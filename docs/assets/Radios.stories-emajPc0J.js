...
}`,...(p=(u=r.parameters)==null?void 0:u.docs)==null?void 0:p.source}}};var b,g,v;o.parameters={...o.parameters,docs:{...(b=o.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    label: 'How custom do you like it?',
    defaultValue: 'pretty',
    render: radio => <div className="flex flex-row items-baseline gap-x-4">
        <Radio {...radio({
        value: 'kinda'
...
}`,...(v=(g=o.parameters)==null?void 0:g.docs)==null?void 0:v.source}}};var x,f,y;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    label: 'A label',
...
}`,...(_=(M=i.parameters)==null?void 0:M.docs)==null?void 0:_.source}}};const k=["StandardLayout","CustomLayout","FieldsetLayout","Small","Medium","Large","AllSizes"],C=Object.freeze(Object.defineProperty({__proto__:null,AllSizes:i,CustomLayout:o,FieldsetLayout:n,Large:s,Medium:t,Small:l,StandardLayout:r,__namedExportsOrder:k,default:P},Symbol.toStringTag,{value:"Module"}));export{o as C,C as S,r as a};
