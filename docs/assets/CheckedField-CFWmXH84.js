import{j as e,M as a,A as l,C as i}from"./blocks-BA1a2dVG.js";import{useMDXComponents as t}from"./index-BXt_MkKP.js";import{F as c,d,T as h}from"./TableOfContents-Dhm7B0is.js";import{C as o}from"./CheckedField-BAZSrRcf.js";import{S as p,B as m,A as x}from"./CheckedField.stories-BYsfpvRD.js";import"./iframe-Dcrhn4el.js";import"./index-CnbiPRYk.js";import"./clsw-D-KgF5mV.js";import"./index-Czi7Upa3.js";function r(n){const s={a:"a",code:"code",h1:"h1",h2:"h2",p:"p",...t(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{of:p}),`
...
`,e.jsxs(s.p,{children:["This is simpler than the ",e.jsx(s.a,{href:"/docs/form-field--docs/",children:"Field"}),` component. There’s no
hint, since a field with only 2 possible values is too simple for it. And
there’s no error message, since if one or both possible values is invalid, the
field has no purpose.`]}),`
`,e.jsxs(s.p,{children:["Note: this layout is already built-into ",e.jsx(s.a,{href:"/docs/forms-checkbox--docs/",children:"Checkbox"}),`,
`,e.jsx(s.a,{href:"/docs/forms-radio--docs/",children:"Radio"}),", and ",e.jsx(s.a,{href:"/docs/forms-switch--docs/",children:"Switch"}),`—you
can use this component to create a custom form control that behaves the same
way.`]}),`
...
`,e.jsx(l,{of:o,sort:"requiredFirst"}),`
