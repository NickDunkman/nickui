import{r as c}from"./iframe-DOqKYI6o.js";import{a as m,S as t,u as p,c as h}from"./index-D3vd8min.js";var a=(e=>(e.primary="primary",e.secondary="secondary",e.danger="danger",e))(a||{});const y=m({base:`
    appearance-none
    border-1 rounded-sm
    text-center
  ...
  `,variants:{sizer:{[t.small]:"text-sm py-1.75 px-3",[t.medium]:"text-base py-2.75 px-4.5",[t.large]:"text-lg py-3.75 px-5.5"},flavor:{[a.primary]:"bg-indigo-600 border-indigo-600 text-white font-medium",[a.secondary]:"border-gray-500 bg-gray-100 shadow-md/8",[a.danger]:"bg-rose-700 border-rose-700 text-white font-medium"}},defaultVariants:{sizer:t.small,flavor:a.primary}});function r({className:e,type:s="button",disabled:o=!1,sizer:n,flavor:i,...l}){const d=p(n),u=y({sizer:d,flavor:i});return c.createElement("button",{...l,className:h(u,e),disabled:o,type:s})}r.flavor=a;r.sizer=t;r.__docgenInfo={description:`Buttons allow the user to trigger an action, such as submitting a form
