import{k as s}from"./index-Dr1KcQq8.js";import{r as a}from"./iframe-D3szbWiH.js";import{a as K,u as B,c as F}from"./index-D5U5gOFB.js";const z=K({base:`
    text-nowrap
    appearance-none
    rounded-sm
    text-center
  ...
  `,variants:{sizer:{xs:"text-xs py-1.5 px-2",sm:"text-sm py-1.75 px-2.75",base:"text-base py-2.75 px-4.25",lg:"text-lg py-3.75 px-5.25",xl:"text-xl py-4.75 px-6.25"},isDisabled:{false:`
      ...
      `}],defaultVariants:{sizer:"base",flavor:"neutral",isSecondary:!1,isDisabled:!1,isTouchActivated:!1,isKeyboardFocused:!1}});function q({className:m,type:f="button",disabled:o=!1,sizer:l,flavor:g,secondary:k=!1,onTouchStart:h,onTouchEnd:x,onTouchCancel:y,onMouseDown:p,onKeyDown:w,onKeyUp:T,onFocus:S,onBlur:D,...A}){const[t,u]=a.useState(!1),[n,b]=a.useState(!1),[i,v]=a.useState(!1),[r,c]=a.useState(!1),d=B(l),E=z({sizer:d,flavor:g,isSecondary:k,isDisabled:o,isKeyboardFocused:!o&&n&&!t&&!r,isKeyboardActivated:!o&&i,isTouchActivated:!o&&r});return a.createElement("button",{...A,className:F(E,m),disabled:o,type:f,onBlur:e=>{t&&u(!1),n&&b(!1),D?.(e)},onFocus:e=>{n||b(!0),S?.(e)},onKeyDown:e=>{console.log(s(e.nativeEvent)),i||(s(e.nativeEvent)==="enter"||e.nativeEvent.key==="Enter"||s(e.nativeEvent)==="space"||e.nativeEvent.key===" ")&&v(!0),w?.(e)},onKeyUp:e=>{i&&v(!1),T?.(e)},onMouseDown:e=>{t||u(!0),p?.(e)},onTouchStart:e=>{r||c(!0),h?.(e)},onTouchEnd:e=>{r&&c(!1),x?.(e)},onTouchCancel:e=>{r&&c(!1),y?.(e)},"data-nickui-sizer":Array.isArray(l)?l.join(","):l,"data-nickui-resolved-sizer":d})}q.__docgenInfo={description:`Buttons allow the user to trigger an action, such as submitting a form
