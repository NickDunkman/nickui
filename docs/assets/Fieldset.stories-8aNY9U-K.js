...
}`,...(z=(N=m.parameters)==null?void 0:N.docs)==null?void 0:z.source}}};var D,v,A;n.parameters={...n.parameters,docs:{...(D=n.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    children: [<Docs.FormControlPlaceholder key="first" className="mb-2" />, <Docs.FormControlPlaceholder key="second" />],
    label: 'Your name',
    required: true
  }
}`,...(A=(v=n.parameters)==null?void 0:v.docs)==null?void 0:A.source}}};const L=["Basic","Small","Medium","Large","AllSizes","Error","Required"],R=Object.freeze(Object.defineProperty({__proto__:null,AllSizes:c,Basic:t,Error:m,Large:o,Medium:s,Required:n,Small:l,__namedExportsOrder:L,default:M},Symbol.toStringTag,{value:"Module"}));export{t as B,n as R,R as S};
