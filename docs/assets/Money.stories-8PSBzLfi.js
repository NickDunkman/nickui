import{r as l}from"./iframe-C0VeZLsT.js";import{A as J}from"./AllSizersStoryWrapper-BxMOK3L_.js";import{g as Q}from"./getStoryArgTypes-xnGM9Mjx.js";import{F as ee}from"./Field-CtUsfE6J.js";import{t as ae}from"./styles-joATh96y.js";import{r as te,f as ne,u as se,c as U}from"./index-V48DHmLJ.js";import{a as re}from"./fieldA11y-IXtqdaYQ.js";import{r as le}from"./randomId-Dfhrkieu.js";import{u as oe}from"./useElementBounds-BkKfoHSo.js";import{f as ie}from"./fireInputChange-BU1kNzof.js";function ce(e,t){const a=l.useRef(null),n=e||a,s=l.useRef(null),i=t||s;return l.useEffect(()=>{const c=n.current,u=i.current;if(c&&u){let d=function(){$(c,u)};return $(c,u),c.addEventListener("scroll",d),()=>{c.removeEventListener("scroll",d)}}},[n,i]),[n,i]}function $(e,t){e&&t&&(t.scrollLeft=e.scrollLeft,t.scrollTop=e.scrollTop)}const ue=te({slots:{visibleInputsContainer:"relative",placeholderInput:`
...
}`,...P.parameters?.docs?.source}}};const ve=["fieldLayout","empty","controlled","uncontrolled","disabled","euros","currencyConverter","allowNegatives","xs","sm","base","lg","xl","responsive","allControlStates","allSizers"],Ue=Object.freeze(Object.defineProperty({__proto__:null,__namedExportsOrder:ve,allControlStates:R,allSizers:P,allowNegatives:M,base:E,controlled:x,currencyConverter:k,default:he,disabled:w,empty:v,euros:H,fieldLayout:N,lg:T,responsive:z,sm:S,uncontrolled:V,xl:A,xs:C},Symbol.toStringTag,{value:"Module"}));export{p as M,M as a,k as c,Ue as s};
