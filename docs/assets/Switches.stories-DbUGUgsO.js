import{r as l}from"./iframe-BOhUS0D9.js";import{S}from"./Switch-B3GPII-q.js";import{A as T}from"./AllSizersStoryWrapper-B8yhyoy3.js";import{a as O}from"./Checkboxes-BkbquJoH.js";function c({delimiter:a=",",...n}){return l.createElement(O,{...n,Checkable:S,delimiter:a})}c.__docgenInfo={description:`Renders multiple <Switch> as one field in a <Fieldset>.
...
}`,...k.parameters?.docs?.source}}};const R=["fieldsetLayout","noValue","controlled","uncontrolled","disabled","standardLayout","customLayout","xs","sm","base","lg","xl","responsive","allControlStates","allSizers"],L=Object.freeze(Object.defineProperty({__proto__:null,__namedExportsOrder:R,allControlStates:B,allSizers:k,base:b,controlled:p,customLayout:f,default:A,disabled:u,fieldsetLayout:y,lg:v,noValue:d,responsive:C,sm:h,standardLayout:w,uncontrolled:m,xl:x,xs:g},Symbol.toStringTag,{value:"Module"}));export{c as S,w as a,f as c,L as s};
