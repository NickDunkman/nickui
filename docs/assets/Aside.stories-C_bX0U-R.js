import{r as e}from"./iframe-BHWhhQOG.js";import{A as k}from"./AllSizersStoryWrapper-CfMwsrT0.js";import{r as N,u as z,c as q}from"./index-te24yuVz.js";const A=N({slots:{root:"rounded-sm border-1",heading:"font-semibold",paragraph:""},variants:{sizer:{xs:{root:"p-3 text-xs",heading:"text-xs mb-2.5",paragraph:"text-xs [&:not(:last-child)]:mb-2"},sm:{root:"p-3.5 text-xs",heading:"text-sm mb-3",paragraph:"text-xs [&:not(:last-child)]:mb-2.5"},base:{root:"p-4 text-sm",heading:"text-base mb-3.5",paragraph:"text-sm [&:not(:last-child)]:mb-3"},lg:{root:"p-4.5 text-base",heading:"text-lg mb-4",paragraph:"text-base [&:not(:last-child)]:mb-3.5"},xl:{root:"p-5 text-lg",heading:"text-xl mb-4.5",paragraph:"text-lg [&:not(:last-child)]:mb-4"}},flavor:{neutral:{root:"bg-blue-50 border-blue-200 text-blue-950"},positive:{root:"bg-emerald-50 border-emerald-200 text-emerald-950"},caution:{root:"bg-yellow-50 border-yellow-300 text-yellow-950"},negative:{root:"bg-rose-50 border-rose-200 text-rose-950"}}},defaultVariants:{sizer:"base",flavor:"neutral"}});function a({className:s,sizer:t,flavor:r,children:b,...f}){const v=z(t),C=A({sizer:v,flavor:r}),R=e.useMemo(()=>({styles:A({sizer:v,flavor:r}),resolvedSizer:v,flavor:r}),[v,r]);return e.createElement(P.Provider,{value:R},e.createElement("aside",{...f,className:q(C.root(),s),"data-nickui-sizer":Array.isArray(t)?t.join(","):t,"data-nickui-resolved-sizer":v},b))}a.Heading=H;a.Paragraph=S;const P=e.createContext({styles:A(),resolvedSizer:"base",flavor:"neutral"});function H({children:s,className:t,level:r=3}){const{styles:b}=e.useContext(P),f=`h${r}`;return e.createElement(f,{className:q(b.heading(),t)},s)}H.displayName="AsideHeading";function S({children:s,className:t}){const{styles:r}=e.useContext(P);return e.createElement("p",{className:q(r.paragraph(),t)},s)}S.displayName="AsideParagraph";a.__docgenInfo={description:`Displays some secondary content, typically an "oh, by the way!" relative to
the main content.
...
}`,...x.parameters?.docs?.source}}};const E=["neutral","positive","caution","negative","xs","sm","base","lg","xl","responsive","allFlavors","allSizers"],T=Object.freeze(Object.defineProperty({__proto__:null,__namedExportsOrder:E,allFlavors:h,allSizers:x,base:d,caution:m,default:w,lg:g,negative:u,neutral:l,positive:n,responsive:y,sm:c,xl:p,xs:o},Symbol.toStringTag,{value:"Module"}));export{a as A,T as s};
