import{r}from"./iframe-yGhCdJix.js";import{P as X}from"./PrettyPrint-pbLhOdDF.js";import{A as Y}from"./AllSizersStoryWrapper-BViIvCrF.js";import{F as G}from"./Field-Br2aUlYd.js";import{t as J}from"./styles-yAOqukd3.js";import{a as Q,f as Z,u as ee,c as N}from"./index-BvyJpxie.js";import{u as ae}from"./useElementBounds-DSTD96NG.js";import{u as te}from"./useFieldA11yIds-COiPZunh.js";import{f as ne}from"./fireInputChange-BU1kNzof.js";function re(e,a){const t=r.useRef(null),n=e||t,l=r.useRef(null),s=a||l;return r.useEffect(()=>{const o=n.current,c=s.current;if(o&&c){let g=function(){$(o,c)};return $(o,c),o.addEventListener("scroll",g),()=>{o.removeEventListener("scroll",g)}}},[n,s]),[n,s]}function $(e,a){e&&a&&a.scroll(e.scrollLeft,e.scrollTop)}const le=Q({slots:{visibleInputsContainer:"relative",placeholderInput:`
...
number format`},error:{required:!1,tsType:{name:"ReactNode"},description:"Error message to show along with the field, or just `true` to trigger the\nerror style without showing an error message."},required:{required:!1,tsType:{name:"boolean"},description:"When `true`, adds an asterisk to the label"},disabled:{required:!1,tsType:{name:"boolean"},description:"Prevents the user from interacting with the control"}},composes:["Omit"]};function me(e){return Object.entries(e).reduce((a,[t,n])=>({...a,[t]:{table:{defaultValue:{summary:n}}}}),{})}const{expect:m,fn:p}=__STORYBOOK_MODULE_TEST__,ge={title:"Form controls/Currency",component:y,argTypes:me({currencySymbol:"$",decimalPoint:".",decimalPlaces:2,thousandsSeparator:",",allowNegatives:!1,disabled:!1,sizer:"base"})};function pe(e){const[a,t]=r.useState(e.value),[n,l]=r.useState(0);return r.createElement(r.Fragment,null,r.createElement(X,{className:"mb-2",data:{count:n,value:a}}),r.createElement(y,{...e,value:a,onChange:s=>{l(n+1),t(s.target.value==="1.23"?"69.69":s.target.value)}}))}function ye(e){const[a,t]=r.useState(e.defaultValue),[n,l]=r.useState(0);return r.createElement(r.Fragment,null,r.createElement(X,{className:"mb-2",data:{count:n,value:a}}),r.createElement(y,{...e,defaultValue:a,onChange:s=>{l(n+1),t(s.target.value==="1.23"?"69.69":s.target.value)}}))}const T={tags:["field-layout"],args:{required:!0,label:"A label",hint:"A hint",error:"An error message",defaultValue:"99.99",onChange:p()}},E={tags:["control-state"],args:{"aria-label":"Empty Currency",onChange:p()}},B={tags:["control-state"],render:e=>r.createElement(pe,{...e}),args:{value:"1234.56","aria-label":"Controlled Currency",onChange:p()}},z={tags:["control-state"],render:e=>r.createElement(ye,{...e}),args:{defaultValue:"1234.56","aria-label":"Uncontrolled Currency",onChange:p()}},H={tags:["control-state"],args:{defaultValue:"1234.56",disabled:!0,"aria-label":"Disabled Currency",onChange:p()}},A={tags:["control-state"],args:{defaultValue:"1234.56",currencySymbol:"€",label:"Euros",hint:'Uses "." as the thousands-separator and "," as the decimal point!',thousandsSeparator:".",decimalPoint:",",onChange:p()}},x={tags:["sizer"],args:{sizer:"xs",label:"Xs Currency",defaultValue:"1.23",onChange:p()},play:async({canvas:e,step:a})=>{await a("Assert the xs sizer style on both the Currency & Field",async()=>{m(e.getByLabelText("Xs Currency")).toHaveClass("text-xs"),m(e.getByText("Xs Currency")).toHaveClass("text-xs"),m(e.getByText("$")).toHaveClass("text-xs")})}},b={tags:["sizer"],args:{sizer:"sm",label:"Sm Currency",defaultValue:"1.23",onChange:p()},play:async({canvas:e,step:a})=>{await a("Assert the sm sizer style on both the Currency & Field",async()=>{m(e.getByLabelText("Sm Currency")).toHaveClass("text-sm"),m(e.getByText("Sm Currency")).toHaveClass("text-sm"),m(e.getByText("$")).toHaveClass("text-sm")})}},v={tags:["sizer"],args:{sizer:"base",label:"Base Currency",defaultValue:"1.23",onChange:p()},play:async({canvas:e,step:a})=>{await a("Assert the base sizer style on both the Currency & Field",async()=>{m(e.getByLabelText("Base Currency")).toHaveClass("text-base"),m(e.getByText("Base Currency")).toHaveClass("text-base"),m(e.getByText("$")).toHaveClass("text-base")})}},C={tags:["sizer"],args:{sizer:"lg",label:"Lg Currency",defaultValue:"1.23",onChange:p()},play:async({canvas:e,step:a})=>{await a("Assert the lg sizer style on both the Currency & Field",async()=>{m(e.getByLabelText("Lg Currency")).toHaveClass("text-lg"),m(e.getByText("Lg Currency")).toHaveClass("text-lg"),m(e.getByText("$")).toHaveClass("text-lg")})}},V={tags:["sizer"],args:{sizer:"xl",label:"Xl Currency",defaultValue:"1.23",onChange:p()},play:async({canvas:e,step:a})=>{await a("Assert the xl sizer style on both the Currency & Field",async()=>{m(e.getByLabelText("Xl Currency")).toHaveClass("text-xl"),m(e.getByText("Xl Currency")).toHaveClass("text-xl"),m(e.getByText("$")).toHaveClass("text-xl")})}},k={tags:["sizer"],args:{sizer:["xs","sm:sm","md:base","lg:lg","xl:xl"],label:"Responsive Currency",defaultValue:"1.23",onChange:p()}},P={tags:["!dev","!test"],render:e=>r.createElement(Y,{alignBaseline:!0},r.createElement(y,{...x.args}),r.createElement(y,{...b.args}),r.createElement(y,{...v.args}),r.createElement(y,{...C.args}),r.createElement(y,{...V.args}))};T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  tags: ['field-layout'],
  args: {
    required: true,
    label: 'A label',
...
}`,...P.parameters?.docs?.source}}};const he=["FieldLayout","Empty","Controlled","Uncontrolled","Disabled","Euros","Xs","Sm","Base","Lg","Xl","Responsive","AllSizers"],Re=Object.freeze(Object.defineProperty({__proto__:null,AllSizers:P,Base:v,Controlled:B,Disabled:H,Empty:E,Euros:A,FieldLayout:T,Lg:C,Responsive:k,Sm:b,Uncontrolled:z,Xl:V,Xs:x,__namedExportsOrder:he,default:ge},Symbol.toStringTag,{value:"Module"}));export{y as C,Re as S};
