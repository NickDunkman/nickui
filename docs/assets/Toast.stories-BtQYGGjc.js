...
$1          $3$4`)})}
    ...
    `},render:n=>k.createElement("div",{className:"flex flex-wrap gap-4"},Ct.map(t=>k.createElement($n,{key:t.name,flavor:t.args?.flavor,onClick:()=>dn(t.args)},t.args?.title)))},qt=[Tn,Sn,En,_n],Ln={tags:["!dev","!test"],parameters:{source:`
      import { Button, toast } from 'nickui';
...
}`,...Ln.parameters?.docs?.source}}};const ta=["neutral","positive","caution","negative","secondaryNeutral","secondaryPositive","secondaryCaution","secondaryNegative","asyncToast","customAsyncToast","allFlavors","allSecondaryFlavors"],la=Object.freeze(Object.defineProperty({__proto__:null,__namedExportsOrder:ta,allFlavors:Hn,allSecondaryFlavors:Ln,asyncToast:Bn,caution:On,customAsyncToast:In,default:na,negative:Pn,neutral:kn,positive:wn,secondaryCaution:En,secondaryNegative:_n,secondaryNeutral:Tn,secondaryPositive:Sn},Symbol.toStringTag,{value:"Module"}));export{Ht as T,Bn as a,In as c,la as s,dn as t};
