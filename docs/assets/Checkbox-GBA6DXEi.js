import{r as e}from"./iframe-CcNznxni.js";import{C as z}from"./CheckedField-BwbKD821.js";import{a as R,u as E,c as q}from"./index-X7_sODO6.js";import{u as I}from"./useFieldA11yIds-DeeCjDg0.js";const S=`peer-checked:bg-[url("data:image/svg+xml;charset=utf8,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2010%2010'%3E%3Cpolygon%20fill='%23fff'%20fill-opacity='1'%20points='3.5%205.45%201.5%203.45%200%204.95%203.5%208.45%2010%201.95%208.5%20.45'/%3E%3C/svg%3E%0A")]`,N=R({slots:{root:"",input:"peer opacity-0 absolute -z-1",indicator:`
      relative
    ...
    `},variants:{sizer:{xs:{indicator:"size-3.5 top-0.25 bg-size-[8px]"},sm:{indicator:"size-4 top-[2.5px] bg-size-[10px]"},base:{indicator:"size-4.75 top-0.75 bg-size-[12px]"},lg:{indicator:"size-5.5 top-[3.5px] bg-size-[14px]"},xl:{indicator:"size-6 top-0.75 bg-size-[16px]"}},isDisabled:{true:{indicator:`
        ...
        `}}},defaultVariants:{sizer:"base",isDisabled:!1,isKeyboardFocused:!1}});function F(t){return e.createElement(x,{...t,type:"checkbox",styler:N})}function x({className:t,sizer:m,label:o,hint:u,disabled:a,styler:g,onBlur:v,onFocus:p,type:b,"aria-labelledby":h,"aria-describedby":f,...y}){const[s,d]=e.useState(!1),[i,c]=e.useState(!1);function w(l){l.preventDefault(),s||d(!0)}function k(l){p?.(l),i||c(!0)}function T(l){v?.(l),i&&c(!1),s&&d(!1)}const n=I({label:o,hint:u,controlledAriaLabelledBy:h,controlledAriaDescribedBy:f}),C=E(m),r=g({sizer:C,isDisabled:!!a,isKeyboardFocused:i&&!a&&!s});return e.createElement(z,{className:q(r.root(),t),label:o,labelId:n.ariaLabelledBy,hint:u,hintId:n.ariaDescribedBy,sizer:m,disabled:a,onMouseDown:w},e.createElement("input",{type:b,className:r.input(),disabled:a,onFocus:k,onBlur:T,"aria-labelledby":n.ariaLabelledBy,"aria-describedby":n.ariaDescribedBy,...y}),e.createElement("div",{className:r.indicator(),"data-testid":"indicator",style:{backgroundPosition:"50% 60%"}}))}F.__docgenInfo={description:`A form control that allow users to choose zero to many options from a set
...
| 'xl:lg'
| 'xl:xl'`,elements:[{name:"literal",value:"'xs'"},{name:"literal",value:"'sm'"},{name:"literal",value:"'base'"},{name:"literal",value:"'lg'"},{name:"literal",value:"'xl'"},{name:"literal",value:"'sm:xs'"},{name:"literal",value:"'sm:sm'"},{name:"literal",value:"'sm:base'"},{name:"literal",value:"'sm:lg'"},{name:"literal",value:"'sm:xl'"},{name:"literal",value:"'md:xs'"},{name:"literal",value:"'md:sm'"},{name:"literal",value:"'md:base'"},{name:"literal",value:"'md:lg'"},{name:"literal",value:"'md:xl'"},{name:"literal",value:"'lg:xs'"},{name:"literal",value:"'lg:sm'"},{name:"literal",value:"'lg:base'"},{name:"literal",value:"'lg:lg'"},{name:"literal",value:"'lg:xl'"},{name:"literal",value:"'xl:xs'"},{name:"literal",value:"'xl:sm'"},{name:"literal",value:"'xl:base'"},{name:"literal",value:"'xl:lg'"},{name:"literal",value:"'xl:xl'"}]}],raw:"SizerType[]"}]},description:`Changes the size of the field ("xs", "sm", "base", "lg", "xl", "sm:base",
"lg:xl", etc)`},label:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"The main label to to the right of the form control, naming the field"},hint:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Additional detail about the field, placed directly below the label"},disabled:{required:!1,tsType:{name:"boolean"},description:"Prevents the user from interacting with the control"},styler:{required:!1,tsType:{name:"any"},description:""},type:{required:!0,tsType:{name:"union",raw:"'checkbox' | 'radio'",elements:[{name:"literal",value:"'checkbox'"},{name:"literal",value:"'radio'"}]},description:""}},composes:["Omit"]};export{F as C,x as a};
