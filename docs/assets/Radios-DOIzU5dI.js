import{r as n}from"./iframe-DVoMRv_a.js";import{R as r}from"./Radio-Bx5osM1Z.js";import{F as o}from"./index-Czi7Upa3.js";import{a as i}from"./Checkboxes-iYWRHyY0.js";function e({delimiter:a,...t}){return a&&console.warn("The `delimiter` prop shouldn’t be used with <Radios>"),n.createElement(i,{...t,Checkable:r})}e.sizer=o;e.__docgenInfo={description:`Renders multiple radios as one field in a Fieldset.
@props {@link CheckablesProps} + {@link CommonFieldProps}`,methods:[],displayName:"Radios",props:{name:{required:!1,tsType:{name:"string"},description:"The name for the field"},children:{required:!1,tsType:{name:"signature",type:"function",raw:`(
  inputProps: (control: {
    value: string;
    disabled?: boolean;
...
number format`},error:{required:!1,tsType:{name:"union",raw:"boolean | React.ReactNode",elements:[{name:"boolean"},{name:"ReactReactNode",raw:"React.ReactNode"}]},description:"Error message to show along with the field, or just `true` to trigger the\nerror style without showing an error message."},required:{required:!1,tsType:{name:"boolean"},description:"When `true`, adds an asterisk to the label"},disabled:{required:!1,tsType:{name:"boolean"},description:"Prevents the user from interacting with the control"}},composes:["Omit"]};export{e as R};
