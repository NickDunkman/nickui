import{r}from"./iframe-DwiZhhBp.js";import{A as q}from"./AllSizersStoryWrapper-DI700UeT.js";import{F as _}from"./Field-BMmK5lMp.js";import{u as R}from"./useFieldA11yIds-BsaBAGwJ.js";import{u as N}from"./index-BTldlRDU.js";import{t as F}from"./styles-B9mMDauO.js";function o({className:a,sizer:l,label:e,hint:s,error:n,required:C,disabled:A,id:H,"aria-labelledby":B,"aria-describedby":E,"aria-errormessage":S,"aria-invalid":z,...k}){const c=R({label:e,hint:s,error:n,controlledId:H,controlledAriaLabelledBy:B,controlledAriaDescribedBy:E,controlledAriaErrorMessage:S}),L=N(l),V=F({sizer:L,hasError:!!n});return r.createElement(_,{className:a,sizer:l,label:e,labelId:c.ariaLabelledBy,controlId:c.id,hint:s,hintId:c.ariaDescribedBy,error:n!==!0?n:void 0,errorId:c.ariaErrorMessage,disabled:A,required:C,"data-nickui-component":"Text"},r.createElement("input",{...k,id:c.id,className:V,disabled:A,required:C,"aria-labelledby":c.ariaLabelledBy,"aria-describedby":c.ariaDescribedBy,"aria-errormessage":c.ariaErrorMessage,"aria-invalid":z!==void 0?z:!!n}))}o.__docgenInfo={description:`A form control that allows users to enter & edit a single line of text
...
number format`},error:{required:!1,tsType:{name:"ReactNode"},description:"Error message to show along with the field, or just `true` to trigger the\nerror style without showing an error message."},required:{required:!1,tsType:{name:"boolean"},description:"When `true`, adds an asterisk to the label"},disabled:{required:!1,tsType:{name:"boolean"},description:"Prevents the user from interacting with the control"}}};const{expect:t,fn:i}=__STORYBOOK_MODULE_TEST__,D={title:"Form controls/Text",component:o},b={tags:["field-layout"],args:{required:!0,label:"A label",hint:"A hint",error:"An error message",defaultValue:"A problematic value",onChange:i()},play:async({canvas:a,step:l})=>{const e=a.getByLabelText("A label*"),s=a.getByTitle("(required)");await l("Assert accessibility of layout elements",async()=>{t(e).toHaveRole("textbox"),t(e).toHaveAccessibleDescription("A hint"),t(e).toHaveAccessibleErrorMessage("An error message"),t(s).toHaveTextContent("*")}),await l("Assert the error style",async()=>{t(e).toHaveClass("border-rose-800")})}},u={tags:["control-state"],args:{placeholder:"Empty Text","aria-label":"Empty Text",onChange:i()},play:async({args:a,canvas:l,step:e,userEvent:s})=>{const n=l.getByLabelText("Empty Text");await e("Assert Text is functional without an initial value",async()=>{await s.type(n,"a"),t(n).toHaveValue("a"),t(a.onChange).toHaveBeenCalledOnce()}),await e("Reset the value",async()=>{await s.type(n,"{backspace}"),t(n).toHaveValue("")})}},m={tags:["control-state"],args:{value:"Controlled Text","aria-label":"Controlled Text",onChange:i()},play:async({args:a,canvas:l,step:e,userEvent:s})=>{const n=l.getByLabelText("Controlled Text");await e("Assert `value` works",async()=>{t(n).toHaveValue(a.value)}),await e("Try adding text. `onChange` should fire, but the value is controlled, so it shouldn’t change",async()=>{await s.type(n,"a"),t(a.onChange).toHaveBeenCalledOnce(),t(n).toHaveValue(a.value)})}},d={tags:["control-state"],args:{defaultValue:"Uncontrolled Text","aria-label":"Uncontrolled Text",onChange:i()},play:async({args:a,canvas:l,step:e,userEvent:s})=>{const n=l.getByLabelText("Uncontrolled Text");await e("Assert `defaultValue` works",async()=>{t(n).toHaveValue(a.defaultValue)}),await e("Typing into the Text should amend the value, since it’s uncontrolled",async()=>{await s.type(n,"a"),t(n).toHaveValue(`${a.defaultValue}a`),t(a.onChange).toHaveBeenCalledOnce()}),await e("Reset the value",async()=>{await s.type(n,"{backspace}"),t(n).toHaveValue(a.defaultValue)})}},p={tags:["control-state"],args:{defaultValue:"Disabled Text",disabled:!0,"aria-label":"Disabled Text",onChange:i()},play:async({args:a,canvas:l,step:e,userEvent:s})=>{const n=l.getByLabelText("Disabled Text");await e("Assert disabled state",async()=>{t(n).toBeDisabled()}),await e("Typing should have no effect",async()=>{await s.type(n,"a"),t(a.onChange).not.toHaveBeenCalled(),t(n).toHaveValue(a.defaultValue)})}},x={tags:["sizer"],args:{"aria-label":"Xs Text",sizer:"xs",placeholder:"Xs Text",onChange:i()},play:async({canvas:a,step:l})=>{const e=a.getByLabelText("Xs Text"),s=e.closest('[data-nickui-component="Text"]');await l("Assert the xs sizer style on both the Text & Field",async()=>{t(e).toHaveClass("text-xs"),t(s).toHaveAttribute("data-nickui-sizer","xs")})}},g={tags:["sizer"],args:{"aria-label":"Sm Text",sizer:"sm",placeholder:"Sm Text",onChange:i()},play:async({canvas:a,step:l})=>{const e=a.getByLabelText("Sm Text"),s=e.closest('[data-nickui-component="Text"]');await l("Assert the sm sizer style on both the Text & Field",async()=>{t(e).toHaveClass("text-sm"),t(s).toHaveAttribute("data-nickui-sizer","sm")})}},v={tags:["sizer"],args:{"aria-label":"Base Text",sizer:"base",placeholder:"Base Text",onChange:i()},play:async({canvas:a,step:l})=>{const e=a.getByLabelText("Base Text"),s=e.closest('[data-nickui-component="Text"]');await l("Assert the base sizer style on both the Text & Field",async()=>{t(e).toHaveClass("text-base"),t(s).toHaveAttribute("data-nickui-sizer","base")})}},y={tags:["sizer"],args:{"aria-label":"Lg Text",sizer:"lg",placeholder:"Lg Text",onChange:i()},play:async({canvas:a,step:l})=>{const e=a.getByLabelText("Lg Text"),s=e.closest('[data-nickui-component="Text"]');await l("Assert the lg sizer style on both the Text & Field",async()=>{t(e).toHaveClass("text-lg"),t(s).toHaveAttribute("data-nickui-sizer","lg")})}},h={tags:["sizer"],args:{"aria-label":"Xl Text",sizer:"xl",placeholder:"Xl Text",onChange:i()},play:async({canvas:a,step:l})=>{const e=a.getByLabelText("Xl Text"),s=e.closest('[data-nickui-component="Text"]');await l("Assert the xl sizer style on both the Text & Field",async()=>{t(e).toHaveClass("text-xl"),t(s).toHaveAttribute("data-nickui-sizer","xl")})}},T={tags:["sizer"],args:{sizer:["xs","sm:sm","md:base","lg:lg","xl:xl"],label:"Responsive label",placeholder:"Responsive Text",onChange:i()}},f={tags:["!dev","!test"],render:a=>r.createElement("div",{className:"flex flex-col gap-3 sm:flex-row"},r.createElement(o,{...u.args,className:"sm:flex-1"}),r.createElement(o,{...m.args,className:"sm:flex-1"}),r.createElement(o,{...d.args,className:"sm:flex-1"}),r.createElement(o,{...p.args,className:"sm:flex-1"}))},w={tags:["!dev","!test"],render:a=>r.createElement(q,{alignBaseline:!0},r.createElement(o,{...x.args}),r.createElement(o,{...g.args}),r.createElement(o,{...v.args}),r.createElement(o,{...y.args}),r.createElement(o,{...h.args}))};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  tags: ['field-layout'],
  args: {
    required: true,
    label: 'A label',
...
}`,...w.parameters?.docs?.source}}};const O=["fieldLayout","empty","controlled","uncontrolled","disabled","xs","sm","base","lg","xl","responsive","allControlStates","allSizers"],j=Object.freeze(Object.defineProperty({__proto__:null,__namedExportsOrder:O,allControlStates:f,allSizers:w,base:v,controlled:m,default:D,disabled:p,empty:u,fieldLayout:b,lg:y,responsive:T,sm:g,uncontrolled:d,xl:h,xs:x},Symbol.toStringTag,{value:"Module"}));export{o as T,j as s};
