import{j as e,M as u}from"./blocks-DILD-YPA.js";import{useMDXComponents as c}from"./index-BSWXvihS.js";import{D as i}from"./index-BO77VyQa.js";import{r as p}from"./iframe-D_dx4C3o.js";import{A as o}from"./Aside-CIK2rogE.js";import{s as m,M as h}from"./Money.stories-DmAQzjBY.js";import"./preload-helper-D9Z9MdNV.js";import"./index-MwUvjmfi.js";import"./client-CNIK_tGj.js";import"./Button-DymO3C48.js";import"./index-Bl3bBT5F.js";import"./index-D1YO4riR.js";import"./AllSizersStoryWrapper-M2xuQLnL.js";import"./getStoryArgTypes-CvpAwH8w.js";import"./Field-DLgvBtFY.js";import"./styles-B9mBw5cT.js";import"./fieldA11y-C3gyBWsB.js";import"./randomId-Dfhrkieu.js";import"./useElementBounds-D-KkDKt4.js";import"./fireInputChange-BU1kNzof.js";function y({children:t,defaultValue:n}){const[r,a]=p.useState(n);return t(r,a)}function d(t){const n={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...c(),...t.components};return o||s("Aside",!1),o.Paragraph||s("Aside.Paragraph",!0),i||s("Docs",!1),i.TableOfContents||s("Docs.TableOfContents",!0),e.jsxs(e.Fragment,{children:[e.jsx(u,{of:m,name:"How it works"}),`
...
`,e.jsx(n.p,{children:`Normally, they are collapsed together via overlapping & hiding, so you only
perceive a single control. This demo shows the three inputs separated out.`}),`
`,e.jsx(y,{defaultValue:"",children:(r,a)=>e.jsxs("div",{className:"sb-unstyled flex flex-col sm:flex-row sm:items-stretch sm:gap-4",children:[e.jsx("div",{className:"flex-1",children:e.jsx(i.FauxCanvas,{children:e.jsx(h,{label:"Separated out",hint:e.jsxs(e.Fragment,{children:[e.jsx("div",{children:"top: placeholder input"}),e.jsx("div",{children:"middle: working input"}),e.jsx("div",{children:" bottom: form input"})]}),value:r,onChange:l=>a(l.target.value),docsMeta:{spread:!0},allowNegatives:!0})})}),e.jsx("div",{className:"-mt-10 flex-1 sm:mt-0",children:e.jsx(i.FauxCanvas,{children:e.jsx(h,{label:"Collapsed together",value:r,onChange:l=>a(l.target.value),allowNegatives:!0})})})]})}),`
...
`,e.jsx(n.p,{children:"TODO"})]})}function O(t={}){const{wrapper:n}={...c(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(d,{...t})}):d(t)}function s(t,n){throw new Error("Expected "+(n?"component":"object")+" `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{O as default};
