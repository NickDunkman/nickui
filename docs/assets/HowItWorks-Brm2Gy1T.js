import{j as e,M as u}from"./blocks-BybPGZnz.js";import{useMDXComponents as d}from"./index-CxeJwy2m.js";import{D as o}from"./index-BPy4f3jE.js";import{r as p}from"./iframe-ClCKDRnM.js";import{A as i}from"./Aside-DoecdfTT.js";import{M as h}from"./Money-BFscZdFF.js";import{s as m}from"./Money.stories-DKNfG-g_.js";import"./preload-helper-D9Z9MdNV.js";import"./index-45EnxtDN.js";import"./client-ae6XlYz6.js";import"./Button-BfdKq3oR.js";import"./index-Bcc7r1sS.js";import"./index-C9N6JpZ7.js";import"./Field-CkGsrfN-.js";import"./styles-DKXCIM0g.js";import"./fieldA11y-D5KJLKJw.js";import"./randomId-Dfhrkieu.js";import"./useElementBounds-D7v76WMO.js";import"./fireInputChange-BU1kNzof.js";import"./AllSizersStoryWrapper-CyZMSWq_.js";import"./getStoryArgTypes-msA8qnCj.js";function x({children:t,defaultValue:n}){const[s,r]=p.useState(n);return t(s,r)}function c(t){const n={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...d(),...t.components};return i||a("Aside",!1),i.Paragraph||a("Aside.Paragraph",!0),o||a("Docs",!1),o.TableOfContents||a("Docs.TableOfContents",!0),e.jsxs(e.Fragment,{children:[e.jsx(u,{of:m,name:"How it works"}),`
`,e.jsxs(n.h1,{id:"how-the--component-works-",children:["How the ",e.jsx(o,{of:"Money"})," component works 🤓"]}),`
...
reasons outlined above. But if you type with any kind of speed, the visual chaos
...
a “negative amount to add to your account.” So `,e.jsx(o,{of:"Money"}),` blocks
...
have a value formatted in the same way the `,e.jsx(o,{of:"Money"})," component would."]}),`
...
`,e.jsxs(n.p,{children:["When you interact with the ",e.jsx(o,{of:"Money"}),` component, you’re actually
...
separated out.`}),`
`,e.jsx(x,{defaultValue:"",children:(s,r)=>e.jsxs("div",{className:"sb-unstyled flex flex-col sm:flex-row sm:items-stretch sm:gap-4",children:[e.jsx("div",{className:"flex-1",children:e.jsx(o.FauxCanvas,{children:e.jsx(h,{label:"Separated out",hint:e.jsxs(e.Fragment,{children:[e.jsx("div",{children:"top: placeholder input"}),e.jsx("div",{children:"middle: working input (overlaps the placholder)"}),e.jsx("div",{children:"bottom: form input (hidden)"})]}),value:s,onChange:l=>r(l.target.value),docsMeta:{spread:!0},allowNegatives:!0})})}),e.jsx("div",{className:"-mt-10 flex-1 sm:mt-0",children:e.jsx(o.FauxCanvas,{children:e.jsx(h,{label:"Collapsed together",value:s,onChange:l=>r(l.target.value),allowNegatives:!0})})})]})}),`
...
`,e.jsx(n.h3,{id:"de-formatting-on-focus",children:'"De-formatting" on focus'}),`
`,e.jsxs(n.p,{children:[`Since I decided that adding/removing/moving the thousands separators (commas)
`,e.jsx(n.em,{children:"as you type"}),` is too chaotic, the component removes them on focus. It does this
by overriding the internal format object to have `,e.jsx(n.code,{children:'thousandsSeparator = ""'}),`, and
then the updated format cascades throughout the internal dependents.`]}),`
`,e.jsx(n.p,{children:`Then, when the component loses focus, it adds the thousands separators back by
switching back to the original format configuration.`}),`
...
`,e.jsxs(n.p,{children:["Thankfully, ",e.jsx(n.code,{children:"React.useReducer"}),` offers a great way to make complex state changes
as a single change. The reducer I wrote (wrapped in `,e.jsx(n.code,{children:"useValueStateReducer()"}),`)
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:e.jsx(n.code,{children:"UPDATE_FORMAT"})}),`: used to remove/add thousands separats on focus/blur, and
when the parent passes in a new format (such as to switch currencies)`]}),`
...
`]}),`
`,e.jsxs(n.p,{children:["If you peak into the ",e.jsx(n.code,{children:'<Docs of="Money" />'}),` component code, you’ll see that all
of this complex state stuff is encapsulated into hooks; the component function
itself is almost entirely JSX & presentational logic. The chain of hook calls
looks like:`]}),`
`,e.jsxs(n.ul,{children:[`
...
`]})]})}function O(t={}){const{wrapper:n}={...d(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(c,{...t})}):c(t)}function a(t,n){throw new Error("Expected "+(n?"component":"object")+" `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{O as default};
