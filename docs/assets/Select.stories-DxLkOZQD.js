import{r as a}from"./iframe-DE7SLDRw.js";import{A as _}from"./AllSizersStoryWrapper-BecDCcn2.js";import{F as D}from"./Field-D8LKmKhE.js";import{u as F}from"./useFieldA11yIds-Ys2uElhD.js";import{a as O,u as R}from"./index-FP35bGqQ.js";const h=`after:bg-[url("data:image/svg+xml;utf8,%3Csvg%20viewBox='0%200%2012%2023'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3E%3Cpath%20d='M11.4%207.7C11.6472%208.02962%2011.412%208.5%2011%208.5H1C0.587977%208.5%200.352786%208.02962%200.6%207.7L5.6%201.03333C5.8%200.766667%206.2%200.766667%206.4%201.03333L11.4%207.7Z'%20fill='black'%20fill-opacity='0.86'%20/%3E%3Cpath%20d='M11.4%2015.3C11.6472%2014.9704%2011.412%2014.5%2011%2014.5H1C0.587977%2014.5%200.352786%2014.9704%200.6%2015.3L5.6%2021.9667C5.8%2022.2333%206.2%2022.2333%206.4%2021.9667L11.4%2015.3Z'%20fill='black'%20fill-opacity='0.86'%20/%3E%3C/svg%3E")]`,V=O({slots:{select:`
      appearance-none
      w-full
      border-2 rounded-sm
      bg-white
    ...
    `},variants:{sizer:{xs:{select:"text-xs py-1.25 pl-2 pr-6",root:`after:w-[6px] after:h-[12px] after:right-2.5 ${h}`},sm:{select:"text-sm py-1.5 pl-2 pr-7",root:`after:w-[6.5px] after:h-[13px] after:right-3 ${h}`},base:{select:"text-base py-2.5 pl-3.5 pr-9",root:`after:w-[9px] after:h-[18px] after:right-3.75 ${h}`},lg:{select:"text-lg py-3.5 pl-4.5 pr-11",root:`after:w-[11.5px] after:h-[23px] after:right-4.5 ${h}`},xl:{select:"text-xl py-5.5 pl-5.5 pr-12.5",root:`after:w-[14px] after:h-[28px] after:right-5 ${h}`}},hasError:{true:{select:"border-rose-800 focus:border-rose-800 focus:shadow-rose-300"}},isDisabled:{true:{root:"after:opacity-40"}}},defaultVariants:{sizer:"base",hasError:!1,isDisabled:!1}});function o({className:e,sizer:l,label:n,hint:r,error:s,disabled:w,required:A,id:E,"aria-labelledby":H,"aria-describedby":z,"aria-errormessage":L,"aria-invalid":B,...k}){const i=F({label:n,hint:r,error:s,controlledId:E,controlledAriaLabelledBy:H,controlledAriaDescribedBy:z,controlledAriaErrorMessage:L}),X=R(l),T=V({sizer:X,hasError:!!s,isDisabled:!!w});return a.createElement(D,{className:e,sizer:l,label:n,labelId:i.ariaLabelledBy,controlId:i.id,hint:r,hintId:i.ariaDescribedBy,error:s!==!0?s:void 0,errorId:i.ariaErrorMessage,disabled:w,required:A},a.createElement("div",{className:T.root()},a.createElement("select",{...k,id:i.id,className:T.select(),disabled:w,required:A,"aria-labelledby":i.ariaLabelledBy,"aria-describedby":i.ariaDescribedBy,"aria-errormessage":i.ariaErrorMessage,"aria-invalid":B!==void 0?B:!!s})))}o.__docgenInfo={description:`A form control that allows users to choose an option using a menu
...
}`,...C.parameters?.docs?.source}}};const M=["FieldLayout","Controlled","Uncontrolled","Disabled","Xs","Sm","Base","Lg","Xl","Responsive","AllControlStates","AllSizers"],W=Object.freeze(Object.defineProperty({__proto__:null,AllControlStates:S,AllSizers:C,Base:b,Controlled:d,Disabled:g,FieldLayout:y,Lg:x,Responsive:f,Sm:u,Uncontrolled:m,Xl:v,Xs:p,__namedExportsOrder:M,default:q},Symbol.toStringTag,{value:"Module"}));export{W as S,o as a};
