import{r as e}from"./iframe-BOhUS0D9.js";import{a as g,u as v,c as h}from"./index-DNuRN-av.js";import{u as p}from"./useElementBounds-CxKbftmz.js";const b=g({slots:{container:"cursor-pointer flex relative",control:"absolute top-0 left-0",descriptors:"flex flex-col",hint:"text-gray-500"},variants:{sizer:{xs:{container:"gap-2 text-xs"},sm:{container:"gap-2.5 text-sm",hint:"text-xs"},base:{container:"gap-3 text-base",hint:"text-sm"},lg:{container:"gap-3.5 text-lg",hint:"text-base"},xl:{container:"gap-4 text-xl",hint:"text-lg"}},isDisabled:{true:{container:"cursor-not-allowed text-gray-400",hint:"text-gray-300"}}},defaultVariants:{sizer:"base",isDisabled:!1}});function f({children:r,className:m,label:t,labelId:o,hint:n,hintId:d,sizer:l,disabled:c,...u}){const s=e.useRef(null),x=p(s),i=v(l),a=b({sizer:i,isDisabled:c});return e.createElement("label",{...u,"data-nickui-sizer":Array.isArray(l)?l.join(","):l,"data-nickui-resolved-sizer":i},e.createElement("div",{className:h(a.container(),m)},e.createElement("span",{style:{paddingLeft:x?.width||0},className:"relative"},e.createElement("div",{className:a.control(),ref:s},r),"​"),(t||n)&&e.createElement("div",{className:a.descriptors()},t&&e.createElement("div",{id:o},t),n&&e.createElement("div",{className:a.hint(),id:d},n))))}f.__docgenInfo={description:`Wraps a single checkable form control with a standard layout (label &
