import{r as t}from"./iframe-CjsTI3bz.js";import{C as V}from"./Checkbox-BtTD30tY.js";import{F as j}from"./Fieldset-DB5pOW4X.js";import{u as M,c as B,S as h}from"./index-DrqyF3cy.js";import{r as L}from"./randomId-Dfhrkieu.js";function N({delimiter:i=",",...a}){return t.createElement(q,{...a,delimiter:i,Checkable:V})}N.sizer=h;function q({className:i,sizer:a,label:n,hint:g,error:d,disabled:s,required:R,Checkable:T,name:z,value:f,defaultValue:y,options:c,render:S,onChange:P,onBlur:E,delimiter:u,...x}){const o=t.createRef(),[I]=t.useState(L()),[A,v]=t.useState(y),w=f!==void 0,l=w?f:A,b=!l||l===""?[]:u?l.split(u):[l];function O(e){let r;u?r=(e.target.checked?[...b,e.target.value]:b.filter(H=>H!==e.target.value)).sort(_(o)).join(u):r=e.target.checked?e.target.value:"",w||v(r);const C=p(o);C.value=r,P?.({...e,target:C})}function F(e){const r=p(o);E?.({...e,target:r})}function k({value:e,disabled:r=!1}){return{name:I,value:e,checked:b.includes(e),onChange:O,onBlur:F,disabled:s||r}}t.useLayoutEffect(()=>{if(f===void 0&&y===void 0){const e=p(o);e.value&&v(e.value)}else if(l){const e=p(o);e.value=l}},[]);const m=M(a);return t.createElement(j,{className:i,sizer:a,label:n,hint:g,error:d,disabled:s,required:R},t.createElement("div",{ref:o,className:c&&B("flex flex-col",{"gap-y-2":!m||m===h.small,"gap-y-2.5":m===h.base,"gap-y-3":m===h.large})},c&&t.createElement(t.Fragment,null,c.map(e=>t.createElement(T,{key:e.value?.toString(),sizer:a,...k({value:e.value,disabled:e.disabled}),label:e.label,hint:e.hint}))),!c&&S?.(k),t.createElement("input",{...x,name:z,type:"hidden",className:"the-hidden-input hidden",disabled:s,required:R,"data-testid":"the-hidden-input"})))}function _(i){const a=[...i.current?.getElementsByTagName("input")||[]].filter(n=>n.type==="checkbox"||n.type==="radio").map(n=>n.value);return(n,g)=>{const d=a.indexOf(n),s=a.indexOf(g);return s===-1?-1:d===-1?1:d-s}}function p(i){return[...i.current?.getElementsByClassName("the-hidden-input")||[]][0]}N.__docgenInfo={description:`Renders multiple checkboxes as one field in a Fieldset.
...
[controlled component](https://react.dev/reference/react-dom/components/input#controlling-an-input-with-a-state-variable)`},defaultValue:{required:!1,tsType:{name:"string"},description:"Sets the value when using it as an uncontrolled component"},delimiter:{required:!1,tsType:{name:"string"},description:`Optionally override the delimiter used to split the value into individual
checkable values`},className:{required:!1,tsType:{name:"string"},description:"Optionally add utility classes to the root element"},sizer:{required:!1,tsType:{name:"union",raw:"Sizer | Sizer[]",elements:[{name:"Sizer"},{name:"Array",elements:[{name:"Sizer"}],raw:"Sizer[]"}]},description:`Changes the size of the field ("small", "base", "large", "sm:small",
"md:large", etc)`},label:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"The main label to show above the form control, naming the field"},hint:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:`A hint about what kind of value the control accepts, such as a phone
...
>`,elements:[{name:"intersection",raw:"React.ComponentProps<'input'> & CommonCheckedFieldProps",elements:[{name:"ReactComponentProps",raw:"React.ComponentProps<'input'>",elements:[{name:"literal",value:"'input'"}]},{name:"signature",type:"object",raw:`{
  ...
  className?: string;
  /** Changes the size of the field ("small", "base", "large") */
  sizer?: Sizer | Sizer[];
  ...
  disabled?: boolean;
}`,signature:{properties:[{key:"className",value:{name:"string",required:!1},description:"Optionally add utility classes to the root element"},{key:"sizer",value:{name:"union",raw:"Sizer | Sizer[]",elements:[{name:"Sizer"},{name:"Array",elements:[{name:"Sizer"}],raw:"Sizer[]"}],required:!1},description:'Changes the size of the field ("small", "base", "large")'},{key:"label",value:{name:"ReactReactNode",raw:"React.ReactNode",required:!1},description:"The main label to to the right of the form control, naming the field"},{key:"hint",value:{name:"ReactReactNode",raw:"React.ReactNode",required:!1},description:"Additional detail about the field, placed directly below the label"},{key:"disabled",value:{name:"boolean",required:!1},description:"Prevents the user from interacting with the control"}]}}]}]},description:""}},composes:["Omit"]};export{N as C,q as a};
