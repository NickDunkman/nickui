import{r as a}from"./iframe-B7C3MqEt.js";import{R as e}from"./Radio-BJNR_lxP.js";const Q={title:"Form controls/Radio",component:e},i={tags:["!dev","!test"],args:{label:"A label",explainer:"An explainer"}},r={args:{label:"Unchecked Radio"}},s={args:{label:"Controlled Radio",checked:!0,onChange:()=>{}}},l={args:{label:"Uncontrolled Radio",defaultChecked:!0}},o={args:{label:"Disabled Radio",disabled:!0}},t={args:{label:"Disabled & checked Radio",disabled:!0,defaultChecked:!0}},m={tags:["!dev","!test"],render:K=>a.createElement("div",{className:"flex flex-col gap-4"},a.createElement(e,{...r.args}),a.createElement(e,{...s.args}),a.createElement(e,{...l.args}),a.createElement(e,{...o.args}),a.createElement(e,{...t.args}))},d={args:{label:"Small Radio (default)",defaultChecked:!0}},c={args:{sizer:e.sizer.medium,label:"Medium Radio",defaultChecked:!0}},n={args:{sizer:e.sizer.large,label:"Large Radio",defaultChecked:!0}},u={tags:["!dev","!test"],render:K=>a.createElement("div",{className:"flex flex-col gap-4 sm:flex-row sm:items-baseline"},a.createElement(e,{...d.args,className:"sm:flex-1"}),a.createElement(e,{...c.args,className:"sm:flex-1"}),a.createElement(e,{...n.args,className:"sm:flex-1"}))};var g,p,b;i.parameters={...i.parameters,docs:{...(g=i.parameters)==null?void 0:g.docs,source:{originalSource:`{
  tags: ['!dev', '!test'],
  args: {
    label: 'A label',
    explainer: 'An explainer'
  }
}`,...(b=(p=i.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};var f,R,h;r.parameters={...r.parameters,docs:{...(f=r.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    label: 'Unchecked Radio'
  }
}`,...(h=(R=r.parameters)==null?void 0:R.docs)==null?void 0:h.source}}};var k,C,S;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    label: 'Controlled Radio',
    checked: true,
    onChange: () => {}
  }
}`,...(S=(C=s.parameters)==null?void 0:C.docs)==null?void 0:S.source}}};var x,v,E;l.parameters={...l.parameters,docs:{...(x=l.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    label: 'Uncontrolled Radio',
    defaultChecked: true
  }
}`,...(E=(v=l.parameters)==null?void 0:v.docs)==null?void 0:E.source}}};var z,D,N;o.parameters={...o.parameters,docs:{...(z=o.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    label: 'Disabled Radio',
    disabled: true
  }
}`,...(N=(D=o.parameters)==null?void 0:D.docs)==null?void 0:N.source}}};var U,_,A;t.parameters={...t.parameters,docs:{...(U=t.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
...
}`,...(J=(I=u.parameters)==null?void 0:I.docs)==null?void 0:J.source}}};const V=["CheckedFieldLayout","Unchecked","Controlled","Uncontrolled","Disabled","DisabledChecked","AllControlStates","Small","Medium","Large","AllSizes"],Y=Object.freeze(Object.defineProperty({__proto__:null,AllControlStates:m,AllSizes:u,CheckedFieldLayout:i,Controlled:s,Disabled:o,DisabledChecked:t,Large:n,Medium:c,Small:d,Unchecked:r,Uncontrolled:l,__namedExportsOrder:V,default:Q},Symbol.toStringTag,{value:"Module"}));export{m as A,Y as S};
