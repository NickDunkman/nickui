import{r}from"./iframe-DwiZhhBp.js";import{A as J}from"./AllSizersStoryWrapper-DI700UeT.js";import{F as Q}from"./Field-BMmK5lMp.js";import{t as ee}from"./styles-B9mMDauO.js";import{a as ae,f as te,u as ne,c as U}from"./index-BTldlRDU.js";import{r as se}from"./randomId-Dfhrkieu.js";import{u as le}from"./useElementBounds-7PCy8zqV.js";import{u as re}from"./useFieldA11yIds-BsaBAGwJ.js";import{f as oe}from"./fireInputChange-BU1kNzof.js";function ie(e,t){const a=r.useRef(null),n=e||a,s=r.useRef(null),i=t||s;return r.useEffect(()=>{const u=n.current,c=i.current;if(u&&c){let d=function(){$(u,c)};return $(u,c),u.addEventListener("scroll",d),()=>{u.removeEventListener("scroll",d)}}},[n,i]),[n,i]}function $(e,t){e&&t&&t.scroll(e.scrollLeft,e.scrollTop)}const ue=ae({slots:{visibleInputsContainer:"relative",placeholderInput:`
