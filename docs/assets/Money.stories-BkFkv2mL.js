import{r}from"./iframe-C3OS0XiJ.js";import{A as J}from"./AllSizersStoryWrapper-BgoD26Cb.js";import{F as Q}from"./Field-DLW1HTnl.js";import{t as ee}from"./styles-CCUGfjU_.js";import{a as ae,f as te,u as ne,c as U}from"./index-X5EXH7qk.js";import{r as se}from"./randomId-Dfhrkieu.js";import{u as le}from"./useElementBounds-D2MAHj_L.js";import{u as re}from"./useFieldA11yIds-CXvEWjgF.js";import{f as oe}from"./fireInputChange-BU1kNzof.js";function ie(e,t){const a=r.useRef(null),n=e||a,s=r.useRef(null),i=t||s;return r.useEffect(()=>{const u=n.current,c=i.current;if(u&&c){let d=function(){$(u,c)};return $(u,c),u.addEventListener("scroll",d),()=>{u.removeEventListener("scroll",d)}}},[n,i]),[n,i]}function $(e,t){e&&t&&t.scroll(e.scrollLeft,e.scrollTop)}const ue=ae({slots:{visibleInputsContainer:"relative",placeholderInput:`
