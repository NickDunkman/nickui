import{j as e,M as l,a}from"./blocks-BOY4E8NR.js";import{useMDXComponents as r}from"./index-BMLRhixw.js";import{D as i}from"./index-BaJMzWci.js";import"./preload-helper-D9Z9MdNV.js";import"./iframe-DKZEa4Ck.js";import"./index-Dh-2ttH4.js";import"./client-B5izZOM2.js";import"./index-9iGa6NbW.js";import"./Button-Dp7bQ2Tp.js";import"./index-DdRpch8n.js";import"./PrettyPrint-ClJ9eSXk.js";function s(t){const n={a:"a",code:"code",img:"img",p:"p",strong:"strong",...r(),...t.components};return i||o("docs",!1),i.SourceLink||o("docs.SourceLink",!0),e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"About this project"}),`
`,e.jsxs("div",{className:"sb-unstyled -mt-10 mb-10 flex items-start gap-6 rounded-sm border-1 border-blue-200 bg-blue-50 p-3",children:[e.jsxs("div",{className:"sb-unstyled flex flex-1 flex-wrap gap-3",children:[e.jsx("div",{children:e.jsx(n.p,{children:e.jsx(n.a,{href:"https://github.com/NickDunkman/nickui/actions/workflows/vitest.yml",rel:"nofollow",children:e.jsx(n.img,{src:"https://github.com/NickDunkman/nickui/actions/workflows/vitest.yml/badge.svg?kill_cache=1",alt:`vitest
status`})})})}),e.jsx("div",{children:e.jsx(n.p,{children:e.jsx(n.a,{href:"https://github.com/NickDunkman/nickui/actions/workflows/eslint.yml",rel:"nofollow",children:e.jsx(n.img,{src:"https://github.com/NickDunkman/nickui/actions/workflows/eslint.yml/badge.svg?kill_cache=1",alt:`eslint
status`})})})}),e.jsx("div",{children:e.jsx(n.p,{children:e.jsx(n.a,{href:"https://github.com/NickDunkman/nickui/actions/workflows/tsc.yml",rel:"nofollow",children:e.jsx(n.img,{src:"https://github.com/NickDunkman/nickui/actions/workflows/tsc.yml/badge.svg?kill_cache=1",alt:`tsc
status`})})})}),e.jsx("div",{children:e.jsx(n.p,{children:e.jsx(n.a,{href:"https://github.com/NickDunkman/nickui/actions/workflows/prettier.yml",rel:"nofollow",children:e.jsx(n.img,{src:"https://github.com/NickDunkman/nickui/actions/workflows/prettier.yml/badge.svg?kill_cache=1",alt:`prettier
status`})})})})]}),e.jsx("div",{className:"relative ml-auto w-6",children:e.jsx("div",{className:"absolute -top-0.5 bottom-0 left-0 size-6",children:e.jsx(i.SourceLink,{markOnly:!0})})})]}),`
...
created`}),"!"]})})]})]})}function g(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}function o(t,n){throw new Error("Expected "+(n?"component":"object")+" `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{g as default};
