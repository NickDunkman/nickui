import{r as l}from"./iframe-CjsTI3bz.js";import{C as w}from"./Checkbox-BtTD30tY.js";import{C as c}from"./Checkboxes-BFT0w9Xl.js";const{expect:e,fn:i}=__STORYBOOK_MODULE_TEST__,f={title:"Form controls/Checkboxes",component:c},C={args:{required:!0,label:"A label",hint:"A hint",error:"An error message",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:i()},play:async({canvas:a,step:n})=>{const t=a.getByRole("group"),o=a.getByTitle("required");await n("Assert accessibility of layout elements",async()=>{e(t).toHaveAccessibleName("A label*"),e(t).toHaveAccessibleDescription("A hint"),e(t).toHaveAccessibleErrorMessage("An error message"),e(o).toHaveTextContent("*")})}},b={args:{label:"No valueish prop",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:i()},play:async({args:a,canvas:n,step:t,userEvent:o})=>{const s=n.getByLabelText("Option one"),r=n.getByLabelText("Option two");await t("Assert initial all-unchecked state",async()=>{e(s).not.toBeChecked(),e(r).not.toBeChecked()}),await t("Check first Checkbox using the keyboard",async()=>{await o.tab(),e(s).toHaveFocus(),await o.keyboard(" "),e(s).toBeChecked(),e(r).not.toBeChecked(),e(a.onChange).toHaveBeenCalledOnce()}),await t("Check second Checkbox using the mouse",async()=>{await o.click(r),e(s).toBeChecked(),e(r).toBeChecked(),e(a.onChange).toHaveBeenCalledTimes(2)}),await t("Reset all checked states",async()=>{await o.click(s),e(s).not.toBeChecked(),await o.click(r),e(r).not.toBeChecked()})}},d={args:{label:"Controlled",value:"one",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:i()},play:async({args:a,canvas:n,step:t,userEvent:o})=>{const s=n.getByLabelText("Option one"),r=n.getByLabelText("Option two");await t("Assert `value` prop works",async()=>{e(s).toBeChecked(),e(r).not.toBeChecked()}),await t("Try toggling a Checkbox. `onChange` should fire, but the value is controlled, so the Checkbox shouldn’t toggle",async()=>{await o.click(s),e(a.onChange).toHaveBeenCalled(),e(s).toBeChecked(),e(r).not.toBeChecked()})}},p={args:{label:"Uncontrolled",defaultValue:"one",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:i()},play:async({args:a,canvas:n,step:t,userEvent:o})=>{const s=n.getByLabelText("Option one"),r=n.getByLabelText("Option two");await t("Assert `defaultValue` prop works",async()=>{e(s).toBeChecked(),e(r).not.toBeChecked()}),await t("Toggling a Checkbox should both fire onChange & toggle the checked state, since the value is uncontrolled.",async()=>{await o.click(s),e(a.onChange).toHaveBeenCalled(),e(s).not.toBeChecked(),e(r).not.toBeChecked()}),await t("Reset to original value",async()=>{await o.click(s)})}},g={args:{label:"Disabled",defaultValue:"one",disabled:!0,options:[{value:"one",label:"Option one",disabled:!1},{value:"two",label:"Option two"}],onChange:i()},play:async({canvas:a,step:n})=>{await n("Assert all Checkboxes are disabled",async()=>{e(a.getByLabelText("Option one")).toBeDisabled(),e(a.getByLabelText("Option two")).toBeDisabled()})}},y={args:{label:"Please select some standards",defaultValue:"8601",options:[{value:"aquila",label:"Roman Aquila"},{value:"8601",label:"ISO 8601"},{value:"high-society",label:"High Society",disabled:!0}],onChange:i()},play:async({canvas:a,step:n})=>{const t=a.getByLabelText("Roman Aquila"),o=a.getByLabelText("ISO 8601"),s=a.getByLabelText("High Society");await n("Assert the controlled Checkboxes are configured correctly",async()=>{e(t).not.toBeChecked(),e(t).not.toBeDisabled(),e(o).toBeChecked(),e(o).not.toBeDisabled(),e(s).not.toBeChecked(),e(s).toBeDisabled()})}},v={args:{label:"Please select some customizations",defaultValue:"colorful,embiggened",render:a=>l.createElement("div",{className:"flex flex-row items-baseline gap-x-6"},l.createElement(w,{...a({value:"colorful"}),label:l.createElement("span",{className:"font-bold text-blue-700"},"Colorful"),className:"rounded-sm bg-rose-200 p-2"}),l.createElement(w,{...a({value:"embiggened"}),sizer:w.sizer.large,label:"Embiggened"}),l.createElement("label",null,l.createElement("input",{type:"checkbox",...a({value:"native"})})," Native")),onChange:i()},play:async({canvas:a,step:n})=>{const t=a.getByLabelText("Colorful"),o=a.getByLabelText("Embiggened"),s=a.getByLabelText("Native");await n("Assert the render function’s callback works",async()=>{e(t).toBeChecked(),e(o).toBeChecked(),e(s).not.toBeChecked()})}},h={args:{label:"Small label",hint:"Small hint",sizer:c.sizer.small,options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:i()},play:async({canvas:a,step:n})=>{await n("Assert the small sizer style of both the Checkboxes & Fieldset",async()=>{a.getAllByTestId("indicator").forEach(t=>{e(t).toHaveClass("size-3.5")}),e(a.getByText("Small label")).toHaveClass("text-xs")})}},u={args:{label:"Base label",hint:"Base hint",sizer:c.sizer.base,options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:i()},play:async({canvas:a,step:n})=>{await n("Assert the base sizer style of both the Checkboxes & Fieldset",async()=>{a.getAllByTestId("indicator").forEach(t=>{e(t).toHaveClass("size-4")}),e(a.getByText("Base label")).toHaveClass("text-sm")})}},m={args:{label:"Large label",hint:"Large hint",sizer:c.sizer.large,options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:i()},play:async({canvas:a,step:n})=>{await n("Assert the laerge style of both the Checkboxes & Fieldset",async()=>{a.getAllByTestId("indicator").forEach(t=>{e(t).toHaveClass("size-5")}),e(a.getByText("Large label")).toHaveClass("text-lg")})}},x={tags:["!test"],args:{label:"Responsive label",hint:"Responsive hint",sizer:[w.sizer.small,c.sizer.smBase,c.sizer.mdLarge],options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:i()}},k={tags:["!dev","!test"],render:a=>l.createElement("div",{className:"flex flex-col gap-4 sm:flex-row"},l.createElement(c,{...b.args,className:"sm:flex-1"}),l.createElement(c,{...d.args,className:"sm:flex-1"}),l.createElement(c,{...p.args,className:"sm:flex-1"}),l.createElement(c,{...g.args,className:"sm:flex-1"}))},B={tags:["!dev","!test"],render:a=>l.createElement("div",{className:"flex flex-col gap-4 sm:flex-row sm:items-center"},l.createElement(c,{...h.args,className:"sm:flex-1"}),l.createElement(c,{...u.args,className:"sm:flex-1"}),l.createElement(c,{...m.args,className:"sm:flex-1"}),l.createElement(c,{...x.args,className:"sm:flex-1"}))};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
    required: true,
    label: 'A label',
    hint: 'A hint',
  ...
  play: async ({
    ...
    await step('Assert the small sizer style of both the Checkboxes & Fieldset', async () => {
  ...
  args: {
    ...
    sizer: [Checkbox.sizer.small, Checkboxes.sizer.smBase, Checkboxes.sizer.mdLarge],
    options: [{
      value: 'one',
      label: 'Option one'
    }, {
...
}`,...B.parameters?.docs?.source}}};const O=["FieldsetLayout","NoValue","Controlled","Uncontrolled","Disabled","StandardLayout","CustomLayout","Small","Base","Large","Responsive","AllControlStates","AllSizes"],S=Object.freeze(Object.defineProperty({__proto__:null,AllControlStates:k,AllSizes:B,Base:u,Controlled:d,CustomLayout:v,Disabled:g,FieldsetLayout:C,Large:m,NoValue:b,Responsive:x,Small:h,StandardLayout:y,Uncontrolled:p,__namedExportsOrder:O,default:f},Symbol.toStringTag,{value:"Module"}));export{v as C,S,y as a};
