import{g as Be,r as i}from"./iframe-Bif7ZPbp.js";import{F as Me}from"./Field-CcnIcdx8.js";import{c as De,F as h}from"./index-C4eiBceS.js";import{r as Q}from"./randomId-Dfhrkieu.js";var P={exports:{}},me;function ze(){return me||(me=1,function(s,r){function t(f){if(f&&typeof f=="object"){var d=f.which||f.keyCode||f.charCode;d&&(f=d)}if(typeof f=="number")return z[f];var u=String(f),c=e[u.toLowerCase()];if(c)return c;var c=n[u.toLowerCase()];if(c)return c;if(u.length===1)return u.charCodeAt(0)}t.isEventKey=function(d,u){if(d&&typeof d=="object"){var c=d.which||d.keyCode||d.charCode;if(c==null)return!1;if(typeof u=="string"){var v=e[u.toLowerCase()];if(v)return v===c;var v=n[u.toLowerCase()];if(v)return v===c}else if(typeof u=="number")return u===c;return!1}},r=s.exports=t;var e=r.code=r.codes={backspace:8,tab:9,enter:13,shift:16,ctrl:17,alt:18,"pause/break":19,"caps lock":20,esc:27,space:32,"page up":33,"page down":34,end:35,home:36,left:37,up:38,right:39,down:40,insert:45,delete:46,command:91,"left command":91,"right command":93,"numpad *":106,"numpad +":107,"numpad -":109,"numpad .":110,"numpad /":111,"num lock":144,"scroll lock":145,"my computer":182,"my calculator":183,";":186,"=":187,",":188,"-":189,".":190,"/":191,"`":192,"[":219,"\\":220,"]":221,"'":222},n=r.aliases={windows:91,"⇧":16,"⌥":18,"⌃":17,"⌘":91,ctl:17,control:17,option:18,pause:19,break:19,caps:20,return:13,escape:27,spc:32,spacebar:32,pgup:33,pgdn:34,ins:45,del:46,cmd:91};/*!
 * Programatically add the following
 */for(o=97;o<123;o++)e[String.fromCharCode(o)]=o-32;for(var o=48;o<58;o++)e[o-48]=o;for(o=1;o<13;o++)e["f"+o]=o+111;for(o=0;o<10;o++)e["numpad "+o]=o+96;var z=r.names=r.title={};for(o in e)z[e[o]]=o;for(var S in n)e[S]=n[S]}(P,P.exports)),P.exports}var qe=ze();const Ue=Be(qe);function _e(s){let r=!1;function t(...e){r||(r=!0,requestAnimationFrame(()=>{r=!1,s(...e)}))}return t}const Ie=De({slots:{root:"w-full relative outline-0 cursor-pointer",track:`
    ...
    `,input:"hidden"},variants:{sizer:{[h.small]:{root:"h-5",track:`
        ...
        `}},isDisabled:{true:{root:"cursor-not-allowed",track:"bg-gray-100 before:bg-gray-300",fill:"bg-gray-300",thumb:"bg-gray-100 border-gray-300 shadow-none"}},hasError:{true:{track:"before:bg-rose-800",fill:"bg-rose-800",thumb:"border-rose-800"}},hasFieldHeader:{true:{}},hasFieldFooter:{true:{}},atMin:{true:{track:"before:hidden"}},atMax:{true:{track:"after:hidden"}}},compoundVariants:[{isFocused:!0,hasError:!0,className:{thumb:"after:bg-rose-800"}},{hasFieldHeader:!0,sizer:h.small,className:{root:"mt-2"}},{hasFieldHeader:!0,sizer:h.medium,className:{root:"mt-3"}},{hasFieldHeader:!0,sizer:h.large,className:{root:"mt-4"}},{hasFieldFooter:!0,sizer:h.small,className:{root:"mb-2"}},{hasFieldFooter:!0,sizer:h.medium,className:{root:"mb-3"}},{hasFieldFooter:!0,sizer:h.large,className:{root:"mb-4"}}],defaultVariants:{sizer:h.small,isFocused:!1,isDisabled:!1,atMin:!0,atMax:!1}});function Oe(s,r,t){return((s-r)/(t-r)||0)*100}function p({className:s,sizer:r,label:t,error:e,hint:n,disabled:o,required:z,ref:S,name:f,max:d=100,min:u=0,step:c=1,shiftSteps:v=10,tabIndex:pe,value:ee,defaultValue:j,onChange:fe,onMouseDown:he,onTouchStart:ve,onKeyDown:ge,onFocus:ye,onBlur:we,"aria-labelledby":be,"aria-describedby":Se,"aria-errormessage":He,"aria-invalid":ae,...xe}){const te=i.useRef(null),K=i.useRef(null),g=i.useRef(null),[q,X]=i.useState(!1),[G,re]=i.useState(!1),[ke,se]=i.useState(j!==void 0?Number(j):void 0),U=ee!==void 0?Number(ee):ke,y=U===void 0?u:U,[ne,Ee]=i.useState();function oe(l){const m=parseFloat(l.toFixed(5));if(se(m),g.current){const x=window.HTMLInputElement.prototype,w=Object.getOwnPropertyDescriptor(x,"value").set;if(w){const N=new Event("input",{bubbles:!0});w.call(g.current,m),g.current.dispatchEvent(N)}}}function $(l){if(!K.current)return;const{left:m,right:x,width:de}=K.current.getBoundingClientRect();let w="touches"in l?l.touches[0].clientX:l.clientX;w<m?w=m:w>x&&(w=x);let N=(w-m)/de*(d-u)+u;N=Math.round(N/c)*c,oe(N)}const _=_e(l=>{$(l)});function Ve(l){o||(document.addEventListener("mousemove",_),document.addEventListener("mouseup",le),$(l.nativeEvent),he?.(l),l.preventDefault(),q||X(!0),te.current?.focus())}function le(){document.removeEventListener("mousemove",_),document.removeEventListener("mouseup",le)}function Ae(l){o||(document.addEventListener("touchmove",_),document.addEventListener("touchup",k),document.addEventListener("touchend",k),document.addEventListener("touchcancel",k),$(l.nativeEvent),ve?.(l),l.preventDefault())}function k(){document.removeEventListener("touchmove",_),document.removeEventListener("touchup",k),document.removeEventListener("touchend",k),document.removeEventListener("touchcancel",k)}function Fe(l){if(!o){let m;const x=l.nativeEvent.shiftKey;switch(Ue(l.nativeEvent)||l.nativeEvent.key){case"right":case"ArrowRight":case"up":case"ArrowUp":m=Math.min(d,y+(x?c*v:c));break;case"page up":case"PageUp":m=Math.min(d,y+c*v);break;case"left":case"ArrowLeft":case"down":case"ArrowDown":m=Math.max(u,y-(x?c*v:c));break;case"page down":case"PageDown":m=Math.max(u,y-c*v);break;case"home":case"Home":m=u;break;case"end":case"End":m=d;break;case"esc":case"Escape":if(ne!==void 0){m=ne;break}else return;default:return}oe(m),ge?.(l),l.preventDefault(),q&&X(!1)}}function Ce(l){o||(G||(re(!0),Ee(y)),ye?.(l))}function Te(l){o||(q&&X(!1),G&&re(!1),g.current&&we?.({...l,target:g.current,currentTarget:g.current}))}i.useLayoutEffect(()=>{U===void 0&&j===void 0&&g.current?.value!=null&&se(Number(g.current.value))},[]);function W(l){return typeof l=="function"?l({value:y,min:u,max:d,step:c}):l}const Y=W(t),J=W(n),H=W(e),[Le]=i.useState(Q()),ie=be||(Y?Le:void 0),[Ne]=i.useState(Q()),ce=Se||(J?Ne:void 0),[Re]=i.useState(Q()),ue=He||(H&&H!==!0?Re:void 0),I=Oe(y,u,d),O=Ie({sizer:r,isDisabled:o,isFocused:G&&!o&&!q,hasFieldHeader:!!Y,hasFieldFooter:!!(H&&H!==!0||J),hasError:!!H,atMin:I===0,atMax:I===100});return i.createElement(Me,{className:s,sizer:r,label:Y,labelId:ie,hint:J,hintId:ce,error:H,errorId:ue,disabled:o,required:z},i.createElement("div",{...xe,ref:te,className:O.root(),role:"slider",tabIndex:o?-1:pe||0,onMouseDown:Ve,onTouchStart:Ae,onFocus:Ce,onBlur:Te,onKeyDown:Fe,"aria-disabled":o,"aria-valuemax":d,"aria-valuemin":u,"aria-valuenow":y,"aria-labelledby":ie,"aria-describedby":ce,"aria-errormessage":ue,"aria-invalid":ae!==void 0?ae:!!H},i.createElement("div",{ref:K,className:O.track()},i.createElement("div",{className:O.fill(),style:{right:`${100-I}%`},"data-testid":"fill"}),i.createElement("div",{className:O.thumb(),style:{left:`${I}%`},"data-testid":"thumb"}))),i.createElement("input",{ref:l=>{g.current=l,typeof S=="function"?S(l):S&&(S.current=l)},type:"text",name:f,className:"hidden","aria-hidden":!0,defaultValue:U,onChange:fe}))}p.sizer=h;p.__docgenInfo={description:`A form control that allows users to choose a number within a range.
...
}`,...D.parameters?.docs?.source}}};const je=["FieldLayout","NoValue","Controlled","Uncontrolled","Disabled","CustomRange","Small","Medium","Large","AllControlStates","AllSizes"],Ye=Object.freeze(Object.defineProperty({__proto__:null,AllControlStates:M,AllSizes:D,Controlled:V,CustomRange:B,Disabled:F,FieldLayout:R,Large:L,Medium:T,NoValue:E,Small:C,Uncontrolled:A,__namedExportsOrder:je,default:Pe},Symbol.toStringTag,{value:"Module"}));export{B as C,Ye as S,p as a};
