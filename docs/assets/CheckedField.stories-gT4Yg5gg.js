import{r as e}from"./iframe-B-Uinc_h.js";import{D as n}from"./index-CHuDmDyx.js";import{C as r}from"./CheckedField-Bv-NBShP.js";const y={title:"Field layouts/CheckedField",component:r},t={tags:["!dev","!test"],args:{children:e.createElement(n.FormControlPlaceholder,{tiny:!0}),label:"A label for the field",hint:"A hint for the field"}},a={args:{sizer:r.sizer.small,children:e.createElement(n.FormControlPlaceholder,{tiny:!0}),label:"Small label",hint:"Small hint"}},l={args:{sizer:r.sizer.medium,children:e.createElement(n.FormControlPlaceholder,{tiny:!0}),label:"Medium label",hint:"Medium hint"}},s={args:{sizer:r.sizer.large,children:e.createElement(n.FormControlPlaceholder,{tiny:!0}),label:"Large label",hint:"Large hint"}},o={tags:["!dev","!test"],render:()=>e.createElement("div",{className:"flex flex-col gap-5 sm:flex-row sm:items-baseline"},e.createElement(r,{...a.args,className:"sm:flex-1"}),e.createElement(r,{...l.args,className:"sm:flex-1"}),e.createElement(r,{...s.args,className:"sm:flex-1"}))};var i,c,m;t.parameters={...t.parameters,docs:{...(i=t.parameters)==null?void 0:i.docs,source:{originalSource:`{
  tags: ['!dev', '!test'],
  args: {
...
}`,...(z=(x=o.parameters)==null?void 0:x.docs)==null?void 0:z.source}}};const E=["Basic","Small","Medium","Large","AllSizes"],M=Object.freeze(Object.defineProperty({__proto__:null,AllSizes:o,Basic:t,Large:s,Medium:l,Small:a,__namedExportsOrder:E,default:y},Symbol.toStringTag,{value:"Module"}));export{t as B,M as S};
