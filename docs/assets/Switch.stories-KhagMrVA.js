import{r as a}from"./iframe-B-Uinc_h.js";import{S as e}from"./Switch-Dbi9CZz5.js";const Q={title:"Form controls/Switch",component:e},i={tags:["!dev","!test"],args:{label:"A label",hint:"A hint"}},r={args:{label:"Unchecked Switch"}},s={args:{label:"Controlled Switch",checked:!0,onChange:()=>{}}},t={args:{label:"Uncontrolled Switch",defaultChecked:!0}},c={args:{label:"Disabled Switch",disabled:!0}},l={args:{label:"Disabled & checked Switch",disabled:!0,defaultChecked:!0}},m={tags:["!dev","!test"],render:()=>a.createElement("div",{className:"flex flex-col gap-4"},a.createElement(e,{...r.args}),a.createElement(e,{...s.args}),a.createElement(e,{...t.args}),a.createElement(e,{...c.args}),a.createElement(e,{...l.args}))},o={args:{label:"Small Switch (default)",defaultChecked:!0}},d={args:{sizer:e.sizer.medium,label:"Medium Switch",defaultChecked:!0}},n={args:{sizer:e.sizer.large,label:"Large Switch",defaultChecked:!0}},u={tags:["!dev","!test"],render:()=>a.createElement("div",{className:"flex flex-col gap-5 sm:flex-row sm:items-baseline"},a.createElement(e,{...o.args,className:"sm:flex-1"}),a.createElement(e,{...d.args,className:"sm:flex-1"}),a.createElement(e,{...n.args,className:"sm:flex-1"}))};var g,h,p;i.parameters={...i.parameters,docs:{...(g=i.parameters)==null?void 0:g.docs,source:{originalSource:`{
...
}`,...(N=(D=c.parameters)==null?void 0:D.docs)==null?void 0:N.source}}};var U,A,L;l.parameters={...l.parameters,docs:{...(U=l.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    label: 'Disabled & checked Switch',
    disabled: true,
    defaultChecked: true
  }
}`,...(L=(A=l.parameters)==null?void 0:A.docs)==null?void 0:L.source}}};var M,_,y;m.parameters={...m.parameters,docs:{...(M=m.parameters)==null?void 0:M.docs,source:{originalSource:`{
  tags: ['!dev', '!test'],
...
}`,...(y=(_=m.parameters)==null?void 0:_.docs)==null?void 0:y.source}}};var F,O,j;o.parameters={...o.parameters,docs:{...(F=o.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
  ...
  tags: ['!dev', '!test'],
  render: () => <div className="flex flex-col gap-5 sm:flex-row sm:items-baseline">
      <Switch {...Small.args} className="sm:flex-1" />
      <Switch {...Medium.args} className="sm:flex-1" />
      <Switch {...Large.args} className="sm:flex-1" />
    </div>
}`,...(K=(J=u.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};const R=["CheckedFieldLayout","Unchecked","Controlled","Uncontrolled","Disabled","DisabledChecked","AllControlStates","Small","Medium","Large","AllSizes"],X=Object.freeze(Object.defineProperty({__proto__:null,AllControlStates:m,AllSizes:u,CheckedFieldLayout:i,Controlled:s,Disabled:c,DisabledChecked:l,Large:n,Medium:d,Small:o,Unchecked:r,Uncontrolled:t,__namedExportsOrder:R,default:Q},Symbol.toStringTag,{value:"Module"}));export{X as S};
