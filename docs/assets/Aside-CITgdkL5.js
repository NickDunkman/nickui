...
`,e.jsxs(n.p,{children:["Coloring is done via the ",e.jsx(n.code,{children:"flavor"})," prop. You can pass ",e.jsx(n.code,{children:'"info"'}),` (the default),
`,e.jsx(n.code,{children:'"yep"'}),", ",e.jsx(n.code,{children:'"maybe"'})," or ",e.jsx(n.code,{children:'"nope"'}),"."]}),`
`,e.jsx(h,{of:p}),`
