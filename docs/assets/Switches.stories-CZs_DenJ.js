import{r as l}from"./iframe-D0vVQOb0.js";import{S as B}from"./Switch-DQZmv_9I.js";import{S as k}from"./index-BJKEptQa.js";import{a as S}from"./Checkboxes-DcMJc83X.js";function r({delimiter:a=",",...n}){return l.createElement(S,{...n,Checkable:B,delimiter:a})}r.sizer=k;r.__docgenInfo={description:`Renders multiple <Switch> as one field in a <Fieldset>.
...
number format`},error:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Error message to show along with the field"},required:{required:!1,tsType:{name:"boolean"},description:"Adds an asterisk to the label"},disabled:{required:!1,tsType:{name:"boolean"},description:"Prevents the user from interacting with the control"}},composes:["Omit"]};const{expect:e,fn:c}=__STORYBOOK_MODULE_TEST__,T={title:"Form controls/Switches",component:r},v={args:{required:!0,label:"A label",hint:"A hint",error:"An error message",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:c()},play:async({canvas:a,step:n})=>{const t=a.getByRole("group"),o=a.getByTitle("required");await n("Assert accessibility of layout elements",async()=>{e(t).toHaveAccessibleName("A label*"),e(t).toHaveAccessibleDescription("A hint"),e(t).toHaveAccessibleErrorMessage("An error message"),e(o).toHaveTextContent("*")})}},d={args:{label:"No valueish prop",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:c()},play:async({args:a,canvas:n,step:t,userEvent:o})=>{const s=n.getByLabelText("Option one"),i=n.getByLabelText("Option two");await t("Assert initial all-unchecked state",async()=>{e(s).not.toBeChecked(),e(i).not.toBeChecked()}),await t("Check first Switch using the keyboard",async()=>{await o.tab(),e(s).toHaveFocus(),await o.keyboard(" "),e(s).toBeChecked(),e(i).not.toBeChecked(),e(a.onChange).toHaveBeenCalledOnce()}),await t("Check second Switch using the mouse",async()=>{await o.click(i),e(s).toBeChecked(),e(i).toBeChecked(),e(a.onChange).toHaveBeenCalledTimes(2)}),await t("Reset all checked states",async()=>{await o.click(s),e(s).not.toBeChecked(),await o.click(i),e(i).not.toBeChecked()})}},p={args:{label:"Controlled",value:"one",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:c()},play:async({args:a,canvas:n,step:t,userEvent:o})=>{const s=n.getByLabelText("Option one"),i=n.getByLabelText("Option two");await t("Assert `value` prop works",async()=>{e(s).toBeChecked(),e(i).not.toBeChecked()}),await t("Try toggling a Switch. `onChange` should fire, but the value is controlled, so the Switch shouldn’t toggle",async()=>{await o.click(s),e(a.onChange).toHaveBeenCalled(),e(s).toBeChecked(),e(i).not.toBeChecked()})}},u={args:{label:"Uncontrolled",defaultValue:"one",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:c()},play:async({args:a,canvas:n,step:t,userEvent:o})=>{const s=n.getByLabelText("Option one"),i=n.getByLabelText("Option two");await t("Assert `defaultValue` prop works",async()=>{e(s).toBeChecked(),e(i).not.toBeChecked()}),await t("Toggling a Switch should both fire onChange & toggle the checked state, since the value is uncontrolled.",async()=>{await o.click(s),e(a.onChange).toHaveBeenCalled(),e(s).not.toBeChecked(),e(i).not.toBeChecked()}),await t("Reset to original value",async()=>{await o.click(s)})}},g={args:{label:"Disabled",defaultValue:"one",disabled:!0,options:[{value:"one",label:"Option one",disabled:!1},{value:"two",label:"Option two"}],onChange:c()},play:async({canvas:a,step:n})=>{await n("Assert all Switches are disabled",async()=>{e(a.getByLabelText("Option one")).toBeDisabled(),e(a.getByLabelText("Option two")).toBeDisabled()})}},w={args:{label:"Please select some standards",defaultValue:"8601",options:[{value:"aquila",label:"Roman Aquila"},{value:"8601",label:"ISO 8601"},{value:"high-society",label:"High Society",disabled:!0}],onChange:c()},play:async({canvas:a,step:n})=>{const t=a.getByLabelText("Roman Aquila"),o=a.getByLabelText("ISO 8601"),s=a.getByLabelText("High Society");await n("Assert the controlled Switches are configured correctly",async()=>{e(t).not.toBeChecked(),e(t).not.toBeDisabled(),e(o).toBeChecked(),e(o).not.toBeDisabled(),e(s).not.toBeChecked(),e(s).toBeDisabled()})}},f={args:{label:"Please select some customizations",defaultValue:"colorful,embiggened",render:a=>l.createElement("div",{className:"flex flex-row items-baseline gap-x-6"},l.createElement(B,{...a({value:"colorful"}),label:l.createElement("span",{className:"font-bold text-blue-700"},"Colorful"),className:"rounded-sm bg-rose-200 p-2"}),l.createElement(B,{...a({value:"embiggened"}),sizer:B.sizer.large,label:"Embiggened"}),l.createElement("label",null,l.createElement("input",{type:"checkbox",...a({value:"native"}),"aria-label":"example using different control component"})," ","Native")),onChange:c()},play:async({canvas:a,step:n})=>{const t=a.getByLabelText("Colorful"),o=a.getByLabelText("Embiggened"),s=a.getByLabelText("Native");await n("Assert the render function’s callback works",async()=>{e(t).toBeChecked(),e(o).toBeChecked(),e(s).not.toBeChecked()})}},h={args:{sizer:r.sizer.small,label:"Small label",hint:"Small hint",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:c()},play:async({canvas:a,step:n})=>{await n("Assert the small sizer style of both the Switches & Fieldset",async()=>{a.getAllByTestId("indicator").forEach(t=>{e(t).toHaveClass("h-5")}),e(a.getByText("Small label")).toHaveClass("text-xs")})}},m={args:{sizer:r.sizer.base,label:"Base label",hint:"Base hint",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:c()},play:async({canvas:a,step:n})=>{await n("Assert the base sizer style of both the Switches & Fieldset",async()=>{a.getAllByTestId("indicator").forEach(t=>{e(t).toHaveClass("h-6")}),e(a.getByText("Base label")).toHaveClass("text-sm")})}},b={args:{sizer:r.sizer.large,label:"Large label",hint:"Large hint",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:c()},play:async({canvas:a,step:n})=>{await n("Assert the laerge style of both the Switches & Fieldset",async()=>{a.getAllByTestId("indicator").forEach(t=>{e(t).toHaveClass("h-7")}),e(a.getByText("Large label")).toHaveClass("text-lg")})}},y={tags:["!test"],args:{sizer:[r.sizer.small,r.sizer.smBase,r.sizer.mdLarge],label:"Responsive label",hint:"Responsive hint",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:c()}},x={tags:["!dev","!test"],render:a=>l.createElement("div",{className:"flex flex-col gap-4 sm:flex-row"},l.createElement(r,{...d.args,className:"sm:flex-1"}),l.createElement(r,{...p.args,className:"sm:flex-1"}),l.createElement(r,{...u.args,className:"sm:flex-1"}),l.createElement(r,{...g.args,className:"sm:flex-1"}))},C={tags:["!dev","!test"],render:a=>l.createElement("div",{className:"flex flex-col gap-4 sm:flex-row sm:items-baseline"},l.createElement(r,{...h.args,className:"sm:flex-1"}),l.createElement(r,{...m.args,className:"sm:flex-1"}),l.createElement(r,{...b.args,className:"sm:flex-1"}),l.createElement(r,{...y.args,className:"sm:flex-1"}))};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    required: true,
    label: 'A label',
    hint: 'A hint',
  ...
  play: async ({
    ...
    await step('Assert the small sizer style of both the Switches & Fieldset', async () => {
  ...
  tags: ['!test'],
  args: {
    sizer: [Switches.sizer.small, Switches.sizer.smBase, Switches.sizer.mdLarge],
...
}`,...C.parameters?.docs?.source}}};const O=["FieldsetLayout","NoValue","Controlled","Uncontrolled","Disabled","StandardLayout","CustomLayout","Small","Base","Large","Responsive","AllControlStates","AllSizes"],E=Object.freeze(Object.defineProperty({__proto__:null,AllControlStates:x,AllSizes:C,Base:m,Controlled:p,CustomLayout:f,Disabled:g,FieldsetLayout:v,Large:b,NoValue:d,Responsive:y,Small:h,StandardLayout:w,Uncontrolled:u,__namedExportsOrder:O,default:T},Symbol.toStringTag,{value:"Module"}));export{f as C,E as S,r as a,w as b};
