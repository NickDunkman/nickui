import{r as n}from"./iframe-DVoMRv_a.js";import{C as j}from"./Checkbox-US4qxRTr.js";import{F as V}from"./Fieldset-B9LPp2Mv.js";import{F as m}from"./index-Czi7Upa3.js";import{c as M}from"./clsw-D-KgF5mV.js";import{r as L}from"./randomId-Dfhrkieu.js";function x({delimiter:o=",",...t}){return n.createElement(P,{...t,delimiter:o,Checkable:j})}x.sizer=m;function P({className:o,sizer:t,label:d,explainer:r,hint:h,error:c,disabled:i,required:v,Checkable:E,name:F,value:w,defaultValue:N,options:u,children:f,onChange:g,onBlur:b,delimiter:p,...I}){const l=n.createRef(),[O]=n.useState(L()),[S,k]=n.useState(N),q=w!==void 0,s=q?w:S,R=!s||s===""?[]:p?s.split(p):[s];function z(e){let a;p?a=(e.target.checked?[...R,e.target.value]:R.filter(H=>H!==e.target.value)).sort(_(l)).join(p):a=e.target.checked?e.target.value:"",q||k(a);const T=y(l);T.value=a,g==null||g({...e,target:T})}function A(e){const a=y(l);b==null||b({...e,target:a})}function C({value:e,disabled:a=!1}){return{name:O,value:e,checked:R.includes(e),onChange:z,onBlur:A,disabled:i||a}}return n.useLayoutEffect(()=>{if(s===void 0&&N===void 0){const e=y(l);e.value&&k(e.value)}},[]),n.createElement(V,{className:o,sizer:t,label:d,explainer:r,hint:h,error:c,disabled:i,required:v},n.createElement("div",{ref:l,className:u&&M("flex flex-col",{"gap-y-2":!t||t===m.small,"gap-y-2.5":t===m.medium,"gap-y-3":t===m.large})},u&&n.createElement(n.Fragment,null,u.map(e=>{var a;return n.createElement(E,{key:(a=e.value)==null?void 0:a.toString(),sizer:t,...C({value:e.value,disabled:e.disabled}),label:e.label,explainer:e.explainer})})),!u&&(f==null?void 0:f(C)),n.createElement("input",{...I,name:F,type:"hidden",className:"the-hidden-input hidden",disabled:i,required:v})))}function _(o){var d;const t=[...((d=o.current)==null?void 0:d.getElementsByTagName("input"))||[]].filter(r=>r.type==="checkbox"||r.type==="radio").map(r=>r.value);return(r,h)=>{const c=t.indexOf(r),i=t.indexOf(h);return i===-1?-1:c===-1?1:c-i}}function y(o){var t;return[...((t=o.current)==null?void 0:t.getElementsByClassName("the-hidden-input"))||[]][0]}x.__docgenInfo={description:`Renders multiple checkboxes as one field in a Fieldset.
...
@props {@link CheckablesProps} + {@link CommonFieldProps}`,methods:[],displayName:"Checkboxes",props:{name:{required:!1,tsType:{name:"string"},description:"The name for the field"},children:{required:!1,tsType:{name:"signature",type:"function",raw:`(
  inputProps: (control: {
    value: string;
    disabled?: boolean;
...
(such as when using radios).,`,methods:[],displayName:"Checkables",props:{name:{required:!1,tsType:{name:"string"},description:"The name for the field"},children:{required:!1,tsType:{name:"signature",type:"function",raw:`(
  inputProps: (control: {
    value: string;
    disabled?: boolean;
  }) => React.ComponentProps<'input'>,
