import{r as l}from"./iframe-hb8Gt22z.js";import{A as _}from"./AllSizersStoryWrapper-tjgd90o1.js";import{g as q}from"./getStoryArgTypes-C9YzteSP.js";import{F as D}from"./Field-B4UhGOtL.js";import{a as O}from"./fieldA11y-DLefJadd.js";import{u as F}from"./index-D1YhH-ng.js";import{t as R}from"./styles-BvYzL3LC.js";const X=["date","datetime","datetime-local","email","month","number","password","search","tel","text","time","url","week"];function o({className:t,sizer:n,label:e,hint:s,error:r,required:w,disabled:C,id:z,"aria-label":H,"aria-labelledby":S,"aria-describedby":E,"aria-errormessage":B,"aria-invalid":k,...V}){const A=O({label:e,hint:s,error:r,controlledId:z,controlledAriaLabel:H,controlledAriaLabelledBy:S,controlledAriaDescribedBy:E,controlledAriaErrorMessage:B,controlledAriaInvalid:k}),L=F(n),N=R({sizer:L,hasError:!!r});return l.createElement(D,{...A.field,className:t,sizer:n,label:e,hint:s,error:r!==!0?r:void 0,required:w,"data-nickui-component":"Text"},l.createElement("input",{...V,...A.formControl,className:N,disabled:C,required:w}))}o.__docgenInfo={description:`A form control that allows users to enter & edit a single line of text
