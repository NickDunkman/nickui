import{r as e}from"./iframe-DOqKYI6o.js";import{D as r}from"./index-Bo1lOt9r.js";import{F as s}from"./Fieldset-TrMugLKy.js";const n={title:"Field layouts/Fieldset",component:s},c={tags:["!dev","!test"],args:{children:[e.createElement(r.FormControlPlaceholder,{key:"first",className:"mb-2"}),e.createElement(r.FormControlPlaceholder,{key:"second"})],label:"A label for the fieldset",hint:"A hint about the fieldset’s values",error:"An error message",required:!0}},a={args:{sizer:s.sizer.small,children:[e.createElement(r.FormControlPlaceholder,{key:"first",className:"mb-2"}),e.createElement(r.FormControlPlaceholder,{key:"second"})],label:"Small label",hint:"Small hint",error:"Small error",required:!0}},l={args:{sizer:s.sizer.medium,children:[e.createElement(r.FormControlPlaceholder,{key:"first",className:"mb-2"}),e.createElement(r.FormControlPlaceholder,{key:"second"})],label:"Medium label",hint:"Medium hint",error:"Medium error",required:!0}},o={args:{sizer:s.sizer.large,children:[e.createElement(r.FormControlPlaceholder,{key:"first",className:"mb-2"}),e.createElement(r.FormControlPlaceholder,{key:"second"})],label:"Large label",hint:"Large hint",error:"Large error",required:!0}},t={args:{sizer:[s.sizer.small,s.sizer.smMedium,s.sizer.mdLarge],children:[e.createElement(r.FormControlPlaceholder,{key:"first",className:"mb-2"}),e.createElement(r.FormControlPlaceholder,{key:"second"})],label:"Responsive label",hint:"Responsive hint",error:"Responsive error",required:!0}},m={tags:["!dev","!test"],render:h=>e.createElement("div",{className:"flex flex-col gap-5 sm:flex-row sm:items-baseline"},e.createElement(s,{...a.args,className:"sm:flex-1"}),e.createElement(s,{...l.args,className:"sm:flex-1"}),e.createElement(s,{...o.args,className:"sm:flex-1"}),e.createElement(s,{...t.args,className:"sm:flex-1"}))},i={args:{children:[e.createElement(r.FormControlPlaceholder,{key:"first",className:"mb-2"}),e.createElement(r.FormControlPlaceholder,{key:"second"})],label:"Select some comparables",error:"These cannot be compared"}},d={args:{children:[e.createElement(r.FormControlPlaceholder,{key:"first",className:"mb-2"}),e.createElement(r.FormControlPlaceholder,{key:"second"})],label:"Your name",required:!0}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  ...
  args: {
    sizer: [Fieldset.sizer.small, Fieldset.sizer.smMedium, Fieldset.sizer.mdLarge],
    children: [<Docs.FormControlPlaceholder key="first" className="mb-2" />, <Docs.FormControlPlaceholder key="second" />],
...
}`,...d.parameters?.docs?.source}}};const u=["Basic","Small","Medium","Large","Responsive","AllSizes","Error","Required"],F=Object.freeze(Object.defineProperty({__proto__:null,AllSizes:m,Basic:c,Error:i,Large:o,Medium:l,Required:d,Responsive:t,Small:a,__namedExportsOrder:u,default:n},Symbol.toStringTag,{value:"Module"}));export{c as B,d as R,F as S};
