...
}`,...d.parameters?.docs?.source}}};const C=["neutral","positive","caution","negative","xs","sm","base","lg","xl","responsive","allFlavors","allSizers"],E=Object.freeze(Object.defineProperty({__proto__:null,__namedExportsOrder:C,allFlavors:x,allSizers:d,base:u,caution:o,default:B,lg:g,negative:i,neutral:r,positive:n,responsive:p,sm:c,xl:v,xs:m},Symbol.toStringTag,{value:"Module"}));export{t as S,E as s};
