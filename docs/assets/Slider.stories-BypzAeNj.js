import{g as ur,r as t}from"./iframe-DYxnnFe3.js";import{F as dr}from"./Field-B3CBD8It.js";import{c as cr,F as c}from"./index-Czi7Upa3.js";import{r as te}from"./randomId-Dfhrkieu.js";var X={exports:{}},pe;function mr(){return pe||(pe=1,function(m,n){function p(d){if(d&&typeof d=="object"){var o=d.which||d.keyCode||d.charCode;o&&(d=o)}if(typeof d=="number")return A[d];var a=String(d),s=i[a.toLowerCase()];if(s)return s;var s=y[a.toLowerCase()];if(s)return s;if(a.length===1)return a.charCodeAt(0)}p.isEventKey=function(o,a){if(o&&typeof o=="object"){var s=o.which||o.keyCode||o.charCode;if(s==null)return!1;if(typeof a=="string"){var h=i[a.toLowerCase()];if(h)return h===s;var h=y[a.toLowerCase()];if(h)return h===s}else if(typeof a=="number")return a===s;return!1}},n=m.exports=p;var i=n.code=n.codes={backspace:8,tab:9,enter:13,shift:16,ctrl:17,alt:18,"pause/break":19,"caps lock":20,esc:27,space:32,"page up":33,"page down":34,end:35,home:36,left:37,up:38,right:39,down:40,insert:45,delete:46,command:91,"left command":91,"right command":93,"numpad *":106,"numpad +":107,"numpad -":109,"numpad .":110,"numpad /":111,"num lock":144,"scroll lock":145,"my computer":182,"my calculator":183,";":186,"=":187,",":188,"-":189,".":190,"/":191,"`":192,"[":219,"\\":220,"]":221,"'":222},y=n.aliases={windows:91,"⇧":16,"⌥":18,"⌃":17,"⌘":91,ctl:17,control:17,option:18,pause:19,break:19,caps:20,return:13,escape:27,spc:32,spacebar:32,pgup:33,pgdn:34,ins:45,del:46,cmd:91};/*!
 * Programatically add the following
 */for(r=97;r<123;r++)i[String.fromCharCode(r)]=r-32;for(var r=48;r<58;r++)i[r-48]=r;for(r=1;r<13;r++)i["f"+r]=r+111;for(r=0;r<10;r++)i["numpad "+r]=r+96;var A=n.names=n.title={};for(r in i)A[i[r]]=r;for(var v in y)i[v]=y[v]}(X,X.exports)),X.exports}var fr=mr();const pr=ur(fr);function hr(m){let n=!1;function p(...i){n||(n=!0,requestAnimationFrame(()=>{n=!1,m(...i)}))}return p}const gr=cr({slots:{root:"w-full relative outline-0 cursor-pointer",track:`
    ...
    `,input:"hidden"},variants:{sizer:{[c.small]:{root:"h-5",track:`
        ...
        `}},isDisabled:{true:{root:"cursor-not-allowed",track:"bg-gray-100 before:bg-gray-300",fill:"bg-gray-300",thumb:"bg-gray-100 border-gray-300 shadow-none"}},hasError:{true:{track:"before:bg-rose-800",fill:"bg-rose-800",thumb:"border-rose-800"}},hasFieldHeader:{true:{}},hasFieldFooter:{true:{}},atMin:{true:{track:"before:hidden"}},atMax:{true:{track:"after:hidden"}}},compoundVariants:[{isFocused:!0,hasError:!0,className:{thumb:"after:bg-rose-800"}},{hasFieldHeader:!0,sizer:c.small,className:{root:"mt-2"}},{hasFieldHeader:!0,sizer:c.medium,className:{root:"mt-3"}},{hasFieldHeader:!0,sizer:c.large,className:{root:"mt-4"}},{hasFieldFooter:!0,sizer:c.small,className:{root:"mb-2"}},{hasFieldFooter:!0,sizer:c.medium,className:{root:"mb-3"}},{hasFieldFooter:!0,sizer:c.large,className:{root:"mb-4"}}],defaultVariants:{sizer:c.small,isFocused:!1,isDisabled:!1,atMin:!0,atMax:!1}});function br(m,n,p){return((m-n)/(p-n)||0)*100}function u({className:m,sizer:n,label:p,error:i,hint:y,disabled:r,required:A,ref:v,name:d,max:o=100,min:a=0,step:s=1,shiftSteps:h=10,tabIndex:We,value:ae,defaultValue:B,onChange:Ge,onMouseDown:U,onTouchStart:K,onKeyDown:$,onFocus:O,onBlur:W,"aria-labelledby":Je,"aria-describedby":Qe,"aria-errormessage":Ye,"aria-invalid":se,...Ze}){const ne=t.useRef(null),G=t.useRef(null),f=t.useRef(null),[D,J]=t.useState(!1),[Q,oe]=t.useState(!1),[er,le]=t.useState(B!==void 0?Number(B):void 0),j=ae!==void 0?Number(ae):er,z=j===void 0?a:j;function ie(e){const l=parseFloat(e.toFixed(5));if(le(l),f.current){const S=window.HTMLInputElement.prototype,g=Object.getOwnPropertyDescriptor(S,"value").set;if(g){const V=new Event("input",{bubbles:!0});g.call(f.current,l),f.current.dispatchEvent(V)}}}function Y(e){if(!G.current)return;const{left:l,right:S,width:fe}=G.current.getBoundingClientRect();let g="touches"in e?e.touches[0].clientX:e.clientX;g<l?g=l:g>S&&(g=S);let V=(g-l)/fe*(o-a)+a;V=Math.round(V/s)*s,ie(V)}const P=hr(e=>{Y(e)});function rr(e){var l;r||(document.addEventListener("mousemove",P),document.addEventListener("mouseup",ue),Y(e.nativeEvent),U==null||U(e),e.preventDefault(),D||J(!0),(l=ne.current)==null||l.focus())}function ue(){document.removeEventListener("mousemove",P),document.removeEventListener("mouseup",ue)}function tr(e){r||(document.addEventListener("touchmove",P),document.addEventListener("touchup",E),document.addEventListener("touchend",E),document.addEventListener("touchcancel",E),Y(e.nativeEvent),K==null||K(e),e.preventDefault())}function E(){document.removeEventListener("touchmove",P),document.removeEventListener("touchup",E),document.removeEventListener("touchend",E),document.removeEventListener("touchcancel",E)}function ar(e){if(!r){let l;const S=e.nativeEvent.shiftKey;switch(pr(e.nativeEvent)){case"right":case"up":case"page up":l=Math.min(o,z+(S?s*h:s));break;case"left":case"down":case"page down":l=Math.max(a,z-(S?s*h:s));break;case"home":l=a;break;case"end":l=o;break;default:return}ie(l),$==null||$(e),e.preventDefault(),D&&J(!1)}}function sr(e){r||(Q||oe(!0),O==null||O(e))}function nr(e){r||(D&&J(!1),Q&&oe(!1),f.current&&(W==null||W({...e,target:f.current,currentTarget:f.current})))}t.useLayoutEffect(()=>{var e;j===void 0&&B===void 0&&((e=f.current)==null?void 0:e.value)!=null&&le(Number(f.current.value))},[]);function Z(e){return typeof e=="function"?e({value:z,min:a,max:o,step:s}):e}const ee=Z(p),re=Z(y),w=Z(i),[or]=t.useState(te()),de=Je||(ee?or:void 0),[lr]=t.useState(te()),ce=Qe||(re?lr:void 0),[ir]=t.useState(te()),me=Ye||(w&&w!==!0?ir:void 0),_=br(z,a,o),I=gr({sizer:n,isDisabled:r,isFocused:Q&&!r&&!D,hasFieldHeader:!!ee,hasFieldFooter:!!(w&&w!==!0||re),hasError:!!w,atMin:_===0,atMax:_===100});return t.createElement(dr,{className:m,sizer:n,label:ee,labelId:de,hint:re,hintId:ce,error:w,errorId:me,disabled:r,required:A},t.createElement("div",{...Ze,ref:ne,className:I.root(),role:"slider",tabIndex:r?-1:We||0,onMouseDown:rr,onTouchStart:tr,onFocus:sr,onBlur:nr,onKeyDown:ar,"aria-valuemax":o,"aria-valuemin":a,"aria-valuenow":z,"aria-labelledby":de,"aria-describedby":ce,"aria-errormessage":me,"aria-invalid":se!==void 0?se:!!w},t.createElement("div",{ref:G,className:I.track()},t.createElement("div",{className:I.fill(),style:{right:`${100-_}%`}}),t.createElement("div",{className:I.thumb(),style:{left:`${_}%`}}))),t.createElement("input",{ref:e=>{f.current=e,typeof v=="function"?v(e):v&&(v.current=e)},type:"text",name:d,className:"hidden","aria-hidden":!0,defaultValue:j,onChange:Ge}))}u.sizer=c;u.__docgenInfo={description:`A form control that allows users to choose a number within a range.
...
number format`},error:{required:!1,tsType:{name:"ReactNode"},description:"Error message to show along with the field, or just `true` to trigger the\nerror style without showing an error message."},required:{required:!1,tsType:{name:"boolean"},description:"When `true`, adds an asterisk to the label"},disabled:{required:!1,tsType:{name:"boolean"},description:"Prevents the user from interacting with the control"}},composes:["Omit"]};const vr={title:"Form controls/Slider",component:u};function b(m){return{hint:({value:n})=>t.createElement("div",{className:"flex"},t.createElement("div",null,m),t.createElement("div",{className:"ml-auto"},n)),"aria-label":m}}const H={tags:["!dev","!test"],args:{label:"A label",hint:"A hint",error:"An error message",defaultValue:"50"}},F={args:b("Slider with no valueish prop")},N={args:{value:"50",...b("Slider with controlled value")}},L={args:{defaultValue:"50",...b("Slider with uncontrolled value")}},T={args:{disabled:!0,defaultValue:"50",...b("Disabled Slider")}},C={tags:["!dev","!test"],render:()=>t.createElement("div",{className:"flex flex-col gap-4"},t.createElement(u,{...F.args}),t.createElement(u,{...N.args}),t.createElement(u,{...L.args}),t.createElement(u,{...T.args}))},q={args:{defaultValue:"0",min:-1e3,max:1e3,step:.01,shiftSteps:500,...b("Slider with custom range")}},k={args:{sizer:u.sizer.small,defaultValue:"50",...b("Small Slider (default)")}},x={args:{sizer:u.sizer.medium,defaultValue:"50",...b("Medium Slider")}},M={args:{sizer:u.sizer.large,defaultValue:"50",...b("Large Slider")}},R={tags:["!dev","!test"],render:()=>t.createElement("div",{className:"flex flex-col items-center gap-5 sm:flex-row"},t.createElement(u,{...k.args,className:"sm:flex-1"}),t.createElement(u,{...x.args,className:"sm:flex-1"}),t.createElement(u,{...M.args,className:"sm:flex-1"}))};var he,ge,be;H.parameters={...H.parameters,docs:{...(he=H.parameters)==null?void 0:he.docs,source:{originalSource:`{
...
}`,...(Re=(qe=q.parameters)==null?void 0:qe.docs)==null?void 0:Re.source}}};var Ae,De,je;k.parameters={...k.parameters,docs:{...(Ae=k.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
  args: {
    sizer: Slider.sizer.small,
    defaultValue: '50',
    ...withMetaHint('Small Slider (default)')
  }
}`,...(je=(De=k.parameters)==null?void 0:De.docs)==null?void 0:je.source}}};var Pe,_e,Ie;x.parameters={...x.parameters,docs:{...(Pe=x.parameters)==null?void 0:Pe.docs,source:{originalSource:`{
  args: {
    sizer: Slider.sizer.medium,
    defaultValue: '50',
    ...withMetaHint('Medium Slider')
  }
}`,...(Ie=(_e=x.parameters)==null?void 0:_e.docs)==null?void 0:Ie.source}}};var Xe,Be,Ue;M.parameters={...M.parameters,docs:{...(Xe=M.parameters)==null?void 0:Xe.docs,source:{originalSource:`{
  args: {
  ...
  tags: ['!dev', '!test'],
  render: () => <div className="flex flex-col items-center gap-5 sm:flex-row">
