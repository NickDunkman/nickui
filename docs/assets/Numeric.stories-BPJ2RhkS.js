import{r as o}from"./iframe-D7K3DBLU.js";import{A as T}from"./AllSizersStoryWrapper-C7b1EBiS.js";import{g as z}from"./getStoryArgTypes-DAe_MfAd.js";import{M as H,e as i}from"./expectDelayedValue-CFw1Z6Kf.js";function c({decimalPlaces:n={min:0,max:1/0},...s}){return o.createElement(H,{...s,decimalPlaces:n,currencySymbol:"","data-nickui-component":"Numeric"})}c.__docgenInfo={description:`A form control that allows users to enter a numeric value
@param props {@link NumericProps}`,methods:[],displayName:"Numeric",props:{sizer:{required:!1,tsType:{name:"union",raw:"SizerType | SizerType[]",elements:[{name:"unknown[number]",raw:"(typeof SIZERS)[number]"},{name:"Array",elements:[{name:"unknown[number]",raw:"(typeof SIZERS)[number]"}],raw:"SizerType[]"}]},description:`Changes the size of the component. A sizer string, or an array of sizer
...
}`,...C.parameters?.docs?.source}}};const V=["fieldLayout","empty","controlled","uncontrolled","disabled","european","allowNegatives","xs","sm","base","lg","xl","responsive","allControlStates","allSizers"],D=Object.freeze(Object.defineProperty({__proto__:null,__namedExportsOrder:V,allControlStates:A,allSizers:C,allowNegatives:w,base:b,controlled:p,default:S,disabled:d,empty:u,european:v,fieldLayout:x,lg:h,responsive:N,sm:y,uncontrolled:m,xl:f,xs:g},Symbol.toStringTag,{value:"Module"}));export{c as N,w as a,v as e,D as s};
