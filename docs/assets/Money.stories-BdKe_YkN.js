import{r as s}from"./iframe-Bu1T0fJD.js";import{A as J}from"./AllSizersStoryWrapper-CL5lgHMK.js";import{F as Q}from"./Field-D5hqYqBg.js";import{t as ee}from"./styles-CAYPC_5O.js";import{a as ae,f as te,u as ne,c as _}from"./index-ECKoN68Z.js";import{u as le}from"./useElementBounds-CoEhvGvJ.js";import{u as se}from"./useFieldA11yIds-CMkVI2UQ.js";import{f as re}from"./fireInputChange-BU1kNzof.js";function oe(e,a){const t=s.useRef(null),n=e||t,l=s.useRef(null),u=a||l;return s.useEffect(()=>{const o=n.current,c=u.current;if(o&&c){let i=function(){F(o,c)};return F(o,c),o.addEventListener("scroll",i),()=>{o.removeEventListener("scroll",i)}}},[n,u]),[n,u]}function F(e,a){e&&a&&a.scroll(e.scrollLeft,e.scrollTop)}const ue=ae({slots:{visibleInputsContainer:"relative",placeholderInput:`
