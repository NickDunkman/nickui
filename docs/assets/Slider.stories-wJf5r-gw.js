import{r as l}from"./iframe-BVEIZZKB.js";import{A as ze}from"./AllSizersStoryWrapper-BjQ0Sxs8.js";import{k as Ne}from"./index-DGnQkWYh.js";import{F as Be}from"./Field-CxpmW-VA.js";import{u as Le}from"./useFieldA11yIds-N6qTjOLW.js";import{a as Re,u as Me}from"./index-CsBYKMqv.js";function De(s){let r=!1;function a(...t){r||(r=!0,requestAnimationFrame(()=>{r=!1,s(...t)}))}return a}const qe=Re({slots:{root:"w-full relative outline-0 cursor-pointer",track:`
    ...
    `,input:"hidden"},variants:{sizer:{xs:{root:"h-4",track:`
        ...
        `}},isDisabled:{true:{root:"cursor-not-allowed",track:"bg-gray-100 before:bg-gray-300",fill:"bg-gray-300",thumb:"bg-gray-100 border-gray-300 shadow-none"}},hasError:{true:{track:"before:bg-rose-800",fill:"bg-rose-800",thumb:"border-rose-800"}},hasFieldHeader:{true:{}},hasFieldFooter:{true:{}},atMin:{true:{track:"before:hidden"}},atMax:{true:{track:"after:hidden"}}},compoundVariants:[{isKeyboardFocused:!0,hasError:!0,className:{thumb:"after:bg-rose-800"}},{hasFieldHeader:!0,sizer:"xs",className:{root:"mt-2"}},{hasFieldHeader:!0,sizer:"sm",className:{root:"mt-2"}},{hasFieldHeader:!0,sizer:"base",className:{root:"mt-3"}},{hasFieldHeader:!0,sizer:"lg",className:{root:"mt-4"}},{hasFieldHeader:!0,sizer:"xl",className:{root:"mt-4"}},{hasFieldFooter:!0,sizer:"xs",className:{root:"mb-2"}},{hasFieldFooter:!0,sizer:"sm",className:{root:"mb-2"}},{hasFieldFooter:!0,sizer:"base",className:{root:"mb-3"}},{hasFieldFooter:!0,sizer:"lg",className:{root:"mb-4"}},{hasFieldFooter:!0,sizer:"xl",className:{root:"mb-4"}}],defaultVariants:{sizer:"base",isKeyboardFocused:!1,isDisabled:!1,atMin:!0,atMax:!1}});function Ie(s,r,a){return((s-r)/(a-r)||0)*100}function u({className:s,sizer:r,label:a,error:t,hint:o,disabled:m,required:ie,ref:I,name:ce,max:ue=100,min:de=0,step:g=1,shiftSteps:U=10,tabIndex:me,value:ee,defaultValue:j,onChange:ge,onMouseDown:he,onTouchStart:ve,onKeyDown:pe,onFocus:fe,onBlur:ye,"aria-labelledby":be,"aria-describedby":we,"aria-errormessage":xe,"aria-invalid":ae,...Se}){const N=l.useRef(null),W=l.useRef(null),h=l.useRef(null),[X,G]=l.useState(!1),[$,te]=l.useState(!1),[He,se]=l.useState(j!==void 0?Number(j):void 0),b=Number(ue),v=Number(de),O=ee!==void 0?Number(ee):He,f=O===void 0?v:O,[re,Ve]=l.useState();function ne(n){const i=parseFloat(n.toFixed(5));if(se(i),h.current){const p=window.HTMLInputElement.prototype,y=Object.getOwnPropertyDescriptor(p,"value").set;if(y){const B=new Event("input",{bubbles:!0});y.call(h.current,i),h.current.dispatchEvent(B)}}}function Y(n){if(!W.current)return;const{left:i,right:p,width:oe}=W.current.getBoundingClientRect();let y="touches"in n?n.touches[0].clientX:n.clientX;y<i?y=i:y>p&&(y=p);let B=(y-i)/oe*(b-v)+v;B=Math.round(B/g)*g,ne(B)}const _=De(n=>{Y(n)});function Ae(n){m||(document.addEventListener("mousemove",_),document.addEventListener("mouseup",le),Y(n.nativeEvent),he?.(n),n.preventDefault(),X||G(!0),N.current?.focus())}function le(){document.removeEventListener("mousemove",_),document.removeEventListener("mouseup",le)}function Ee(n){m||(document.addEventListener("touchmove",_),document.addEventListener("touchup",w),document.addEventListener("touchend",w),document.addEventListener("touchcancel",w),Y(n.nativeEvent),ve?.(n))}function w(){document.removeEventListener("touchmove",_),document.removeEventListener("touchup",w),document.removeEventListener("touchend",w),document.removeEventListener("touchcancel",w)}function ke(n){if(!m){let i;const p=n.nativeEvent.shiftKey;switch(Ne(n.nativeEvent)||n.nativeEvent.key){case"right":case"ArrowRight":case"up":case"ArrowUp":i=Math.min(b,f+(p?g*U:g));break;case"page up":case"PageUp":i=Math.min(b,f+g*U);break;case"left":case"ArrowLeft":case"down":case"ArrowDown":i=Math.max(v,f-(p?g*U:g));break;case"page down":case"PageDown":i=Math.max(v,f-g*U);break;case"home":case"Home":i=v;break;case"end":case"End":i=b;break;case"esc":case"Escape":if(re!==void 0){i=re;break}else return;default:return}ne(i),pe?.(n),n.preventDefault(),X&&G(!1)}}function Ce(n){m||($||(te(!0),Ve(f)),fe?.(n))}function Fe(n){m||(X&&G(!1),$&&te(!1),h.current&&ye?.({...n,target:h.current,currentTarget:h.current}))}l.useLayoutEffect(()=>{O===void 0&&j===void 0&&h.current?.value!=null&&se(Number(h.current.value))},[]);function J(n){return typeof n=="function"?n({value:f,min:v,max:b,step:g}):n}const Q=J(a),Z=J(o),x=J(t),S=Le({label:Q,hint:Z,error:x,controlledAriaLabelledBy:be,controlledAriaDescribedBy:we,controlledAriaErrorMessage:xe}),P=Ie(f,v,b),Te=Me(r),K=qe({sizer:Te,isDisabled:m,isKeyboardFocused:$&&!m&&!X,hasFieldHeader:!!Q,hasFieldFooter:!!(x&&x!==!0||Z),hasError:!!x,atMin:P===0,atMax:P===100});return l.useEffect(()=>{if(N.current){let n=function(p){p.preventDefault()};const i=N.current;return i.addEventListener("touchstart",n,{passive:!1}),()=>{i.removeEventListener("touchstart",n)}}},[N]),l.createElement(Be,{className:s,sizer:r,label:Q,labelId:S.ariaLabelledBy,hint:Z,hintId:S.ariaDescribedBy,error:x,errorId:S.ariaErrorMessage,disabled:m,required:ie},l.createElement("div",{...Se,ref:N,className:K.root(),role:"slider",tabIndex:m?-1:me||0,onMouseDown:Ae,onTouchStart:Ee,onFocus:Ce,onBlur:Fe,onKeyDown:ke,"aria-disabled":m,"aria-valuemax":b,"aria-valuemin":v,"aria-valuenow":f,"aria-labelledby":S.ariaLabelledBy,"aria-describedby":S.ariaDescribedBy,"aria-errormessage":S.ariaErrorMessage,"aria-invalid":ae!==void 0?ae:!!x},l.createElement("div",{ref:W,className:K.track()},l.createElement("div",{className:K.fill(),style:{right:`${100-P}%`},"data-testid":"fill"}),l.createElement("div",{className:K.thumb(),style:{left:`${P}%`},"data-testid":"thumb"}))),l.createElement("input",{ref:n=>{h.current=n,typeof I=="function"?I(n):I&&(I.current=n)},type:"text",name:ce,className:"hidden","aria-hidden":!0,defaultValue:O,onChange:ge}))}u.__docgenInfo={description:`A form control that allows users to choose a number within a range.
...
}`,...q.parameters?.docs?.source}}};const Xe=["FieldLayout","NoValue","Controlled","Uncontrolled","Disabled","CustomRange","Xs","Sm","Base","Lg","Xl","Responsive","AllControlStates","AllSizers"],$e=Object.freeze(Object.defineProperty({__proto__:null,AllControlStates:D,AllSizers:q,Base:F,Controlled:V,CustomRange:R,Disabled:E,FieldLayout:L,Lg:T,NoValue:H,Responsive:M,Sm:C,Uncontrolled:A,Xl:z,Xs:k,__namedExportsOrder:Xe,default:Ue},Symbol.toStringTag,{value:"Module"}));export{R as C,$e as S,u as a};
