...
}`);b(en).toRgb();Array.from({length:4},function(n,t){return"--atom-phase".concat(t+1,"-rgb")});M(`.commet-rli-bounding-box {
...
}`);var rt=Array.from({length:4},function(n,t){return"--OP-annulus-dual-sectors-phase".concat(t+1,"-color")}),wo=function(n){var t,o=$n(n?.style,n?.size),a=o.styles,r=o.fontSize,s=n?.easing,d=Fn(n?.speedPlus,"1.2s").animationPeriod,h=function(l){var p={},e=rt.length;if(l instanceof Array){for(var x=Yn(l,e),g=0;g<x.length&&!(g>=4);g++)p[rt[g]]=x[g];return p}try{if(typeof l!="string")throw new Error("Color String expected");for(var u=0;u<e;u++)p[rt[u]]=l}catch(c){for(c instanceof Error?console.warn("[".concat(c.message,']: Received "').concat(typeof l,'" with value, ').concat(JSON.stringify(l))):console.warn("".concat(JSON.stringify(l),' received in <OrbitProgress variant="annulus-splits" /> indicator cannot be processed. Using default instead!')),u=0;u<e;u++)p[rt[u]]=en}return p}((t=n?.color)!==null&&t!==void 0?t:""),m=n.dense?"0.45em":"";return i.createElement("span",{className:"rli-d-i-b OP-annulus-dual-sectors-rli-bounding-box",style:k(k(k(k(k({},r&&{fontSize:r}),d&&{"--rli-animation-duration":d}),s&&{"--rli-animation-function":s}),h),a),role:"status","aria-live":"polite","aria-label":"Loading"},i.createElement("span",{className:"rli-d-i-b OP-annulus-dual-sectors-indicator"},i.createElement("span",{className:"rli-d-i-b annulus-sectors",style:k({},m&&{borderWidth:m})}),i.createElement(jn,{className:"OP-annulus-dual-sectors-text",text:n?.text,textColor:n?.textColor})))};M(`.OP-annulus-sector-track-rli-bounding-box {
...
}`);var zn=Array.from({length:4},function(n,t){return["--OP-annulus-track-phase".concat(t+1,"-color"),"--OP-annulus-sector-phase".concat(t+1,"-color")]}),it=function(n){return n===void 0&&(n=1),.25*n},Oo=function(n){var t,o=$n(n?.style,n?.size),a=o.styles,r=o.fontSize,s=n?.easing,d=Fn(n?.speedPlus,"1s").animationPeriod,h=function(l){var p={},e=zn.length;if(l instanceof Array){for(var x=Yn(l,e),g=0;g<x.length&&!(g>=4);g++){var u=zn[g];try{if(!(f=b(x[g])).isValid())throw new Error("Invalid Color: ".concat(f.getOriginalInput()));var c=f.setAlpha(it(f.getAlpha())).toRgbString(),v=x[g];p[u[0]]=c,p[u[1]]=v}catch{v=en,c=(f=b(en)).setAlpha(it(f.getAlpha())).toRgbString(),p[u[0]]=c,p[u[1]]=v}}return p}try{var f=b(l);if(typeof l!="string")throw new Error("Color String expected");if(!f.isValid())throw new Error("Invalid Color: ".concat(f.getOriginalInput()));v=l,c=f.setAlpha(it(f.getAlpha())).toRgbString();for(var N=0;N<e;N++)p[(u=zn[N])[0]]=c,p[u[1]]=v}catch(E){for(E instanceof Error?console.warn("[".concat(E.message,']: Received "').concat(typeof l,'" with value, ').concat(JSON.stringify(l))):console.warn("".concat(JSON.stringify(l),' received in <OrbitProgress variant="annulus-track" /> indicator cannot be processed. Using default instead!')),v=en,c=(f=b(en)).setAlpha(it(f.getAlpha())).toRgbString(),N=0;N<zn.length;N++)p[(u=zn[N])[0]]=c,p[u[1]]=v}return p}((t=n?.color)!==null&&t!==void 0?t:""),m=n.dense?"0.45em":"";return i.createElement("span",{className:"rli-d-i-b OP-annulus-sector-track-rli-bounding-box",style:k(k(k(k(k({},r&&{fontSize:r}),d&&{"--rli-animation-duration":d}),s&&{"--rli-animation-function":s}),h),a),role:"status","aria-live":"polite","aria-label":"Loading"},i.createElement("span",{className:"rli-d-i-b OP-annulus-sector-track-indicator"},i.createElement("span",{className:"rli-d-i-b annulus-track-ring",style:k({},m&&{borderWidth:m})}),i.createElement(jn,{className:"OP-annulus-sector-text",text:n?.text,textColor:n?.textColor})))},Po=function(n){var t=Object(n).variant,o=t===void 0?"disc":t;return o==="dotted"?i.createElement(yo,k({},n)):o==="spokes"?i.createElement(xo,k({},n)):o==="disc"?i.createElement(vo,k({},n)):o==="split-disc"?i.createElement(wo,k({},n)):o==="track-disc"?i.createElement(Oo,k({},n)):null};M(`.foursquare-rli-bounding-box {
