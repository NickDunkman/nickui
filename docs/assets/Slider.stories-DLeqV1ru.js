import{r as o}from"./iframe-CjsTI3bz.js";import{k as Me}from"./index-DYocaE6X.js";import{F as De}from"./Field-d3pyfIbc.js";import{a as qe,S as u,u as Ie}from"./index-DrqyF3cy.js";import{r as Q}from"./randomId-Dfhrkieu.js";function Ue(n){let r=!1;function a(...t){r||(r=!0,requestAnimationFrame(()=>{r=!1,n(...t)}))}return a}const Oe=qe({slots:{root:"w-full relative outline-0 cursor-pointer",track:`
    ...
    `,input:"hidden"},variants:{sizer:{[u.small]:{root:"h-5",track:`
        ...
        `}},isDisabled:{true:{root:"cursor-not-allowed",track:"bg-gray-100 before:bg-gray-300",fill:"bg-gray-300",thumb:"bg-gray-100 border-gray-300 shadow-none"}},hasError:{true:{track:"before:bg-rose-800",fill:"bg-rose-800",thumb:"border-rose-800"}},hasFieldHeader:{true:{}},hasFieldFooter:{true:{}},atMin:{true:{track:"before:hidden"}},atMax:{true:{track:"after:hidden"}}},compoundVariants:[{isKeyboardFocused:!0,hasError:!0,className:{thumb:"after:bg-rose-800"}},{hasFieldHeader:!0,sizer:u.small,className:{root:"mt-2"}},{hasFieldHeader:!0,sizer:u.base,className:{root:"mt-3"}},{hasFieldHeader:!0,sizer:u.large,className:{root:"mt-4"}},{hasFieldFooter:!0,sizer:u.small,className:{root:"mb-2"}},{hasFieldFooter:!0,sizer:u.base,className:{root:"mb-3"}},{hasFieldFooter:!0,sizer:u.large,className:{root:"mb-4"}}],defaultVariants:{sizer:u.base,isKeyboardFocused:!1,isDisabled:!1,atMin:!0,atMax:!1}});function _e(n,r,a){return((n-r)/(a-r)||0)*100}function c({className:n,sizer:r,label:a,error:t,hint:i,disabled:d,required:ue,ref:D,name:de,max:me=100,min:he=0,step:h=1,shiftSteps:q=10,tabIndex:pe,value:Z,defaultValue:K,onChange:ge,onMouseDown:ve,onTouchStart:fe,onKeyDown:ye,onFocus:we,onBlur:be,"aria-labelledby":Se,"aria-describedby":He,"aria-errormessage":xe,"aria-invalid":ee,...Ee}){const B=o.useRef(null),j=o.useRef(null),p=o.useRef(null),[I,X]=o.useState(!1),[G,ae]=o.useState(!1),[Ve,te]=o.useState(K!==void 0?Number(K):void 0),b=Number(me),g=Number(he),U=Z!==void 0?Number(Z):Ve,y=U===void 0?g:U,[re,ke]=o.useState();function se(s){const l=parseFloat(s.toFixed(5));if(te(l),p.current){const v=window.HTMLInputElement.prototype,w=Object.getOwnPropertyDescriptor(v,"value").set;if(w){const L=new Event("input",{bubbles:!0});w.call(p.current,l),p.current.dispatchEvent(L)}}}function W(s){if(!j.current)return;const{left:l,right:v,width:ce}=j.current.getBoundingClientRect();let w="touches"in s?s.touches[0].clientX:s.clientX;w<l?w=l:w>v&&(w=v);let L=(w-l)/ce*(b-g)+g;L=Math.round(L/h)*h,se(L)}const O=Ue(s=>{W(s)});function Ae(s){d||(document.addEventListener("mousemove",O),document.addEventListener("mouseup",ne),W(s.nativeEvent),ve?.(s),s.preventDefault(),I||X(!0),B.current?.focus())}function ne(){document.removeEventListener("mousemove",O),document.removeEventListener("mouseup",ne)}function Ce(s){d||(document.addEventListener("touchmove",O),document.addEventListener("touchup",H),document.addEventListener("touchend",H),document.addEventListener("touchcancel",H),W(s.nativeEvent),fe?.(s))}function H(){document.removeEventListener("touchmove",O),document.removeEventListener("touchup",H),document.removeEventListener("touchend",H),document.removeEventListener("touchcancel",H)}function Fe(s){if(!d){let l;const v=s.nativeEvent.shiftKey;switch(Me(s.nativeEvent)||s.nativeEvent.key){case"right":case"ArrowRight":case"up":case"ArrowUp":l=Math.min(b,y+(v?h*q:h));break;case"page up":case"PageUp":l=Math.min(b,y+h*q);break;case"left":case"ArrowLeft":case"down":case"ArrowDown":l=Math.max(g,y-(v?h*q:h));break;case"page down":case"PageDown":l=Math.max(g,y-h*q);break;case"home":case"Home":l=g;break;case"end":case"End":l=b;break;case"esc":case"Escape":if(re!==void 0){l=re;break}else return;default:return}se(l),ye?.(s),s.preventDefault(),I&&X(!1)}}function Te(s){d||(G||(ae(!0),ke(y)),we?.(s))}function Be(s){d||(I&&X(!1),G&&ae(!1),p.current&&be?.({...s,target:p.current,currentTarget:p.current}))}o.useLayoutEffect(()=>{U===void 0&&K===void 0&&p.current?.value!=null&&te(Number(p.current.value))},[]);function $(s){return typeof s=="function"?s({value:y,min:g,max:b,step:h}):s}const Y=$(a),J=$(i),S=$(t),[Le]=o.useState(Q()),oe=Se||(Y?Le:void 0),[Re]=o.useState(Q()),ie=He||(J?Re:void 0),[Ne]=o.useState(Q()),le=xe||(S&&S!==!0?Ne:void 0),_=_e(y,g,b),ze=Ie(r),P=Oe({sizer:ze,isDisabled:d,isKeyboardFocused:G&&!d&&!I,hasFieldHeader:!!Y,hasFieldFooter:!!(S&&S!==!0||J),hasError:!!S,atMin:_===0,atMax:_===100});return o.useEffect(()=>{if(B.current){let s=function(v){v.preventDefault()};const l=B.current;return l.addEventListener("touchstart",s,{passive:!1}),()=>{l.removeEventListener("touchstart",s)}}},[B]),o.createElement(De,{className:n,sizer:r,label:Y,labelId:oe,hint:J,hintId:ie,error:S,errorId:le,disabled:d,required:ue},o.createElement("div",{...Ee,ref:B,className:P.root(),role:"slider",tabIndex:d?-1:pe||0,onMouseDown:Ae,onTouchStart:Ce,onFocus:Te,onBlur:Be,onKeyDown:Fe,"aria-disabled":d,"aria-valuemax":b,"aria-valuemin":g,"aria-valuenow":y,"aria-labelledby":oe,"aria-describedby":ie,"aria-errormessage":le,"aria-invalid":ee!==void 0?ee:!!S},o.createElement("div",{ref:j,className:P.track()},o.createElement("div",{className:P.fill(),style:{right:`${100-_}%`},"data-testid":"fill"}),o.createElement("div",{className:P.thumb(),style:{left:`${_}%`},"data-testid":"thumb"}))),o.createElement("input",{ref:s=>{p.current=s,typeof D=="function"?D(s):D&&(D.current=s)},type:"text",name:de,className:"hidden","aria-hidden":!0,defaultValue:U,onChange:ge}))}c.sizer=u;c.__docgenInfo={description:`A form control that allows users to choose a number within a range.
