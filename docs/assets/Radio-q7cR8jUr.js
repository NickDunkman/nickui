import{r}from"./iframe-CMQOyV56.js";import{a as i}from"./Checkbox-CxGyW_Pi.js";import{a as n,S as e}from"./index-xsI1GVmR.js";const o=n({slots:{root:"",labelWithOffset:"",input:"peer opacity-0 absolute -z-1",indicator:`
    ...
    `},variants:{sizer:{[e.small]:{indicator:"size-3.5 top-0.25 peer-checked:after:size-1.5"},[e.medium]:{indicator:"size-4 top-0.75 peer-checked:after:size-1.5"},[e.large]:{indicator:"size-5 top-0.75 peer-checked:after:size-2"}},isDisabled:{true:{indicator:`
        ...
        `}}},defaultVariants:{sizer:e.small,isDisabled:!1,isFocused:!1}});function t(a){return r.createElement(i,{...a,type:"radio",styler:o})}t.sizer=e;t.__docgenInfo={description:`A form control that allow users to choose one option from a set
