import{r as t}from"./iframe-D0vVQOb0.js";import{a as b,N as o,S as y,u as x,c as w}from"./index-BJKEptQa.js";const R=b({base:`
    rounded-sm font-medium
  `,variants:{sizer:{[y.small]:"text-sm px-3 py-2",[y.base]:"text-base px-4 py-3",[y.large]:"text-lg px-5 py-4"},flavor:{[o.info]:"bg-blue-800 text-white",[o.yep]:"bg-green-700 text-white",[o.maybe]:"bg-yellow-500",[o.nope]:"bg-rose-700 text-white"}},defaultVariants:{sizer:y.base,flavor:o.info}});function e({className:s,sizer:a,flavor:v,...S}){const f=x(a),z=R({sizer:f,flavor:v});return t.createElement("div",{...S,className:w(z,s)})}e.sizer=y;e.flavor=o;e.__docgenInfo={description:`Displays an important notice to the user, such as an error message, warning,
