import{r as a}from"./iframe-Cy2zHahl.js";import{c as V,F as d}from"./index-Czi7Upa3.js";import{a as W}from"./Checkbox-C2J1LwCN.js";const G=V({slots:{root:"pt-0.5",input:"peer opacity-0 absolute -z-1",indicator:`
    ...
    `},variants:{sizer:{[d.small]:{root:"min-h-5",indicator:"w-8 h-5 after:size-4 after:border-5 peer-checked:after:translate-x-3"},[d.medium]:{root:"min-h-6",indicator:"w-10 h-6 after:size-5 after:border-6 peer-checked:after:translate-x-4"},[d.large]:{root:"min-h-7",indicator:"w-12 h-7 after:size-6 after:border-7 peer-checked:after:translate-x-5"}},isDisabled:{true:{indicator:"bg-gray-300 after:bg-gray-100 peer-checked:bg-gray-300 after:shadow-none"}},isFocused:{true:{indicator:`
        ...
        `}}},defaultVariants:{sizer:d.small,isDisabled:!1}});function e(u){return a.createElement(W,{...u,styler:G})}e.sizer=d;e.__docgenInfo={description:`A variation of the Checkbox component that has a more explict-feeling "off"
...
}`,...(H=(I=i.parameters)==null?void 0:I.docs)==null?void 0:H.source}}};var P,j,B;p.parameters={...p.parameters,docs:{...(P=p.parameters)==null?void 0:P.docs,source:{originalSource:`{
  tags: ['!dev', '!test'],
