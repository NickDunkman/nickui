import{r as l}from"./iframe-m3ARp835.js";import{A as _}from"./AllSizersStoryWrapper-zl3vKeFP.js";import{g as q}from"./getStoryArgTypes-zAxgZkbZ.js";import{F as D}from"./Field-BzXF1XTz.js";import{a as O}from"./fieldA11y-CwFZMBjx.js";import{u as F}from"./index-DM2Rz7DM.js";import{t as R}from"./styles-B3xmv8zc.js";const X=["date","datetime","datetime-local","email","month","number","password","search","tel","text","time","url","week"];function o({className:t,sizer:n,label:e,hint:s,error:r,required:w,disabled:C,id:z,"aria-label":H,"aria-labelledby":S,"aria-describedby":E,"aria-errormessage":B,"aria-invalid":k,...V}){const A=O({label:e,hint:s,error:r,controlledId:z,controlledAriaLabel:H,controlledAriaLabelledBy:S,controlledAriaDescribedBy:E,controlledAriaErrorMessage:B,controlledAriaInvalid:k}),L=F(n),N=R({sizer:L,hasError:!!r});return l.createElement(D,{...A.field,className:t,sizer:n,label:e,hint:s,error:r!==!0?r:void 0,required:w,"data-nickui-component":"Text"},l.createElement("input",{...V,...A.formControl,className:N,disabled:C,required:w}))}o.__docgenInfo={description:`A form control that allows users to enter & edit a single line of text
