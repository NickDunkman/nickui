import{r as l}from"./iframe-D3szbWiH.js";import{S}from"./Switch-D6G_iZ87.js";import{A as T}from"./AllSizersStoryWrapper-B3OwGk9k.js";import{a as O}from"./Checkboxes-DlIaFx4a.js";function c({delimiter:a=",",...n}){return l.createElement(O,{...n,Checkable:S,delimiter:a})}c.__docgenInfo={description:`Renders multiple <Switch> as one field in a <Fieldset>.
...
}`,...k.parameters?.docs?.source}}};const R=["FieldsetLayout","NoValue","Controlled","Uncontrolled","Disabled","StandardLayout","CustomLayout","Xs","Sm","Base","Lg","Xl","Responsive","AllControlStates","AllSizers"],L=Object.freeze(Object.defineProperty({__proto__:null,AllControlStates:B,AllSizers:k,Base:b,Controlled:p,CustomLayout:f,Disabled:u,FieldsetLayout:y,Lg:v,NoValue:d,Responsive:C,Sm:h,StandardLayout:w,Uncontrolled:m,Xl:x,Xs:g,__namedExportsOrder:R,default:A},Symbol.toStringTag,{value:"Module"}));export{f as C,L as S,c as a,w as b};
