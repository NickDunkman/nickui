import{k as u}from"./index-DpvBQJGL.js";import{r as t}from"./iframe-Si2UkeX9.js";import{a as B,S as i,u as q,c as M}from"./index-oXvcZMk4.js";var r=(o=>(o.primary="primary",o.secondary="secondary",o.danger="danger",o))(r||{});const R=B({base:`
    appearance-none
    border-1 rounded-sm
    text-center
    select-none
  ...
  `,variants:{sizer:{[i.small]:"text-sm py-1.75 px-3",[i.base]:"text-base py-2.75 px-4.5",[i.large]:"text-lg py-3.75 px-5.5"},isDisabled:{false:`
      ...
      `},{flavor:r.primary,isKeyboardFocused:!0,isKeyboardActivated:!1,isDisabled:!1,class:"focus:bg-blue-500 focus:border-blue-500"},{flavor:r.secondary,isKeyboardActivated:!0,isDisabled:!1,class:`
        active:bg-gray-200 active:border-gray-600
      ...
      `},{flavor:r.danger,isKeyboardFocused:!0,isKeyboardActivated:!1,isDisabled:!1,class:"focus:bg-rose-600 focus:border-rose-600"},{isKeyboardFocused:!0,isKeyboardActivated:!0,isDisabled:!1,class:"focus:shadow-none focus:translate-y-0.25 focus:scale-99"}],defaultVariants:{sizer:i.base,flavor:r.primary,isDisabled:!1,isTouched:!1,isKeyboardFocused:!1}});function b({className:o,type:y="button",disabled:a=!1,sizer:g,flavor:h,onTouchStart:m,onTouchEnd:w,onTouchCancel:T,onMouseDown:K,onKeyDown:D,onKeyUp:x,onFocus:z,onBlur:S,...E}){const[c,f]=t.useState(!1),[n,v]=t.useState(!1),[s,l]=t.useState(!1),[d,p]=t.useState(!1),A=q(g),F=R({sizer:A,flavor:h,isDisabled:a,isTouched:!a&&s,isKeyboardFocused:!a&&n&&!c&&!s,isKeyboardActivated:!a&&d});return t.createElement("button",{...E,className:M(F,o),disabled:a,type:y,onBlur:e=>{c&&f(!1),n&&v(!1),S?.(e)},onFocus:e=>{n||v(!0),z?.(e)},onKeyDown:e=>{console.log(u(e.nativeEvent)),d||(u(e.nativeEvent)==="enter"||e.nativeEvent.key==="Enter"||u(e.nativeEvent)==="space"||e.nativeEvent.key===" ")&&p(!0),D?.(e)},onKeyUp:e=>{d&&p(!1),x?.(e)},onMouseDown:e=>{c||f(!0),K?.(e)},onTouchStart:e=>{s||l(!0),m?.(e)},onTouchEnd:e=>{s&&l(!1),w?.(e)},onTouchCancel:e=>{s&&l(!1),T?.(e)}})}b.flavor=r;b.sizer=i;b.__docgenInfo={description:`Buttons allow the user to trigger an action, such as submitting a form
