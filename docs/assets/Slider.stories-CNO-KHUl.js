import{r as o}from"./iframe-d_INZCmK.js";import{k as ze}from"./index-C6HuLS31.js";import{F as De}from"./Field-BINraHLL.js";import{a as qe,S as u,u as Ie}from"./index-BxnlHtOP.js";import{r as J}from"./randomId-Dfhrkieu.js";function Ue(n){let r=!1;function a(...t){r||(r=!0,requestAnimationFrame(()=>{r=!1,n(...t)}))}return a}const Oe=qe({slots:{root:"w-full relative outline-0 cursor-pointer",track:`
    ...
    `,input:"hidden"},variants:{sizer:{[u.small]:{root:"h-5",track:`
        ...
        `}},isDisabled:{true:{root:"cursor-not-allowed",track:"bg-gray-100 before:bg-gray-300",fill:"bg-gray-300",thumb:"bg-gray-100 border-gray-300 shadow-none"}},hasError:{true:{track:"before:bg-rose-800",fill:"bg-rose-800",thumb:"border-rose-800"}},hasFieldHeader:{true:{}},hasFieldFooter:{true:{}},atMin:{true:{track:"before:hidden"}},atMax:{true:{track:"after:hidden"}}},compoundVariants:[{isKeyboardFocused:!0,hasError:!0,className:{thumb:"after:bg-rose-800"}},{hasFieldHeader:!0,sizer:u.small,className:{root:"mt-2"}},{hasFieldHeader:!0,sizer:u.medium,className:{root:"mt-3"}},{hasFieldHeader:!0,sizer:u.large,className:{root:"mt-4"}},{hasFieldFooter:!0,sizer:u.small,className:{root:"mb-2"}},{hasFieldFooter:!0,sizer:u.medium,className:{root:"mb-3"}},{hasFieldFooter:!0,sizer:u.large,className:{root:"mb-4"}}],defaultVariants:{sizer:u.small,isKeyboardFocused:!1,isDisabled:!1,atMin:!0,atMax:!1}});function _e(n,r,a){return((n-r)/(a-r)||0)*100}function c({className:n,sizer:r,label:a,error:t,hint:i,disabled:d,required:ue,ref:z,name:de,max:me=100,min:he=0,step:m=1,shiftSteps:D=10,tabIndex:pe,value:Z,defaultValue:P,onChange:ve,onMouseDown:fe,onTouchStart:ge,onKeyDown:ye,onFocus:we,onBlur:be,"aria-labelledby":Se,"aria-describedby":He,"aria-errormessage":xe,"aria-invalid":ee,...Ee}){const C=o.useRef(null),K=o.useRef(null),h=o.useRef(null),[q,j]=o.useState(!1),[X,ae]=o.useState(!1),[Ve,te]=o.useState(P!==void 0?Number(P):void 0),w=Number(me),p=Number(he),I=Z!==void 0?Number(Z):Ve,g=I===void 0?p:I,[re,ke]=o.useState();function se(s){const l=parseFloat(s.toFixed(5));if(te(l),h.current){const v=window.HTMLInputElement.prototype,y=Object.getOwnPropertyDescriptor(v,"value").set;if(y){const L=new Event("input",{bubbles:!0});y.call(h.current,l),h.current.dispatchEvent(L)}}}function G(s){if(!K.current)return;const{left:l,right:v,width:ce}=K.current.getBoundingClientRect();let y="touches"in s?s.touches[0].clientX:s.clientX;y<l?y=l:y>v&&(y=v);let L=(y-l)/ce*(w-p)+p;L=Math.round(L/m)*m,se(L)}const U=Ue(s=>{G(s)});function Ae(s){d||(document.addEventListener("mousemove",U),document.addEventListener("mouseup",ne),G(s.nativeEvent),fe?.(s),s.preventDefault(),q||j(!0),C.current?.focus())}function ne(){document.removeEventListener("mousemove",U),document.removeEventListener("mouseup",ne)}function Fe(s){d||(document.addEventListener("touchmove",U),document.addEventListener("touchup",S),document.addEventListener("touchend",S),document.addEventListener("touchcancel",S),G(s.nativeEvent),ge?.(s))}function S(){document.removeEventListener("touchmove",U),document.removeEventListener("touchup",S),document.removeEventListener("touchend",S),document.removeEventListener("touchcancel",S)}function Te(s){if(!d){let l;const v=s.nativeEvent.shiftKey;switch(ze(s.nativeEvent)||s.nativeEvent.key){case"right":case"ArrowRight":case"up":case"ArrowUp":l=Math.min(w,g+(v?m*D:m));break;case"page up":case"PageUp":l=Math.min(w,g+m*D);break;case"left":case"ArrowLeft":case"down":case"ArrowDown":l=Math.max(p,g-(v?m*D:m));break;case"page down":case"PageDown":l=Math.max(p,g-m*D);break;case"home":case"Home":l=p;break;case"end":case"End":l=w;break;case"esc":case"Escape":if(re!==void 0){l=re;break}else return;default:return}se(l),ye?.(s),s.preventDefault(),q&&j(!1)}}function Ce(s){d||(X||(ae(!0),ke(g)),we?.(s))}function Le(s){d||(q&&j(!1),X&&ae(!1),h.current&&be?.({...s,target:h.current,currentTarget:h.current}))}o.useLayoutEffect(()=>{I===void 0&&P===void 0&&h.current?.value!=null&&te(Number(h.current.value))},[]);function W(s){return typeof s=="function"?s({value:g,min:p,max:w,step:m}):s}const $=W(a),Y=W(i),b=W(t),[Re]=o.useState(J()),oe=Se||($?Re:void 0),[Ne]=o.useState(J()),ie=He||(Y?Ne:void 0),[Me]=o.useState(J()),le=xe||(b&&b!==!0?Me:void 0),O=_e(g,p,w),Be=Ie(r),_=Oe({sizer:Be,isDisabled:d,isKeyboardFocused:X&&!d&&!q,hasFieldHeader:!!$,hasFieldFooter:!!(b&&b!==!0||Y),hasError:!!b,atMin:O===0,atMax:O===100});return o.useEffect(()=>{if(C.current){let s=function(v){v.preventDefault()};const l=C.current;return l.addEventListener("touchstart",s,{passive:!1}),()=>{l.removeEventListener("touchstart",s)}}},[C]),o.createElement(De,{className:n,sizer:r,label:$,labelId:oe,hint:Y,hintId:ie,error:b,errorId:le,disabled:d,required:ue},o.createElement("div",{...Ee,ref:C,className:_.root(),role:"slider",tabIndex:d?-1:pe||0,onMouseDown:Ae,onTouchStart:Fe,onFocus:Ce,onBlur:Le,onKeyDown:Te,"aria-disabled":d,"aria-valuemax":w,"aria-valuemin":p,"aria-valuenow":g,"aria-labelledby":oe,"aria-describedby":ie,"aria-errormessage":le,"aria-invalid":ee!==void 0?ee:!!b},o.createElement("div",{ref:K,className:_.track()},o.createElement("div",{className:_.fill(),style:{right:`${100-O}%`},"data-testid":"fill"}),o.createElement("div",{className:_.thumb(),style:{left:`${O}%`},"data-testid":"thumb"}))),o.createElement("input",{ref:s=>{h.current=s,typeof z=="function"?z(s):z&&(z.current=s)},type:"text",name:de,className:"hidden","aria-hidden":!0,defaultValue:I,onChange:ve}))}c.sizer=u;c.__docgenInfo={description:`A form control that allows users to choose a number within a range.
...
number format`},error:{required:!1,tsType:{name:"ReactNode"},description:"Error message to show along with the field, or just `true` to trigger the\nerror style without showing an error message."},required:{required:!1,tsType:{name:"boolean"},description:"When `true`, adds an asterisk to the label"},disabled:{required:!1,tsType:{name:"boolean"},description:"Prevents the user from interacting with the control"}},composes:["Omit"]};const{expect:e,fn:Q}=__STORYBOOK_MODULE_TEST__,Pe={title:"Form controls/Slider",component:c};function f(n){return{hint:({value:r})=>o.createElement("div",{className:"flex"},o.createElement("div",null,n),o.createElement("div",{className:"ml-auto"},r)),"aria-label":n}}const R={args:{required:!0,label:"A label",hint:"A hint",error:"An error message",defaultValue:"50"},play:async({canvas:n,step:r})=>{const a=n.getByLabelText("A label*"),t=n.getByTitle("required");await r("Assert accessibility of layout elements",async()=>{e(a).toHaveRole("slider"),e(a).toHaveAccessibleDescription("A hint"),e(a).toHaveAccessibleErrorMessage("An error message"),e(a).toHaveValue(50),e(a).toHaveAttribute("aria-valuemin","0"),e(a).toHaveAttribute("aria-valuemax","100"),e(t).toHaveTextContent("*")}),await r("Assert the error style",async()=>{e(n.getByTestId("fill")).toHaveClass("bg-rose-800")})}},H={args:{...f("Slider with no valueish prop"),onChange:Q()},play:async({args:n,canvas:r,step:a,userEvent:t})=>{const i=r.getByRole("slider");await a("Increase value using right arrow",async()=>{e(i).toHaveValue(0),await t.tab(),e(i).toHaveFocus(),await t.keyboard("{ArrowRight}"),e(i).toHaveValue(1),e(n.onChange).toHaveBeenCalledOnce(),await t.keyboard("{Shift>}{ArrowRight}{/Shift}"),e(i).toHaveValue(11)}),await a("Increase value using up arrow",async()=>{await t.keyboard("{ArrowUp}"),e(i).toHaveValue(12),await t.keyboard("{Shift>}{ArrowUp}{/Shift}"),e(i).toHaveValue(22)}),await a("Increase value using page up",async()=>{await t.keyboard("{PageUp}"),e(i).toHaveValue(32)}),await a("Decrease value using left arrow",async()=>{await t.keyboard("{ArrowLeft}"),e(i).toHaveValue(31),await t.keyboard("{Shift>}{ArrowLeft}{/Shift}"),e(i).toHaveValue(21)}),await a("Decrease value using down arrow",async()=>{await t.keyboard("{ArrowDown}"),e(i).toHaveValue(20),await t.keyboard("{Shift>}{ArrowDown}{/Shift}"),e(i).toHaveValue(10)}),await a("Increase value using page up",async()=>{await t.keyboard("{PageDown}"),e(i).toHaveValue(0)}),await a("Set value to max using end key",async()=>{await t.keyboard("{End}"),e(i).toHaveValue(100)}),await a("Set value to min using home key",async()=>{await t.keyboard("{Home}"),e(i).toHaveValue(0),e(n.onChange).toHaveBeenCalledTimes(12)}),await a("Unfocus the Slider",async()=>{await t.tab(),e(i).not.toHaveFocus()})}},x={args:{...f("Slider with controlled value"),value:"50",onChange:Q()},play:async({args:n,canvas:r,step:a,userEvent:t})=>{const i=r.getByRole("slider");await a("Assert `value` works",async()=>{e(i).toHaveValue(50)}),await a("Focus the Slider",async()=>{await t.tab(),e(i).toHaveFocus()}),await a("Try increasing the value. `onChange` should fire, but the value is controlled, so it shouldn’t change",async()=>{await t.keyboard("{ArrowRight}"),e(n.onChange).toHaveBeenCalledOnce(),e(i).toHaveValue(50)}),await a("Unfocus the Slider",async()=>{await t.tab(),e(i).not.toHaveFocus()})}},E={args:{...f("Slider with uncontrolled value"),defaultValue:"50",onChange:Q()},play:async({args:n,canvas:r,step:a,userEvent:t})=>{const i=r.getByRole("slider");await a("Assert `defaultValue` works",async()=>{e(i).toHaveValue(50)}),await a("Focus the Slider",async()=>{await t.tab(),e(i).toHaveFocus()}),await a("Sliding the Slider should change the value, since it’s uncontrolled",async()=>{await t.keyboard("{ArrowRight}"),e(i).toHaveValue(51),e(n.onChange).toHaveBeenCalledOnce()}),await a("Reset the value",async()=>{await t.keyboard("{ArrowLeft}"),e(i).toHaveValue(50)}),await a("Unfocus the Slider",async()=>{await t.tab(),e(i).not.toHaveFocus()})}},V={args:{...f("Disabled Slider"),disabled:!0,defaultValue:"50"},play:async({canvas:n,step:r,userEvent:a})=>{const t=n.getByRole("slider");await r("Assert disabled state",async()=>{e(t).toHaveAttribute("aria-disabled","true"),await a.tab(),e(t).not.toHaveFocus()})}},N={args:{...f("Slider with custom range"),defaultValue:"0",min:-1e3,max:1e3,step:.01,shiftSteps:500},play:async({canvas:n,step:r,userEvent:a})=>{const t=n.getByRole("slider");await r("Focus the Slider",async()=>{await a.tab(),e(t).toHaveFocus()}),await r("Increase the value by one step",async()=>{e(t).toHaveValue(0),await a.keyboard("{ArrowRight}"),e(t).toHaveValue(.01)}),await r('Use the shift key to decrease by one "shift step"',async()=>{await a.keyboard("{Shift>}{ArrowLeft}{/Shift}"),e(t).toHaveValue(-4.99)}),await r("Go to the max value",async()=>{await a.keyboard("{End}"),e(t).toHaveValue(1e3)}),await r("Go to the min value",async()=>{await a.keyboard("{Home}"),e(t).toHaveValue(-1e3)}),await r("Reset back to the initial value",async()=>{await a.keyboard("{Escape}"),e(t).toHaveValue(0)}),await r("Unfocus the Slider",async()=>{await a.tab(),e(t).not.toHaveFocus()})}},k={args:{sizer:c.sizer.small,...f("Small Slider (default)"),defaultValue:"50"},play:async({canvas:n,step:r})=>{await r("Assert the small style on both the Slider & Field",async()=>{e(n.getByLabelText("Small Slider (default)")).toHaveClass("h-5"),e(n.getByText("Small Slider (default)").parentNode?.parentNode).toHaveClass("text-xs")})}},A={args:{sizer:c.sizer.medium,...f("Medium Slider"),defaultValue:"50"},play:async({canvas:n,step:r})=>{await r("Assert the medium style on both the Slider & Field",async()=>{e(n.getByLabelText("Medium Slider")).toHaveClass("h-6"),e(n.getByText("Medium Slider").parentNode?.parentNode).toHaveClass("text-xs")})}},F={args:{sizer:c.sizer.large,...f("Large Slider"),defaultValue:"50"},play:async({canvas:n,step:r})=>{await r("Assert the large style on both the Slider & Field",async()=>{e(n.getByLabelText("Large Slider")).toHaveClass("h-7"),e(n.getByText("Large Slider").parentNode?.parentNode).toHaveClass("text-sm")})}},T={tags:["!test"],args:{sizer:[c.sizer.smMedium,c.sizer.mdLarge],...f("Responsive Slider"),defaultValue:"50"}},M={tags:["!dev","!test"],render:n=>o.createElement("div",{className:"flex flex-col gap-4"},o.createElement(c,{...H.args}),o.createElement(c,{...x.args}),o.createElement(c,{...E.args}),o.createElement(c,{...V.args}))},B={tags:["!dev","!test"],render:n=>o.createElement("div",{className:"flex flex-col items-center gap-5 sm:flex-row"},o.createElement(c,{...k.args,className:"sm:flex-1"}),o.createElement(c,{...A.args,className:"sm:flex-1"}),o.createElement(c,{...F.args,className:"sm:flex-1"}),o.createElement(c,{...T.args,className:"sm:flex-1"}))};R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
  args: {
    required: true,
    label: 'A label',
    hint: 'A hint',
...
}`,...B.parameters?.docs?.source}}};const Ke=["FieldLayout","NoValue","Controlled","Uncontrolled","Disabled","CustomRange","Small","Medium","Large","Responsive","AllControlStates","AllSizes"],Je=Object.freeze(Object.defineProperty({__proto__:null,AllControlStates:M,AllSizes:B,Controlled:x,CustomRange:N,Disabled:V,FieldLayout:R,Large:F,Medium:A,NoValue:H,Responsive:T,Small:k,Uncontrolled:E,__namedExportsOrder:Ke,default:Pe},Symbol.toStringTag,{value:"Module"}));export{N as C,Je as S,c as a};
