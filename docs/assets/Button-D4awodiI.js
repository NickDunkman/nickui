import{k as c}from"./index-C0cj4GDh.js";import{r as a}from"./iframe-CF7ggHrS.js";import{a as K,u as B,c as F}from"./index-DuZop_BC.js";const z=K({base:`
    text-nowrap
    appearance-none
    rounded-sm
    text-center
  ...
  `,variants:{sizer:{xs:"text-xs py-1.5 px-2",sm:"text-sm py-1.75 px-2.75",base:"text-base py-2.75 px-4.25",lg:"text-lg py-3.75 px-5.25",xl:"text-xl py-4.75 px-6.25"},isDisabled:{false:`
      ...
      `}],defaultVariants:{sizer:"base",flavor:"neutral",isSecondary:!1,isDisabled:!1,isTouchActivated:!1,isKeyboardFocused:!1}});function q({className:m,type:f="button",disabled:o=!1,sizer:t,flavor:g,secondary:k=!1,onTouchStart:h,onTouchEnd:x,onTouchCancel:p,onMouseDown:y,onKeyDown:w,onKeyUp:T,onFocus:S,onBlur:A,...D}){const[l,u]=a.useState(!1),[n,b]=a.useState(!1),[i,v]=a.useState(!1),[r,s]=a.useState(!1),d=B(t),E=z({sizer:d,flavor:g,isSecondary:k,isDisabled:o,isKeyboardFocused:!o&&n&&!l&&!r,isKeyboardActivated:!o&&i,isTouchActivated:!o&&r});return a.createElement("button",{...D,className:F(E,m),disabled:o,type:f,onBlur:e=>{l&&u(!1),n&&b(!1),A?.(e)},onFocus:e=>{n||b(!0),S?.(e)},onKeyDown:e=>{console.log(c(e.nativeEvent)),i||(c(e.nativeEvent)==="enter"||e.nativeEvent.key==="Enter"||c(e.nativeEvent)==="space"||e.nativeEvent.key===" ")&&v(!0),w?.(e)},onKeyUp:e=>{i&&v(!1),T?.(e)},onMouseDown:e=>{l||u(!0),y?.(e)},onTouchStart:e=>{r||s(!0),h?.(e)},onTouchEnd:e=>{r&&s(!1),x?.(e)},onTouchCancel:e=>{r&&s(!1),p?.(e)},"data-nickui-sizer":Array.isArray(t)?t.join(","):t,"data-nickui-resolved-sizer":d})}q.__docgenInfo={description:`Buttons allow the user to trigger an action, such as submitting a form
