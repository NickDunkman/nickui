import{r}from"./iframe-BVEIZZKB.js";import{A as R}from"./AllSizersStoryWrapper-BjQ0Sxs8.js";import{F as q}from"./Field-CxpmW-VA.js";import{u as _}from"./useFieldA11yIds-N6qTjOLW.js";import{u as k}from"./index-CsBYKMqv.js";import{t as D}from"./styles-kT3mZMIh.js";function o({className:e,sizer:l,label:n,hint:s,error:t,required:w,disabled:B,id:A,"aria-labelledby":S,"aria-describedby":z,"aria-errormessage":E,"aria-invalid":H,...L}){const c=_({label:n,hint:s,error:t,controlledId:A,controlledAriaLabelledBy:S,controlledAriaDescribedBy:z,controlledAriaErrorMessage:E}),V=k(l),X=D({sizer:V,hasError:!!t});return r.createElement(q,{className:e,sizer:l,label:n,labelId:c.ariaLabelledBy,controlId:c.id,hint:s,hintId:c.ariaDescribedBy,error:t!==!0?t:void 0,errorId:c.ariaErrorMessage,disabled:B,required:w},r.createElement("input",{...L,id:c.id,className:X,disabled:B,required:w,"aria-labelledby":c.ariaLabelledBy,"aria-describedby":c.ariaDescribedBy,"aria-errormessage":c.ariaErrorMessage,"aria-invalid":H!==void 0?H:!!t}))}o.__docgenInfo={description:`A form control that allows users to enter & edit a single line of text
...
}`,...C.parameters?.docs?.source}}};const O=["FieldLayout","Empty","Controlled","Uncontrolled","Disabled","Xs","Sm","Base","Lg","Xl","Responsive","AllControlStates","AllSizers"],j=Object.freeze(Object.defineProperty({__proto__:null,AllControlStates:f,AllSizers:C,Base:v,Controlled:u,Disabled:d,Empty:m,FieldLayout:h,Lg:y,Responsive:T,Sm:x,Uncontrolled:p,Xl:b,Xs:g,__namedExportsOrder:O,default:F},Symbol.toStringTag,{value:"Module"}));export{j as S,o as T};
