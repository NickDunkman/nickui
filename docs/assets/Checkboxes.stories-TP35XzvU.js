import{r as l}from"./iframe-BHWhhQOG.js";import{C as A}from"./Checkbox-FgbetUOE.js";import{A as z}from"./AllSizersStoryWrapper-CfMwsrT0.js";import{C as i}from"./Checkboxes-bWQEfLuM.js";const{expect:e,fn:c}=__STORYBOOK_MODULE_TEST__,O={title:"Form controls/Checkboxes",component:i},v={tags:["field-layout"],args:{required:!0,label:"A label",hint:"A hint",error:"An error message",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:c()},play:async({canvas:a,step:n})=>{const t=a.getByRole("group"),o=a.getByTitle("(required)");await n("Assert accessibility of layout elements",async()=>{e(t).toHaveAccessibleName("A label*"),e(t).toHaveAccessibleDescription("A hint"),e(t).toHaveAccessibleErrorMessage("An error message"),e(o).toHaveTextContent("*")})}},b={tags:["control-state"],args:{label:"No valueish prop",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:c()},play:async({args:a,canvas:n,step:t,userEvent:o})=>{const s=n.getByLabelText("Option one"),r=n.getByLabelText("Option two");await t("Assert initial all-unchecked state",async()=>{e(s).not.toBeChecked(),e(r).not.toBeChecked()}),await t("Check first Checkbox using the keyboard",async()=>{await o.tab(),e(s).toHaveFocus(),await o.keyboard(" "),e(s).toBeChecked(),e(r).not.toBeChecked(),e(a.onChange).toHaveBeenCalledOnce()}),await t("Check second Checkbox using the mouse",async()=>{await o.click(r),e(s).toBeChecked(),e(r).toBeChecked(),e(a.onChange).toHaveBeenCalledTimes(2)}),await t("Reset all checked states",async()=>{await o.click(s),e(s).not.toBeChecked(),await o.click(r),e(r).not.toBeChecked()})}},d={tags:["control-state"],args:{label:"Controlled",value:"one",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:c()},play:async({args:a,canvas:n,step:t,userEvent:o})=>{const s=n.getByLabelText("Option one"),r=n.getByLabelText("Option two");await t("Assert `value` prop works",async()=>{e(s).toBeChecked(),e(r).not.toBeChecked()}),await t("Try toggling a Checkbox. `onChange` should fire, but the value is controlled, so the Checkbox shouldn’t toggle",async()=>{await o.click(s),e(a.onChange).toHaveBeenCalled(),e(s).toBeChecked(),e(r).not.toBeChecked()})}},g={tags:["control-state"],args:{label:"Uncontrolled",defaultValue:"one",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:c()},play:async({args:a,canvas:n,step:t,userEvent:o})=>{const s=n.getByLabelText("Option one"),r=n.getByLabelText("Option two");await t("Assert `defaultValue` prop works",async()=>{e(s).toBeChecked(),e(r).not.toBeChecked()}),await t("Toggling a Checkbox should both fire onChange & toggle the checked state, since the value is uncontrolled.",async()=>{await o.click(s),e(a.onChange).toHaveBeenCalled(),e(s).not.toBeChecked(),e(r).not.toBeChecked()}),await t("Reset to original value",async()=>{await o.click(s)})}},p={tags:["control-state"],args:{label:"Disabled",defaultValue:"one",disabled:!0,options:[{value:"one",label:"Option one",disabled:!1},{value:"two",label:"Option two"}],onChange:c()},play:async({canvas:a,step:n})=>{await n("Assert all Checkboxes are disabled",async()=>{e(a.getByLabelText("Option one")).toBeDisabled(),e(a.getByLabelText("Option two")).toBeDisabled()})}},m={args:{label:"Please select some standards",defaultValue:"8601",options:[{value:"aquila",label:"Roman Aquila"},{value:"8601",label:"ISO 8601"},{value:"high-society",label:"High Society",disabled:!0}],onChange:c()},play:async({canvas:a,step:n})=>{const t=a.getByLabelText("Roman Aquila"),o=a.getByLabelText("ISO 8601"),s=a.getByLabelText("High Society");await n("Assert the controlled Checkboxes are configured correctly",async()=>{e(t).not.toBeChecked(),e(t).not.toBeDisabled(),e(o).toBeChecked(),e(o).not.toBeDisabled(),e(s).not.toBeChecked(),e(s).toBeDisabled()})}},k={args:{label:"Please select some customizations",defaultValue:"colorful,embiggened",render:a=>l.createElement("div",{className:"flex flex-row items-baseline gap-x-6"},l.createElement(A,{...a({value:"colorful"}),label:l.createElement("span",{className:"font-bold text-blue-700"},"Colorful"),className:"rounded-sm bg-rose-200 p-2"}),l.createElement(A,{...a({value:"embiggened"}),sizer:"lg",label:"Embiggened"}),l.createElement("label",null,l.createElement("input",{type:"checkbox",...a({value:"native"})})," Native")),onChange:c()},play:async({canvas:a,step:n})=>{const t=a.getByLabelText("Colorful"),o=a.getByLabelText("Embiggened"),s=a.getByLabelText("Native");await n("Assert the render function’s callback works",async()=>{e(t).toBeChecked(),e(o).toBeChecked(),e(s).not.toBeChecked()})}},u={tags:["sizer"],args:{sizer:"xs",options:[{value:"one",label:"Xs"},{value:"two",label:"Checkboxes"}],onChange:c()},play:async({canvas:a,step:n})=>{await n("Assert the xs sizer style of both the Checkboxes & Fieldset",async()=>{a.getAllByTestId("indicator").forEach(t=>{e(t).toHaveClass("size-3.5")}),e(a.getByRole("group")).toHaveAttribute("data-nickui-sizer","xs")})}},h={tags:["sizer"],args:{sizer:"sm",options:[{value:"one",label:"Sm"},{value:"two",label:"Checkboxes"}],onChange:c()},play:async({canvas:a,step:n})=>{await n("Assert the sm sizer style of both the Checkboxes & Fieldset",async()=>{a.getAllByTestId("indicator").forEach(t=>{e(t).toHaveClass("size-4")}),e(a.getByRole("group")).toHaveAttribute("data-nickui-sizer","sm")})}},y={tags:["sizer"],args:{sizer:"base",options:[{value:"one",label:"Base"},{value:"two",label:"Checkboxes"}],onChange:c()},play:async({canvas:a,step:n})=>{await n("Assert the base sizer style of both the Checkboxes & Fieldset",async()=>{a.getAllByTestId("indicator").forEach(t=>{e(t).toHaveClass("size-4.75")}),e(a.getByRole("group")).toHaveAttribute("data-nickui-sizer","base")})}},x={tags:["sizer"],args:{sizer:"lg",options:[{value:"one",label:"Lg"},{value:"two",label:"Checkboxes"}],onChange:c()},play:async({canvas:a,step:n})=>{await n("Assert the lg style of both the Checkboxes & Fieldset",async()=>{a.getAllByTestId("indicator").forEach(t=>{e(t).toHaveClass("size-5.5")}),e(a.getByRole("group")).toHaveAttribute("data-nickui-sizer","lg")})}},C={tags:["sizer"],args:{sizer:"xl",options:[{value:"one",label:"Xl"},{value:"two",label:"Checkboxes"}],onChange:c()},play:async({canvas:a,step:n})=>{await n("Assert the xl style of both the Checkboxes & Fieldset",async()=>{a.getAllByTestId("indicator").forEach(t=>{e(t).toHaveClass("size-6")}),e(a.getByRole("group")).toHaveAttribute("data-nickui-sizer","xl")})}},B={tags:["sizer"],args:{label:"Responsive label",sizer:["xs","sm:sm","md:base","lg:lg","xl:xl"],options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}],onChange:c()}},w={tags:["!dev","!test"],render:a=>l.createElement("div",{className:"flex flex-col gap-4 sm:flex-row sm:justify-between"},l.createElement(i,{...b.args}),l.createElement(i,{...d.args}),l.createElement(i,{...g.args}),l.createElement(i,{...p.args}))},f={tags:["!dev","!test"],render:a=>l.createElement(z,{alignBaseline:!0},l.createElement(i,{...u.args}),l.createElement(i,{...h.args}),l.createElement(i,{...y.args}),l.createElement(i,{...x.args}),l.createElement(i,{...C.args}))};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  tags: ['field-layout'],
  args: {
    required: true,
    label: 'A label',
...
}`,...f.parameters?.docs?.source}}};const T=["fieldsetLayout","noValue","controlled","uncontrolled","disabled","standardLayout","customLayout","xs","sm","base","lg","xl","responsive","allControlStates","allSizers"],R=Object.freeze(Object.defineProperty({__proto__:null,__namedExportsOrder:T,allControlStates:w,allSizers:f,base:y,controlled:d,customLayout:k,default:O,disabled:p,fieldsetLayout:v,lg:x,noValue:b,responsive:B,sm:h,standardLayout:m,uncontrolled:g,xl:C,xs:u},Symbol.toStringTag,{value:"Module"}));export{m as a,k as c,R as s};
