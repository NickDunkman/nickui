import{r as a}from"./iframe-BKZX7tvf.js";import{C as H}from"./Checkbox-CU2a_0rr.js";import{F as V}from"./Fieldset-f12_sXif.js";import{u as j,c as M}from"./index-zgBM_x_G.js";import{r as B}from"./randomId-Dfhrkieu.js";function L({delimiter:s=",",...l}){return a.createElement(k,{...l,delimiter:s,Checkable:H,"data-nickui-component":"Checkboxes"})}function k({className:s,sizer:l,label:n,hint:p,error:u,disabled:r,required:h,Checkable:T,name:C,value:v,defaultValue:b,options:d,render:N,onChange:q,onBlur:P,delimiter:c,"data-nickui-component":z,...E}){const i=a.createRef(),[S]=a.useState(B()),[I,f]=a.useState(b),y=v!==void 0,m=y?v:I,x=!m||m===""?[]:c?m.split(c):[m];function A(e){let t;c?t=(e.target.checked?[...x,e.target.value]:x.filter(F=>F!==e.target.value)).sort(_(i)).join(c):t=e.target.checked?e.target.value:"",y||f(t);const w=g(i);w.value=t,q?.({...e,target:w})}function O(e){const t=g(i);P?.({...e,target:t})}function R({value:e,disabled:t=!1}){return{name:S,value:e,checked:x.includes(e),onChange:A,onBlur:O,disabled:r||t}}a.useLayoutEffect(()=>{if(v===void 0&&b===void 0){const e=g(i);e.value&&f(e.value)}else if(m){const e=g(i);e.value=m}},[]);const o=j(l);return a.createElement(V,{className:s,sizer:l,label:n,hint:p,error:u,disabled:r,required:h,"data-nickui-component":z},a.createElement("div",{ref:i,className:d&&M("flex flex-col",{"gap-y-1.5":o==="xs","gap-y-1.75":o==="sm","gap-y-2":o==="base","gap-y-2.25":o==="lg","gap-y-2.5":o==="xl"})},d&&a.createElement(a.Fragment,null,d.map(e=>a.createElement(T,{key:e.value?.toString(),sizer:l,...R({value:e.value,disabled:e.disabled}),label:e.label,hint:e.hint}))),!d&&N?.(R),a.createElement("input",{...E,name:C,type:"hidden",className:"the-hidden-input hidden",disabled:r,required:h,"data-testid":"the-hidden-input"})))}function _(s){const l=[...s.current?.getElementsByTagName("input")||[]].filter(n=>n.type==="checkbox"||n.type==="radio").map(n=>n.value);return(n,p)=>{const u=l.indexOf(n),r=l.indexOf(p);return r===-1?-1:u===-1?1:u-r}}function g(s){return[...s.current?.getElementsByClassName("the-hidden-input")||[]][0]}L.__docgenInfo={description:`Renders multiple checkboxes as one field in a Fieldset.
...
"lg:xl", etc)`},{key:"label",value:{name:"ReactReactNode",raw:"React.ReactNode",required:!1},description:"The main label to to the right of the form control, naming the field"},{key:"hint",value:{name:"ReactReactNode",raw:"React.ReactNode",required:!1},description:"Additional detail about the field, placed directly below the label"},{key:"disabled",value:{name:"boolean",required:!1},description:"Prevents the user from interacting with the control"}]}}]}]},description:""},"data-nickui-component":{required:!1,tsType:{name:"string"},description:""}},composes:["Omit"]};export{L as C,k as a};
