import{k as c}from"./index-DOz55NW-.js";import{r as l}from"./iframe-BuPrAHyZ.js";import{a as F,u as E,c as B}from"./index-BKq8PzBJ.js";const z=F({base:`
    text-nowrap
    appearance-none
    rounded-sm
    text-center
  ...
  `,variants:{sizer:{xs:"text-xs py-1.75 px-2.25",sm:"text-sm py-2 px-3",base:"text-base py-3 px-4.5",lg:"text-lg py-4 px-5.5",xl:"text-xl py-5 px-6.5"},isDisabled:{false:`
      ...
      `}},compoundVariants:[{isKeyboardFocused:!0,isKeyboardActivated:!0,isDisabled:!1,class:"focus:shadow-none focus:translate-y-0.25 focus:scale-99"},{flavor:"neutral",isSecondary:!1,isDisabled:!1,class:`
      ...
      `},{flavor:"neutral",isSecondary:!1,isKeyboardActivated:!0,isDisabled:!1,class:`
        [--nickui-button-hover-bg-color:var(--color-blue-700)]
        [--nickui-button-active-bg-color:var(--color-blue-700)]
        [--nickui-button-focus-bg-color:var(--color-blue-700)]
      `},{flavor:"neutral",isSecondary:!1,isTouchActivated:!0,isDisabled:!1,class:"[--nickui-button-coarse-bg-color:var(--color-blue-800)]"},{flavor:"neutral",isSecondary:!1,isKeyboardFocused:!0,isKeyboardActivated:!1,isDisabled:!1,class:"[--nickui-button-focus-bg-color:var(--color-blue-500)]"},{flavor:"neutral",isSecondary:!0,isDisabled:!1,class:`
        shadow-md/10
        text-blue-950
        bg-blue-200 
        hover:bg-[#c4e4ff]
      ...
      `},{flavor:"neutral",isSecondary:!0,isKeyboardActivated:!0,isDisabled:!1,class:"active:bg-blue-300 focus:bg-blue-300 hover:bg-blue-300"},{flavor:"neutral",isSecondary:!0,isTouchActivated:!0,isDisabled:!1,class:`
      ...
      `},{flavor:"neutral",isSecondary:!0,isKeyboardFocused:!0,isKeyboardActivated:!1,isDisabled:!1,class:"focus:bg-[#c4e4ff]"},{flavor:"positive",isSecondary:!1,isDisabled:!1,class:`
        bg-emerald-700 text-white
        hover:bg-emerald-600
        active:bg-emerald-800
        pointer-coarse:hover:bg-emerald-700 pointer-coarse:active:bg-emerald-700
      `},{flavor:"positive",isSecondary:!1,isKeyboardActivated:!0,isDisabled:!1,class:"active:bg-emerald-800 focus:bg-emerald-800 hover:bg-emerald-800"},{flavor:"positive",isSecondary:!1,isTouchActivated:!0,isDisabled:!1,class:`
      ...
      `},{flavor:"positive",isSecondary:!1,isKeyboardFocused:!0,isKeyboardActivated:!1,isDisabled:!1,class:"focus:bg-emerald-600"},{flavor:"positive",isSecondary:!0,isDisabled:!1,class:`
        shadow-md/10
        text-emerald-950
        bg-emerald-200
        hover:bg-[#bff2d9]
      ...
      `},{flavor:"neutral",isSecondary:!0,isKeyboardActivated:!0,isDisabled:!1,class:"active:bg-emerald-300 focus:bg-emerald-300 hover:bg-emerald-300"},{flavor:"neutral",isSecondary:!0,isTouchActivated:!0,isDisabled:!1,class:`
      ...
      `},{flavor:"neutral",isSecondary:!0,isKeyboardFocused:!0,isKeyboardActivated:!1,isDisabled:!1,class:"focus:bg-[#bff2d9]"},{flavor:"negative",isDisabled:!1,class:`
        bg-rose-700 text-white
        hover:bg-rose-600
        active:bg-rose-800
        pointer-coarse:hover:bg-rose-700 pointer-coarse:active:bg-rose-700
      `},{flavor:"negative",isKeyboardActivated:!0,isDisabled:!1,class:"active:bg-rose-800 focus:bg-rose-800 hover:bg-rose-800"},{flavor:"negative",isTouchActivated:!0,isDisabled:!1,class:`
      ...
      `},{flavor:"negative",isKeyboardFocused:!0,isKeyboardActivated:!1,isDisabled:!1,class:"focus:bg-rose-600"},{flavor:"negative",isSecondary:!0,isDisabled:!1,class:`
        shadow-md/10
        text-rose-950
        bg-rose-200 
        hover:bg-[#ffdadd]
      ...
      `},{flavor:"negative",isSecondary:!0,isKeyboardActivated:!0,isDisabled:!1,class:"active:bg-rose-300 focus:bg-rose-300 hover:bg-rose-300"},{flavor:"negative",isSecondary:!0,isTouchActivated:!0,isDisabled:!1,class:`
      ...
      `},{flavor:"negative",isSecondary:!0,isKeyboardFocused:!0,isKeyboardActivated:!1,isDisabled:!1,class:"focus:bg-[#ffdadd]"}],defaultVariants:{sizer:"base",flavor:"neutral",isSecondary:!1,isDisabled:!1,isTouchActivated:!1,isKeyboardFocused:!1}});function q({className:m,type:f="button",disabled:a=!1,sizer:o,flavor:g,secondary:p=!1,onTouchStart:y,onTouchEnd:h,onTouchCancel:x,onMouseDown:w,onKeyDown:S,onKeyUp:k,onFocus:A,onBlur:D,...K}){const[r,u]=l.useState(!1),[t,d]=l.useState(!1),[i,b]=l.useState(!1),[s,n]=l.useState(!1),v=E(o),T=z({sizer:v,flavor:g,isSecondary:p,isDisabled:a,isKeyboardFocused:!a&&t&&!r&&!s,isKeyboardActivated:!a&&i,isTouchActivated:!a&&s});return l.createElement("button",{...K,className:B(T,m),disabled:a,type:f,onBlur:e=>{r&&u(!1),t&&d(!1),D?.(e)},onFocus:e=>{t||d(!0),A?.(e)},onKeyDown:e=>{console.log(c(e.nativeEvent)),i||(c(e.nativeEvent)==="enter"||e.nativeEvent.key==="Enter"||c(e.nativeEvent)==="space"||e.nativeEvent.key===" ")&&b(!0),S?.(e)},onKeyUp:e=>{i&&b(!1),k?.(e)},onMouseDown:e=>{r||u(!0),w?.(e)},onTouchStart:e=>{s||n(!0),y?.(e)},onTouchEnd:e=>{s&&n(!1),h?.(e)},onTouchCancel:e=>{s&&n(!1),x?.(e)},"data-nickui-sizer":Array.isArray(o)?o.join(","):o,"data-nickui-resolved-sizer":v})}q.__docgenInfo={description:`Buttons allow the user to trigger an action, such as submitting a form
