...
<Docs.FormLibraryDemos of="Switches" fieldName="preShotRoutine">
  {({ props, error }) => (
    <Switches
      {...props}
      ...
      options={[
        ...
        {
          value: 'imagine',
          label: '2. Imagine the shot',
        },
        {
          value: 'target',
          label: '3. Pick a target',
        },
        {
          value: 'club',
          label: '4. Choose club',
...
<Docs.KeyboardInteractions
  keys={[
    ['Tab', 'Cycles focus between the individual switches'],
    ['Space', 'Toggles the checked state of the focused switch'],
  ]}
/>
