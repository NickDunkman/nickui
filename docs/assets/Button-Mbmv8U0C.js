import{r as i}from"./iframe-BKg6Mjzb.js";import{a as v,S as o,u as y,c as w}from"./index-DPOB3eB5.js";var e=(r=>(r.primary="primary",r.secondary="secondary",r.danger="danger",r))(e||{});const T=v({base:`
    appearance-none
    border-1 rounded-sm
    text-center
  ...
  `,variants:{sizer:{[o.small]:"text-sm py-1.75 px-3",[o.medium]:"text-base py-2.75 px-4.5",[o.large]:"text-lg py-3.75 px-5.5"},flavor:{[e.primary]:`
      ...
      `}],defaultVariants:{sizer:o.small,flavor:e.primary}});function n({className:r,type:d="button",disabled:l=!1,sizer:c,flavor:u,onTouchStart:p,onTouchEnd:m,onTouchCancel:h,...b}){const[t,s]=i.useState(!1),g=y(c),f=T({sizer:g,flavor:u,isTouched:t});return i.createElement("button",{...b,className:w(f,r),disabled:l,type:d,onTouchStart:a=>{t||s(!0),p?.(a)},onTouchEnd:a=>{t&&s(!1),m?.(a)},onTouchCancel:a=>{t&&s(!1),h?.(a)}})}n.flavor=e;n.sizer=o;n.__docgenInfo={description:`Buttons allow the user to trigger an action, such as submitting a form
