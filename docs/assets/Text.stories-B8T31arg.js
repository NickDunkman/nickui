import{r}from"./iframe-BOhUS0D9.js";import{A as _}from"./AllSizersStoryWrapper-B8yhyoy3.js";import{F as R}from"./Field-BCFMpcPz.js";import{u as k}from"./useFieldA11yIds-CMM-qVMC.js";import{u as N}from"./index-DNuRN-av.js";import{t as X}from"./styles-BLS07UrL.js";function o({className:e,sizer:l,label:s,hint:n,error:t,required:w,disabled:H,id:A,"aria-labelledby":z,"aria-describedby":S,"aria-errormessage":E,"aria-invalid":B,...L}){const c=k({label:s,hint:n,error:t,controlledId:A,controlledAriaLabelledBy:z,controlledAriaDescribedBy:S,controlledAriaErrorMessage:E}),V=N(l),q=X({sizer:V,hasError:!!t});return r.createElement(R,{className:e,sizer:l,label:s,labelId:c.ariaLabelledBy,controlId:c.id,hint:n,hintId:c.ariaDescribedBy,error:t!==!0?t:void 0,errorId:c.ariaErrorMessage,disabled:H,required:w},r.createElement("input",{...L,id:c.id,className:q,disabled:H,required:w,"aria-labelledby":c.ariaLabelledBy,"aria-describedby":c.ariaDescribedBy,"aria-errormessage":c.ariaErrorMessage,"aria-invalid":B!==void 0?B:!!t}))}o.__docgenInfo={description:`A form control that allows users to enter & edit a single line of text
...
}`,...C.parameters?.docs?.source}}};const D=["fieldLayout","empty","controlled","uncontrolled","disabled","xs","sm","base","lg","xl","responsive","allControlStates","allSizers"],j=Object.freeze(Object.defineProperty({__proto__:null,__namedExportsOrder:D,allControlStates:f,allSizers:C,base:v,controlled:u,default:F,disabled:p,empty:m,fieldLayout:h,lg:y,responsive:T,sm:x,uncontrolled:d,xl:b,xs:g},Symbol.toStringTag,{value:"Module"}));export{o as T,j as s};
