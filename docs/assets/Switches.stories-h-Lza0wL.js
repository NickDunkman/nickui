import{r as e}from"./iframe-DYxnnFe3.js";import{S as d}from"./Switch-Of6O2IZ4.js";import{F as A}from"./index-Czi7Upa3.js";import{a as P}from"./Checkboxes-BTFHBw15.js";function a({delimiter:s=",",...L}){return e.createElement(P,{...L,Checkable:d,delimiter:s})}a.sizer=A;a.__docgenInfo={description:`Renders multiple <Switch> as one field in a <Fieldset>.
...
number format`},error:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Error message to show along with the field"},required:{required:!1,tsType:{name:"boolean"},description:"Adds an asterisk to the label"},disabled:{required:!1,tsType:{name:"boolean"},description:"Prevents the user from interacting with the control"}},composes:["Omit"]};const M={title:"Form controls/Switches",component:a},r={args:{label:"Please select some standards",defaultValue:"8601",options:[{value:"aquila",label:"Roman Aquila"},{value:"8601",label:"ISO 8601"},{value:"high-society",label:"High Society",disabled:!0}]}},o={args:{label:"Please select some customizations",defaultValue:"colorful,embiggened",render:s=>e.createElement("div",{className:"flex flex-row items-baseline gap-x-6"},e.createElement(d,{...s({value:"colorful"}),label:e.createElement("span",{className:"font-bold text-blue-700"},"Colorful"),className:"rounded-sm bg-rose-200 p-2"}),e.createElement(d,{...s({value:"embiggened"}),sizer:d.sizer.large,label:"Embiggened"}),e.createElement("div",null,e.createElement("input",{type:"checkbox",...s({value:"native"}),"aria-label":"example using different control component"})," ","Native"))}},i={args:{label:"A label",hint:"A hint",error:"An error message",options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}]}},t={args:{label:"Small label",hint:"Small hint",sizer:a.sizer.small,options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}]}},n={args:{label:"Medium label",hint:"Medium hint",sizer:a.sizer.medium,options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}]}},l={args:{label:"Large label",hint:"Large hint",sizer:a.sizer.large,options:[{value:"one",label:"Option one"},{value:"two",label:"Option two"}]}},c={tags:["!dev","!test"],render:()=>e.createElement("div",{className:"flex flex-col gap-x-12 gap-y-8 sm:flex-row sm:items-baseline"},e.createElement(a,{...t.args,className:"sm:flex-1"}),e.createElement(a,{...n.args,className:"sm:flex-1"}),e.createElement(a,{...l.args,className:"sm:flex-1"}))};var u,m,p;r.parameters={...r.parameters,docs:{...(u=r.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
...
}`,...(w=(v=i.parameters)==null?void 0:v.docs)==null?void 0:w.source}}};var y,S,R;t.parameters={...t.parameters,docs:{...(y=t.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    label: 'Small label',
    hint: 'Small hint',
...
}`,...(R=(S=t.parameters)==null?void 0:S.docs)==null?void 0:R.source}}};var N,x,z;n.parameters={...n.parameters,docs:{...(N=n.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    label: 'Medium label',
    hint: 'Medium hint',
...
}`,...(z=(x=n.parameters)==null?void 0:x.docs)==null?void 0:z.source}}};var q,O,k;l.parameters={...l.parameters,docs:{...(q=l.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    label: 'Large label',
    hint: 'Large hint',
...
}`,...(k=(O=l.parameters)==null?void 0:O.docs)==null?void 0:k.source}}};var E,C,T;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`{
  tags: ['!dev', '!test'],
  render: () => <div className="flex flex-col gap-x-12 gap-y-8 sm:flex-row sm:items-baseline">
      <Switches {...Small.args} className="sm:flex-1" />
      <Switches {...Medium.args} className="sm:flex-1" />
      <Switches {...Large.args} className="sm:flex-1" />
    </div>
}`,...(T=(C=c.parameters)==null?void 0:C.docs)==null?void 0:T.source}}};const F=["StandardLayout","CustomLayout","FieldsetLayout","Small","Medium","Large","AllSizes"],j=Object.freeze(Object.defineProperty({__proto__:null,AllSizes:c,CustomLayout:o,FieldsetLayout:i,Large:l,Medium:n,Small:t,StandardLayout:r,__namedExportsOrder:F,default:M},Symbol.toStringTag,{value:"Module"}));export{o as C,j as S,a,r as b};
