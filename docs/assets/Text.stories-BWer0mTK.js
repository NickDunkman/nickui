import{r}from"./iframe-CczT3480.js";import{F as k}from"./Field-DELreOLn.js";import{a as D,S as h,u as O}from"./index-B9jOoLAk.js";import{r as f}from"./randomId-Dfhrkieu.js";const F=D({base:`
    w-full
    border-2 rounded-sm
    bg-white
  ...
  `,variants:{sizer:{[h.small]:"text-sm py-1.5 px-2",[h.medium]:"text-base py-2.5 px-3.5",[h.large]:"text-lg py-3.5 px-4.5"},hasError:{true:"border-rose-800 focus:border-rose-800 focus:shadow-rose-300"}},defaultVariants:{sizer:h.small,hasError:!1}});function l({className:e,sizer:s,label:n,hint:o,error:a,required:w,disabled:C,id:B,"aria-describedby":L,"aria-errormessage":z,"aria-invalid":H,...V}){const[M]=r.useState(f()),A=B||(n?M:void 0),[R]=r.useState(f()),E=L||(o?R:void 0),[_]=r.useState(f()),S=z||(a&&a!==!0?_:void 0),q=O(s),N=F({sizer:q,hasError:!!a});return r.createElement(k,{className:e,sizer:s,label:n,controlId:A,hint:o,hintId:E,error:a!==!0?a:void 0,errorId:S,disabled:C,required:w},r.createElement("input",{...V,id:A,className:N,disabled:C,required:w,"aria-describedby":E,"aria-errormessage":S,"aria-invalid":H!==void 0?H:!!a}))}l.sizer=h;l.__docgenInfo={description:`A form control that allows users to enter & edit a single line of text
...
number format`},error:{required:!1,tsType:{name:"ReactNode"},description:"Error message to show along with the field, or just `true` to trigger the\nerror style without showing an error message."},required:{required:!1,tsType:{name:"boolean"},description:"When `true`, adds an asterisk to the label"},disabled:{required:!1,tsType:{name:"boolean"},description:"Prevents the user from interacting with the control"}}};const{expect:t,fn:i}=__STORYBOOK_MODULE_TEST__,U={title:"Form controls/Text",component:l},v={args:{required:!0,label:"A label",hint:"A hint",error:"An error message",defaultValue:"A problematic value",onChange:i()},play:async({canvas:e,step:s})=>{const n=e.getByLabelText("A label*"),o=e.getByTitle("required");await s("Assert accessibility of layout elements",async()=>{t(n).toHaveRole("textbox"),t(n).toHaveAccessibleDescription("A hint"),t(n).toHaveAccessibleErrorMessage("An error message"),t(o).toHaveTextContent("*")}),await s("Assert the error style",async()=>{t(n).toHaveClass("border-rose-800")})}},c={args:{placeholder:"Empty Text","aria-label":"Empty Text",onChange:i()},play:async({args:e,canvas:s,step:n,userEvent:o})=>{const a=s.getByLabelText("Empty Text");await n("Assert Text is functional without an initial value",async()=>{await o.type(a,"a"),t(a).toHaveValue("a"),t(e.onChange).toHaveBeenCalledOnce()}),await n("Reset the value",async()=>{await o.type(a,"{backspace}"),t(a).toHaveValue("")})}},d={args:{value:"Controlled Text","aria-label":"Controlled Text",onChange:i()},play:async({args:e,canvas:s,step:n,userEvent:o})=>{const a=s.getByLabelText("Controlled Text");await n("Assert `value` works",async()=>{t(a).toHaveValue(e.value)}),await n("Try adding text. `onChange` should fire, but the value is controlled, so it shouldn’t change",async()=>{await o.type(a,"a"),t(e.onChange).toHaveBeenCalledOnce(),t(a).toHaveValue(e.value)})}},u={args:{defaultValue:"Uncontrolled Text","aria-label":"Uncontrolled Text",onChange:i()},play:async({args:e,canvas:s,step:n,userEvent:o})=>{const a=s.getByLabelText("Uncontrolled Text");await n("Assert `defaultValue` works",async()=>{t(a).toHaveValue(e.defaultValue)}),await n("Typing into the Text should amend the value, since it’s uncontrolled",async()=>{await o.type(a,"a"),t(a).toHaveValue(`${e.defaultValue}a`),t(e.onChange).toHaveBeenCalledOnce()}),await n("Reset the value",async()=>{await o.type(a,"{backspace}"),t(a).toHaveValue(e.defaultValue)})}},p={args:{defaultValue:"Disabled Text",disabled:!0,"aria-label":"Disabled Text",onChange:i()},play:async({args:e,canvas:s,step:n,userEvent:o})=>{const a=s.getByLabelText("Disabled Text");await n("Assert disabled state",async()=>{t(a).toBeDisabled()}),await n("Typing should have no effect",async()=>{await o.type(a,"a"),t(e.onChange).not.toHaveBeenCalled(),t(a).toHaveValue(e.defaultValue)})}},m={args:{sizer:l.sizer.small,label:"Small label",placeholder:"Small Text (default)",onChange:i()},play:async({canvas:e,step:s})=>{await s("Assert the small style on both the Text & Field",async()=>{t(e.getByLabelText("Small label")).toHaveClass("text-sm"),t(e.getByText("Small label")).toHaveClass("text-xs")})}},g={args:{sizer:l.sizer.medium,label:"Medium label",placeholder:"Medium Text",onChange:i()},play:async({canvas:e,step:s})=>{await s("Assert the medium style on both the Text & Field",async()=>{t(e.getByLabelText("Medium label")).toHaveClass("text-base"),t(e.getByText("Medium label")).toHaveClass("text-sm")})}},x={args:{sizer:l.sizer.large,label:"Large label",placeholder:"Large Text",onChange:i()},play:async({canvas:e,step:s})=>{await s("Assert the large style on both the Text & Field",async()=>{t(e.getByLabelText("Large label")).toHaveClass("text-lg"),t(e.getByText("Large label")).toHaveClass("text-lg")})}},y={tags:["!test"],args:{sizer:[l.sizer.smMedium,l.sizer.mdLarge],label:"Responsive label",placeholder:"Responsive Text",onChange:i()}},b={tags:["!dev","!test"],render:e=>r.createElement("div",{className:"flex flex-col gap-4"},r.createElement(l,{...c.args}),r.createElement(l,{...d.args}),r.createElement(l,{...u.args}),r.createElement(l,{...p.args}))},T={tags:["!dev","!test"],render:e=>r.createElement("div",{className:"flex flex-col gap-4 sm:flex-row sm:items-baseline"},r.createElement(l,{...m.args,className:"sm:flex-1"}),r.createElement(l,{...g.args,className:"sm:flex-1"}),r.createElement(l,{...x.args,className:"sm:flex-1"}),r.createElement(l,{...y.args,className:"sm:flex-1"}))};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    required: true,
    label: 'A label',
    hint: 'A hint',
