...
This is simpler than the [Field](/docs/form-field--docs/) component. There’s no
...
Note: this layout is already built-into [Checkbox](/docs/forms-checkbox--docs/),
[Radio](/docs/forms-radio--docs/), and [Switch](/docs/forms-switch--docs/)—you
