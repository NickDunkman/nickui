import{r as a}from"./iframe-BHWhhQOG.js";import{a as l}from"./Checkbox-FgbetUOE.js";import{r as n}from"./index-te24yuVz.js";const t=n({slots:{root:"",input:"peer opacity-0 absolute -z-1",indicator:`
    ...
    `},variants:{sizer:{xs:{indicator:"size-3.5 top-0.25 peer-checked:after:size-1.25"},sm:{indicator:"size-4 top-[2.5px] peer-checked:after:size-1.5"},base:{indicator:"size-4.75 top-0.75 peer-checked:after:size-1.75"},lg:{indicator:"size-5.5 top-[3.5px] peer-checked:after:size-2"},xl:{indicator:"size-6 top-0.75 peer-checked:after:size-2.25"}},isDisabled:{true:{indicator:`
        ...
        `}}},defaultVariants:{sizer:"base",isDisabled:!1,isKeyboardFocused:!1}});function r(e){return a.createElement(l,{...e,type:"radio",styler:t,"data-nickui-component":"Radio"})}r.__docgenInfo={description:`A form control that allow users to choose one option from a set
