import{r as n}from"./iframe-DOqKYI6o.js";import{F as oe}from"./Field-DBcgitAT.js";import{a as ce,S as c,u as me}from"./index-D3vd8min.js";import{r as B}from"./randomId-Dfhrkieu.js";const de=ce({slots:{root:"relative",textarea:`
    ...
    `,hiddenTextarea:"invisible absolute -z-1 pointer-events-none select-none"},compoundSlots:[{slots:["textarea","hiddenTextarea"],className:"appearance-none w-full border-2"},{slots:["textarea","hiddenTextarea"],sizer:c.small,className:"text-sm py-1.5 px-2"},{slots:["textarea","hiddenTextarea"],sizer:c.medium,className:"text-base py-2.5 px-3.5"},{slots:["textarea","hiddenTextarea"],sizer:c.large,className:"text-lg py-3.5 px-4.5"}],variants:{sizer:{[c.small]:{},[c.medium]:{},[c.large]:{}},hasError:{false:{},true:{textarea:"border-rose-800 focus:border-rose-800 focus:shadow-rose-300"}},disableManualResize:{false:{},true:{textarea:"resize-none"}}},defaultVariants:{sizer:c.small,hasError:!1}});function u({className:e,sizer:r,label:s,hint:i,error:a,disabled:l,required:L,id:G,defaultValue:D,value:M,onChange:$,rows:F,minRows:m=2,maxRows:z=10,disableManualResize:K,"aria-describedby":Y,"aria-errormessage":J,"aria-invalid":I,...X}){const k=n.createRef(),x=n.useRef(null),[A,Z]=n.useState(0),ee=F!==void 0?F:A>m?A:m,[ae,_]=n.useState(D),O=M!==void 0,H=O?M:ae;function te(o){O||_(o.target.value),$?.(o)}n.useLayoutEffect(()=>{if(x.current){x.current.value=H||"";const o=getComputedStyle(x.current),ue=P(o.lineHeight),le=P(o.paddingTop)+P(o.paddingBottom),R=Math.ceil((x.current.scrollHeight-le)/ue),W=R<m?m:R>z?z:R;W!==A&&Z(W)}},[H,m,z,A]),n.useLayoutEffect(()=>{if(M===void 0&&D===void 0){const o=pe(k);o.value&&_(o.value)}},[]);const[se]=n.useState(B()),U=G||(s?se:void 0),[ie]=n.useState(B()),j=Y||(i?ie:void 0),[re]=n.useState(B()),Q=J||(a&&a!==!0?re:void 0),ne=me(r),N=de({sizer:ne,hasError:!!a,disableManualResize:K});return n.createElement(oe,{className:e,sizer:r,label:s,controlId:U,hint:i,hintId:j,error:a!==!0?a:void 0,errorId:Q,disabled:l,required:L},n.createElement("div",{ref:k,className:N.root()},n.createElement("textarea",{ref:x,className:N.hiddenTextarea(),rows:m,disabled:!0,"aria-hidden":!0}),n.createElement("textarea",{...X,id:U,className:N.textarea(),rows:ee,value:H,onChange:te,disabled:l,required:L,"aria-describedby":j,"aria-errormessage":Q,"aria-invalid":I!==void 0?I:!!a})))}u.sizer=c;function P(e){return Number(e.slice(0,-2))}function pe(e){return[...e.current?.getElementsByTagName("textarea")||[]][1]}u.__docgenInfo={description:`A form control that allows users to enter & edit a mass of text
...
}`,...S.parameters?.docs?.source}}};const ve=["FieldLayout","Empty","Controlled","Uncontrolled","Disabled","Small","Medium","Large","AutoResizableHeight","FixedHeight","DisableManualResize","AllControlStates","AllSizes"],ye=Object.freeze(Object.defineProperty({__proto__:null,AllControlStates:C,AllSizes:S,AutoResizableHeight:q,Controlled:p,DisableManualResize:w,Disabled:v,Empty:d,FieldLayout:y,FixedHeight:T,Large:h,Medium:f,Small:b,Uncontrolled:g,__namedExportsOrder:ve,default:ge},Symbol.toStringTag,{value:"Module"}));export{q as A,w as D,T as F,ye as S,u as T};
