import{r as s}from"./iframe-BLM9_nYH.js";import{A as z}from"./AllSizersStoryWrapper-DvGML2ek.js";import{a as f,u as w,c as A}from"./index-BGW97fss.js";const R=f({base:`
    rounded-sm font-medium
  `,variants:{sizer:{xs:"text-xs px-2.5 py-1.5",sm:"text-sm px-3 py-2",base:"text-base px-4 py-3",lg:"text-lg px-5 py-4",xl:"text-xl px-6 py-5"},flavor:{neutral:"bg-blue-800 text-white",positive:"bg-emerald-700 text-white",caution:"bg-yellow-500 text-yellow-950",negative:"bg-rose-700 text-white"}},defaultVariants:{sizer:"base",flavor:"neutral"}});function t({className:a,sizer:e,flavor:h,...S}){const y=w(e),b=R({sizer:y,flavor:h});return s.createElement("div",{...S,className:A(b,a),"data-nickui-sizer":Array.isArray(e)?e.join(","):e,"data-nickui-resolved-sizer":y})}t.__docgenInfo={description:`Displays an important notice to the user, such as an error message, warning,
