import{r}from"./iframe-CczT3480.js";import{F as ce}from"./Field-DELreOLn.js";import{a as me,S as m,u as de}from"./index-B9jOoLAk.js";import{r as P}from"./randomId-Dfhrkieu.js";const pe=me({slots:{root:"relative",textarea:`
    ...
    `,hiddenTextarea:"invisible absolute -z-1 pointer-events-none select-none"},compoundSlots:[{slots:["textarea","hiddenTextarea"],className:"appearance-none w-full border-2"},{slots:["textarea","hiddenTextarea"],sizer:m.small,className:"text-sm py-1.5 px-2"},{slots:["textarea","hiddenTextarea"],sizer:m.medium,className:"text-base py-2.5 px-3.5"},{slots:["textarea","hiddenTextarea"],sizer:m.large,className:"text-lg py-3.5 px-4.5"}],variants:{sizer:{[m.small]:{},[m.medium]:{},[m.large]:{}},hasError:{false:{},true:{textarea:"border-rose-800 focus:border-rose-800 focus:shadow-rose-300"}},disableManualResize:{false:{},true:{textarea:"resize-none"}}},defaultVariants:{sizer:m.small,hasError:!1}});function u({className:e,sizer:n,label:s,hint:i,error:a,disabled:o,required:D,id:$,defaultValue:F,value:z,onChange:K,rows:I,minRows:d=2,maxRows:R=10,disableManualResize:Y,"aria-describedby":J,"aria-errormessage":X,"aria-invalid":k,...Z}){const _=r.createRef(),q=r.useRef(null),[V,ee]=r.useState(0),ae=I!==void 0?I:V>d?V:d,[te,O]=r.useState(F),U=z!==void 0,H=U?z:te;function se(c){U||O(c.target.value),K?.(c)}r.useLayoutEffect(()=>{if(q.current){q.current.value=H||"";const c=getComputedStyle(q.current),le=L(c.lineHeight),oe=L(c.paddingTop)+L(c.paddingBottom),B=Math.ceil((q.current.scrollHeight-oe)/le),G=B<d?d:B>R?R:B;G!==V&&ee(G)}},[H,d,R,V]),r.useLayoutEffect(()=>{if(z===void 0&&F===void 0){const c=ge(_);c.value&&O(c.value)}},[]);const[ie]=r.useState(P()),j=$||(s?ie:void 0),[ne]=r.useState(P()),Q=J||(i?ne:void 0),[re]=r.useState(P()),W=X||(a&&a!==!0?re:void 0),ue=de(n),N=pe({sizer:ue,hasError:!!a,disableManualResize:Y});return r.createElement(ce,{className:e,sizer:n,label:s,controlId:j,hint:i,hintId:Q,error:a!==!0?a:void 0,errorId:W,disabled:o,required:D},r.createElement("div",{ref:_,className:N.root()},r.createElement("textarea",{ref:q,className:N.hiddenTextarea(),rows:d,disabled:!0,"aria-hidden":!0}),r.createElement("textarea",{...Z,id:j,className:N.textarea(),rows:ae,value:H,onChange:se,disabled:o,required:D,"aria-describedby":Q,"aria-errormessage":W,"aria-invalid":k!==void 0?k:!!a})))}u.sizer=m;function L(e){return Number(e.slice(0,-2))}function ge(e){return[...e.current?.getElementsByTagName("textarea")||[]][1]}u.__docgenInfo={description:`A form control that allows users to enter & edit a mass of text
...
}`,...E.parameters?.docs?.source}}};const be=["FieldLayout","Empty","Controlled","Uncontrolled","Disabled","Small","Medium","Large","Responsive","AutoResizableHeight","FixedHeight","DisableManualResize","AllControlStates","AllSizes"],qe=Object.freeze(Object.defineProperty({__proto__:null,AllControlStates:A,AllSizes:E,AutoResizableHeight:w,Controlled:g,DisableManualResize:S,Disabled:b,Empty:p,FieldLayout:T,FixedHeight:C,Large:x,Medium:f,Responsive:y,Small:h,Uncontrolled:v,__namedExportsOrder:be,default:ve},Symbol.toStringTag,{value:"Module"}));export{w as A,S as D,C as F,qe as S,u as T};
