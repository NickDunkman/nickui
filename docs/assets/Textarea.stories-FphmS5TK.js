import{r as e}from"./iframe-DYxnnFe3.js";import{F as Qe}from"./Field-B3CBD8It.js";import{c as We,F as r}from"./index-Czi7Upa3.js";import{r as F}from"./randomId-Dfhrkieu.js";const Ge=We({slots:{root:"relative",textarea:`
    ...
    `,hiddenTextarea:"invisible absolute -z-1 pointer-events-none select-none"},compoundSlots:[{slots:["textarea","hiddenTextarea"],className:"appearance-none w-full border-2"},{slots:["textarea","hiddenTextarea"],sizer:r.small,className:"text-sm py-1.5 px-2"},{slots:["textarea","hiddenTextarea"],sizer:r.medium,className:"text-base py-2.5 px-3.5"},{slots:["textarea","hiddenTextarea"],sizer:r.large,className:"text-lg py-3.5 px-4.5"}],variants:{sizer:{[r.small]:{},[r.medium]:{},[r.large]:{}},hasError:{false:{},true:{textarea:"border-rose-800 focus:border-rose-800 focus:shadow-rose-300"}},disableManualResize:{false:{},true:{textarea:"resize-none"}}},defaultVariants:{sizer:r.small,hasError:!1}});function a({className:m,sizer:p,label:H,hint:D,error:s,disabled:L,required:j,id:Fe,defaultValue:U,value:w,onChange:A,rows:g=2,maxRows:z=10,disableManualResize:He,"aria-describedby":De,"aria-errormessage":Le,"aria-invalid":_,...je}){const P=e.createRef(),b=e.useRef(null),[h,M]=e.useState(0),[Ue,B]=e.useState(U),k=w!==void 0,R=k?w:Ue;function _e(t){k||B(t.target.value),A==null||A(t)}e.useLayoutEffect(()=>{if(z>g&&b.current){b.current.value=R||"";const t=getComputedStyle(b.current),G=x(t.lineHeight),J=x(t.paddingTop)+x(t.paddingBottom),N=x(t.borderTopWidth)+x(t.borderBottomWidth),S=b.current.scrollHeight+N,C=g*G+J+N,V=z*G+J+N;S>V?h!==V&&M(V):S<C?h!==C&&M(C):h!==S&&M(S)}},[R,g,z,h]),e.useLayoutEffect(()=>{if(w===void 0&&U===void 0){const t=Je(P);t.value&&B(t.value)}},[]);const[Pe]=e.useState(F()),O=Fe||(H?Pe:void 0),[Be]=e.useState(F()),Q=De||(D?Be:void 0),[ke]=e.useState(F()),W=Le||(s&&s!==!0?ke:void 0),Oe=z>g?{style:{height:h}}:{rows:g},I=Ge({sizer:p,hasError:!!s,disableManualResize:He});return e.createElement(Qe,{className:m,sizer:p,label:H,controlId:O,hint:D,hintId:Q,error:s!==!0?s:void 0,errorId:W,disabled:L,required:j},e.createElement("div",{ref:P,className:I.root()},e.createElement("textarea",{"aria-hidden":!0,disabled:!0,ref:b,className:I.hiddenTextarea()}),e.createElement("textarea",{...je,...Oe,id:O,className:I.textarea(),value:R,onChange:_e,disabled:L,required:j,"aria-describedby":Q,"aria-errormessage":W,"aria-invalid":_!==void 0?_:!!s})))}a.sizer=r;function x(m){return Number(m.slice(0,-2))}function Je(m){var p;return[...((p=m.current)==null?void 0:p.getElementsByTagName("textarea"))||[]][1]}a.__docgenInfo={description:`A form control that allows users to enter & edit a mass of text
...
}`,...(Y=(X=f.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};var Z,$,ee;i.parameters={...i.parameters,docs:{...(Z=i.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  args: {
    placeholder: 'Empty Textarea',
    'aria-label': 'Empty Textarea with no set value'
  }
}`,...(ee=($=i.parameters)==null?void 0:$.docs)==null?void 0:ee.source}}};var ae,te,re;l.parameters={...l.parameters,docs:{...(ae=l.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  args: {
    value: 'Controlled Textarea',
    onChange: () => {},
    'aria-label': 'Example Textarea with a controlled value'
  }
}`,...(re=(te=l.parameters)==null?void 0:te.docs)==null?void 0:re.source}}};var se,ie,le;n.parameters={...n.parameters,docs:{...(se=n.parameters)==null?void 0:se.docs,source:{originalSource:`{
  args: {
    defaultValue: 'Uncontrolled Textarea',
    'aria-label': 'Example Textarea with an uncontrolled value'
  }
}`,...(le=(ie=n.parameters)==null?void 0:ie.docs)==null?void 0:le.source}}};var ne,oe,ue;o.parameters={...o.parameters,docs:{...(ne=o.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  args: {
    defaultValue: 'Disabled Textarea',
    disabled: true,
    'aria-label': 'Example disabled Textarea'
  }
}`,...(ue=(oe=o.parameters)==null?void 0:oe.docs)==null?void 0:ue.source}}};var ce,de,me;v.parameters={...v.parameters,docs:{...(ce=v.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  tags: ['!dev', '!test'],
...
}`,...(me=(de=v.parameters)==null?void 0:de.docs)==null?void 0:me.source}}};var pe,ge,be;u.parameters={...u.parameters,docs:{...(pe=u.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  args: {
    sizer: Textarea.sizer.small,
    placeholder: 'Small Textarea (default)',
    'aria-label': 'Example small Textarea'
  }
}`,...(be=(ge=u.parameters)==null?void 0:ge.docs)==null?void 0:be.source}}};var he,xe,fe;c.parameters={...c.parameters,docs:{...(he=c.parameters)==null?void 0:he.docs,source:{originalSource:`{
  args: {
    sizer: Textarea.sizer.medium,
    placeholder: 'Medium Textarea',
    'aria-label': 'Example medium Textarea'
  }
}`,...(fe=(xe=c.parameters)==null?void 0:xe.docs)==null?void 0:fe.source}}};var ve,Te,qe;d.parameters={...d.parameters,docs:{...(ve=d.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  args: {
    sizer: Textarea.sizer.large,
    placeholder: 'Large Textarea',
    'aria-label': 'Example large Textarea'
  }
}`,...(qe=(Te=d.parameters)==null?void 0:Te.docs)==null?void 0:qe.source}}};var ye,Ee,ze;T.parameters={...T.parameters,docs:{...(ye=T.parameters)==null?void 0:ye.docs,source:{originalSource:`{
  tags: ['!dev', '!test'],
  render: () => <div className="flex flex-col gap-4">
      <Textarea {...Small.args} />
...
}`,...(Ve=(Ce=E.parameters)==null?void 0:Ce.docs)==null?void 0:Ve.source}}};const Xe=["FieldLayout","Empty","Controlled","Uncontrolled","Disabled","AllControlStates","Small","Medium","Large","AllSizes","AutoResizableHeight","FixedHeight","DisableManualResize"],aa=Object.freeze(Object.defineProperty({__proto__:null,AllControlStates:v,AllSizes:T,AutoResizableHeight:q,Controlled:l,DisableManualResize:E,Disabled:o,Empty:i,FieldLayout:f,FixedHeight:y,Large:d,Medium:c,Small:u,Uncontrolled:n,__namedExportsOrder:Xe,default:Ke},Symbol.toStringTag,{value:"Module"}));export{q as A,E as D,y as F,aa as S,a as T};
