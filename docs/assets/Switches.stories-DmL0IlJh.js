import{r as l}from"./iframe-CorW3x8U.js";import{S as B}from"./Switch-CzHDMBno.js";import{S as k}from"./index-DEIdBdoc.js";import{a as S}from"./Checkboxes-B6dovE-Y.js";function r({delimiter:a=",",...n}){return l.createElement(S,{...n,Checkable:B,delimiter:a})}r.sizer=k;r.__docgenInfo={description:`Renders multiple <Switch> as one field in a <Fieldset>.
...
}`,...C.parameters?.docs?.source}}};const O=["FieldsetLayout","NoValue","Controlled","Uncontrolled","Disabled","StandardLayout","CustomLayout","Small","Medium","Large","Responsive","AllControlStates","AllSizes"],E=Object.freeze(Object.defineProperty({__proto__:null,AllControlStates:x,AllSizes:C,Controlled:p,CustomLayout:f,Disabled:m,FieldsetLayout:v,Large:b,Medium:h,NoValue:d,Responsive:y,Small:g,StandardLayout:w,Uncontrolled:u,__namedExportsOrder:O,default:T},Symbol.toStringTag,{value:"Module"}));export{f as C,E as S,r as a,w as b};
