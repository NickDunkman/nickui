  ...
  source={{
    ...
    code: `
      ...
      <div className="flex gap-4 flex-wrap">
        <Button onClick={() => toast({ title: 'Info Toast', body: 'Lorem ipsum ...' })} />
          Info Toast
        </Button>
        <Button onClick={() => toast({ title: 'Yep Toast', body: 'Lorem ipsum ...' })} />
          Yep Toast
        </Button>
        <Button onClick={() => toast({ title: 'Maybe Toast', body: 'Lorem ipsum ...' })} />
          Maybe Toast
        </Button>
        <Button onClick={() => toast({ title: 'Nope Toast', body: 'Lorem ipsum ...' })} />
          Nope Toast
        </Button>
      </div>
    `,
...
could catch an HTTP error and then resolve with `flavor: 'nope'`.
