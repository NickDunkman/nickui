import{k as u}from"./index-CxnPVIKe.js";import{r as t}from"./iframe-CczT3480.js";import{a as B,S as i,u as q,c as M}from"./index-B9jOoLAk.js";var r=(o=>(o.primary="primary",o.secondary="secondary",o.danger="danger",o))(r||{});const R=B({base:`
    appearance-none
    border-1 rounded-sm
    text-center
    select-none
    ...
    outline-none
  `,variants:{sizer:{[i.small]:"text-sm py-1.75 px-3",[i.medium]:"text-base py-2.75 px-4.5",[i.large]:"text-lg py-3.75 px-5.5"},isDisabled:{false:`
        cursor-pointer 
        shadow-md/15
      ...
      `},{flavor:r.primary,isKeyboardFocused:!0,isKeyboardActivated:!1,isDisabled:!1,class:"focus:bg-indigo-800 focus:border-indigo-800"},{flavor:r.secondary,isKeyboardActivated:!0,isDisabled:!1,class:`
        active:bg-gray-300 active:border-gray-700
      ...
      `},{flavor:r.secondary,isKeyboardFocused:!0,isKeyboardActivated:!1,isDisabled:!1,class:"focus:bg-gray-200 focus:border-gray-600"},{flavor:r.danger,isKeyboardActivated:!0,isDisabled:!1,class:`
        active:bg-rose-950 active:border-rose-950
