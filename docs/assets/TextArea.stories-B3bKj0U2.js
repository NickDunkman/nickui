import{r}from"./iframe-BPbQ6ggc.js";import{A as me}from"./AllSizersStoryWrapper-D0mRqEo6.js";import{F as de}from"./Field-Cs6vtW0o.js";import{r as P}from"./randomId-Dfhrkieu.js";import{a as pe,u as ge}from"./index-lOW5hRJ7.js";const xe=pe({slots:{root:"relative",textarea:`
    ...
    `,hiddenTextArea:"invisible absolute -z-1 pointer-events-none select-none"},compoundSlots:[{slots:["textarea","hiddenTextArea"],className:"appearance-none w-full border-2"},{slots:["textarea","hiddenTextArea"],sizer:"xs",className:"text-xs py-1.25 px-2"},{slots:["textarea","hiddenTextArea"],sizer:"sm",className:"text-sm py-1.5 px-2"},{slots:["textarea","hiddenTextArea"],sizer:"base",className:"text-base py-2.5 px-3.5"},{slots:["textarea","hiddenTextArea"],sizer:"lg",className:"text-lg py-3.5 px-4.5"},{slots:["textarea","hiddenTextArea"],sizer:"xl",className:"text-xl py-4.5 px-5.5"}],variants:{sizer:{xs:{},sm:{},base:{},lg:{},xl:{}},hasError:{false:{},true:{textarea:"border-rose-800 focus:border-rose-800 focus:shadow-rose-300"}},disableManualResize:{false:{},true:{textarea:"resize-none"}}},defaultVariants:{sizer:"base",hasError:!1}});function o({className:e,sizer:s,label:i,hint:n,error:a,disabled:u,required:F,id:$,defaultValue:I,value:H,onChange:K,rows:k,minRows:m=2,maxRows:R=10,disableManualResize:Y,"aria-describedby":J,"aria-errormessage":Z,"aria-invalid":X,...ee}){const _=r.createRef(),T=r.useRef(null),[B,ae]=r.useState(0),te=k!==void 0?k:B>m?B:m,[se,O]=r.useState(I),U=H!==void 0,N=U?H:se;function ie(c){U||O(c.target.value),K?.(c)}r.useLayoutEffect(()=>{if(T.current){T.current.value=N||"";const c=getComputedStyle(T.current),oe=D(c.lineHeight),ce=D(c.paddingTop)+D(c.paddingBottom),L=Math.ceil((T.current.scrollHeight-ce)/oe),G=L<m?m:L>R?R:L;G!==B&&ae(G)}},[N,m,R,B]),r.useLayoutEffect(()=>{if(H===void 0&&I===void 0){const c=ve(_);c.value&&O(c.value)}},[]);const[ne]=r.useState(P()),j=$||(i?ne:void 0),[re]=r.useState(P()),Q=J||(n?re:void 0),[le]=r.useState(P()),W=Z||(a&&a!==!0?le:void 0),ue=ge(s),M=xe({sizer:ue,hasError:!!a,disableManualResize:Y});return r.createElement(de,{className:e,sizer:s,label:i,controlId:j,hint:n,hintId:Q,error:a!==!0?a:void 0,errorId:W,disabled:u,required:F},r.createElement("div",{ref:_,className:M.root()},r.createElement("textarea",{ref:T,className:M.hiddenTextArea(),rows:m,disabled:!0,"aria-hidden":!0}),r.createElement("textarea",{...ee,id:j,className:M.textarea(),rows:te,value:N,onChange:ie,disabled:u,required:F,"aria-describedby":Q,"aria-errormessage":W,"aria-invalid":X!==void 0?X:!!a})))}function D(e){return Number(e.slice(0,-2))}function ve(e){return[...e.current?.getElementsByTagName("textarea")||[]][1]}o.__docgenInfo={description:`A form control that allows users to enter & edit a mass of text
...
Proin et fringilla enim. Fusce id ultrices nisl. Fusce dignissim dolor et elementum hendrerit. Morbi ornare lectus eu lectus commodo, placerat faucibus ipsum facilisis. Sed tempor condimentum lobortis. Proin laoreet mollis diam in ornare. Nullam quam ex, egestas ac tristique sit amet, iaculis id turpis. Sed eget molestie libero, a fringilla dui. Aliquam erat volutpat. Praesent in interdum enim, ut blandit magna.`),t(u()).toEqual(10)}),await i("Reset to the original value",async()=>{await n.clear(a),await V(n.type,a,e.defaultValue),t(u()).toBeGreaterThanOrEqual(1),t(u()).toBeLessThanOrEqual(10)})}},C={args:{"aria-label":"Fixed height TextArea",defaultValue:"In quis convallis felis. In efficitur aliquam lobortis. Curabitur venenatis ut justo vitae tincidunt. Morbi vel commodo sapien. Maecenas tincidunt, leo in maximus posuere, metus neque auctor elit, congue rutrum tellus tellus a magna. Ut leo est, auctor et purus non, pellentesque pellentesque libero. Quisque at maximus risus, mollis tempus justo. Donec venenatis quam ac risus auctor pellentesque. Aenean ex quam, facilisis at pharetra ut, sollicitudin et urna. Nullam bibendum nibh sed leo convallis, eu vestibulum purus gravida. Fusce elementum nulla in ornare bibendum. In euismod diam ut nisl tristique, in ornare turpis tincidunt. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Integer finibus mauris risus, quis aliquet dolor vehicula ut. Suspendisse id dolor felis.",rows:3,minRows:1,maxRows:10,lang:"la",onChange:l()},play:async({args:e,canvas:s,step:i,userEvent:n})=>{const a=s.getByLabelText("Fixed height TextArea");function u(){return parseInt(a.getAttribute("rows")||"0")}await i("The textarea should use the fixed `rows` after clearing the value",async()=>{await n.clear(a),t(u()).toEqual(3)}),await i("The textarea should use the fixed `rows` after adding an absolute chunk of text",async()=>{await V(n.type,a,`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent a interdum nisl, et fermentum quam. Vestibulum id pretium nisi. Sed congue porttitor varius. Mauris sit amet dui porta, placerat nisl et, consequat ante. Maecenas at ornare dui. Nam eu ex vitae ante faucibus elementum. Nam a orci quis urna iaculis dictum. Morbi mollis neque ut commodo eleifend.
Nam vitae tortor et metus ullamcorper blandit in a turpis. Nam nec posuere felis. Nunc at auctor purus. Vivamus ornare magna orci. Cras sit amet facilisis urna, vitae semper massa. Mauris varius porta faucibus. In vehicula, tortor in semper vulputate, odio diam semper urna, a ornare arcu nulla non massa. Vestibulum tristique eu eros at pulvinar. Quisque id sapien non justo suscipit semper.
Suspendisse potenti. Aliquam venenatis erat at tempus consectetur. Proin vulputate, dolor quis imperdiet suscipit, risus sem feugiat ante, a blandit diam neque non quam. Vestibulum vel nibh ut eros vestibulum fermentum id ac elit. Duis bibendum pulvinar tincidunt. Aliquam eu efficitur dui, ac varius lectus. Sed venenatis ultrices ipsum sit amet euismod. Phasellus vehicula nisi ante, sit amet mattis odio feugiat quis. Cras iaculis malesuada velit sit amet sodales. Phasellus lacus eros, aliquet eget condimentum eu, feugiat sit amet augue. Donec a consectetur enim, egestas aliquam risus. Sed facilisis faucibus dui non finibus. Phasellus fringilla pretium odio, et condimentum ligula maximus in. Proin sit amet nisl in nisi placerat tincidunt. Proin in placerat augue.
Cras egestas, nulla eu fringilla ullamcorper, odio tellus feugiat risus, nec varius libero tortor at eros. Suspendisse quis eleifend lorem. Sed iaculis, nisi at tempor accumsan, eros nunc pellentesque nulla, feugiat efficitur neque lacus eu nulla. Aliquam convallis pretium lectus vel hendrerit. Duis commodo tortor eu molestie sodales. Proin convallis pulvinar orci eu vehicula. In rhoncus ullamcorper metus et sodales. Curabitur facilisis tellus ut laoreet finibus. Duis convallis felis nisi. Quisque vehicula imperdiet risus, eu viverra nibh congue nec. Mauris quis pharetra odio. Mauris turpis mauris, malesuada sed ipsum id, aliquet facilisis ex. Nunc eleifend turpis eu metus convallis, id luctus sem volutpat. Vestibulum interdum blandit augue, quis feugiat dui tristique quis. Nunc convallis arcu dui, porta placerat ante feugiat vitae. Fusce at odio risus.
Proin et fringilla enim. Fusce id ultrices nisl. Fusce dignissim dolor et elementum hendrerit. Morbi ornare lectus eu lectus commodo, placerat faucibus ipsum facilisis. Sed tempor condimentum lobortis. Proin laoreet mollis diam in ornare. Nullam quam ex, egestas ac tristique sit amet, iaculis id turpis. Sed eget molestie libero, a fringilla dui. Aliquam erat volutpat. Praesent in interdum enim, ut blandit magna.`),t(u()).toEqual(3)}),await i("Reset to the original value",async()=>{await n.clear(a),await V(n.type,a,e.defaultValue),t(u()).toEqual(3)})}},S={args:{"aria-label":"Disabled manual resize TextArea",defaultValue:"This TextArea has no resize handle at the bottom right!",disableManualResize:!0,onChange:l()},play:async({canvas:e,step:s})=>{await s("The TextArea should have the resize handle hidden",async()=>{t(e.getByLabelText("Disabled manual resize TextArea")).toHaveClass("resize-none")})}},z={tags:["!dev","!test"],render:e=>r.createElement("div",{className:"flex flex-col gap-4"},r.createElement(o,{...d.args}),r.createElement(o,{...p.args}),r.createElement(o,{...g.args}),r.createElement(o,{...x.args}))},E={tags:["!dev","!test"],render:e=>r.createElement(me,{alignBaseline:!0},r.createElement(o,{...v.args}),r.createElement(o,{...b.args}),r.createElement(o,{...h.args}),r.createElement(o,{...f.args}),r.createElement(o,{...y.args}))};q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
  tags: ['field-layout'],
  args: {
    required: true,
    label: 'A label',
...
}`,...E.parameters?.docs?.source}}};const he=["FieldLayout","Empty","Controlled","Uncontrolled","Disabled","Xs","Sm","Base","Lg","Xl","Responsive","AutoResizableHeight","FixedHeight","DisableManualResize","AllControlStates","AllSizers"],we=Object.freeze(Object.defineProperty({__proto__:null,AllControlStates:z,AllSizers:E,AutoResizableHeight:w,Base:h,Controlled:p,DisableManualResize:S,Disabled:x,Empty:d,FieldLayout:q,FixedHeight:C,Lg:f,Responsive:A,Sm:b,Uncontrolled:g,Xl:y,Xs:v,__namedExportsOrder:he,default:be},Symbol.toStringTag,{value:"Module"}));export{w as A,S as D,C as F,we as S,o as T};
