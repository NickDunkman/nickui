import{r}from"./iframe-DcTNfTrS.js";import{c as re,F as u}from"./index-Czi7Upa3.js";import{c as ae}from"./clsw-D-KgF5mV.js";var s=(a=>(a.primary="primary",a.secondary="secondary",a.danger="danger",a))(s||{});const se=re({base:`
    appearance-none
    border-1 rounded-sm
    text-center
  ...
  `,variants:{sizer:{[u.small]:"text-sm py-1.75 px-3",[u.medium]:"text-base py-2.75 px-4.5",[u.large]:"text-lg py-3.75 px-5.5"},flavor:{[s.primary]:"bg-indigo-600 border-indigo-600 text-white font-medium",[s.secondary]:"border-gray-500 bg-gray-100 shadow-md/8",[s.danger]:"bg-rose-700 border-rose-700 text-white font-medium"}},defaultVariants:{sizer:u.small,flavor:s.primary}});function e({className:a,type:W="button",disabled:X=!1,sizer:Y,flavor:Z,...$}){const ee=se({sizer:Y,flavor:Z});return r.createElement("button",{...$,className:ae(ee,a),disabled:X,type:W})}e.flavor=s;e.sizer=u;e.__docgenInfo={description:`Buttons allow the user to trigger an action, such as submitting a form
...
}`,...(S=(B=o.parameters)==null?void 0:B.docs)==null?void 0:S.source}}};var x,w,E;p.parameters={...p.parameters,docs:{...(x=p.parameters)==null?void 0:x.docs,source:{originalSource:`{
  tags: ['!dev', '!test'],
  render: _args => <div className="flex gap-4">
      <Button {...Enabled.args} />
      <Button {...Disabled.args} />
    </div>
}`,...(E=(w=p.parameters)==null?void 0:w.docs)==null?void 0:E.source}}};var z,_,N;n.parameters={...n.parameters,docs:{...(z=n.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
