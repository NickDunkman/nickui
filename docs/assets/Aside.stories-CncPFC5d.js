import{r as e}from"./iframe-BPbQ6ggc.js";import{A as C}from"./AllSizersStoryWrapper-D0mRqEo6.js";import{a as R,u as k,c as q}from"./index-lOW5hRJ7.js";const f=R({slots:{root:"rounded-sm border-1",heading:"font-semibold",paragraph:""},variants:{sizer:{xs:{root:"p-3 text-xs",heading:"text-xs mb-2.5",paragraph:"text-xs [&:not(:last-child)]:mb-2"},sm:{root:"p-3.5 text-xs",heading:"text-sm mb-3",paragraph:"text-xs [&:not(:last-child)]:mb-2.5"},base:{root:"p-4 text-sm",heading:"text-base mb-3.5",paragraph:"text-sm [&:not(:last-child)]:mb-3"},lg:{root:"p-4.5 text-base",heading:"text-lg mb-4",paragraph:"text-base [&:not(:last-child)]:mb-3.5"},xl:{root:"p-5 text-lg",heading:"text-xl mb-4.5",paragraph:"text-lg [&:not(:last-child)]:mb-4"}},flavor:{neutral:{root:"bg-blue-50 border-blue-200 text-blue-950"},positive:{root:"bg-emerald-50 border-emerald-200 text-emerald-950"},caution:{root:"bg-yellow-50 border-yellow-300 text-yellow-950"},negative:{root:"bg-rose-50 border-rose-200 text-rose-950"}}},defaultVariants:{sizer:"base",flavor:"neutral"}});function a({className:s,sizer:t,flavor:r,children:x,...A}){const v=k(t),S=f({sizer:v,flavor:r}),N=e.useMemo(()=>({styles:f({sizer:v,flavor:r}),resolvedSizer:v,flavor:r}),[v,r]);return e.createElement(P.Provider,{value:N},e.createElement("aside",{...A,className:q(S.root(),s),"data-nickui-sizer":Array.isArray(t)?t.join(","):t,"data-nickui-resolved-sizer":v},x))}a.Heading=z;a.Paragraph=H;const P=e.createContext({styles:f(),resolvedSizer:"base",flavor:"neutral"});function z({children:s,className:t,level:r=3}){const{styles:x}=e.useContext(P),A=`h${r}`;return e.createElement(A,{className:q(x.heading(),t)},s)}H.displayName="AsideHeading";function H({children:s,className:t}){const{styles:r}=e.useContext(P);return e.createElement("p",{className:q(r.paragraph(),t)},s)}H.displayName="AsideParagraph";a.__docgenInfo={description:`Displays some secondary content, typically an "oh, by the way!" relative to
the main content.
