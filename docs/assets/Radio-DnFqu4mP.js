import{r}from"./iframe-CJWqI_sH.js";import{a as i}from"./Checkbox-DZgOQSD9.js";import{a as o,S as e}from"./index-DC3BbHJo.js";const n=o({slots:{root:"",labelWithOffset:"",input:"peer opacity-0 absolute -z-1",indicator:`
    ...
    `},variants:{sizer:{[e.small]:{indicator:"size-3.5 top-0.25 peer-checked:after:size-1.5"},[e.base]:{indicator:"size-4 top-0.75 peer-checked:after:size-1.5"},[e.large]:{indicator:"size-5 top-0.75 peer-checked:after:size-2"}},isDisabled:{true:{indicator:`
        ...
        `}}},defaultVariants:{sizer:e.base,isDisabled:!1,isKeyboardFocused:!1}});function t(a){return r.createElement(i,{...a,type:"radio",styler:n})}t.sizer=e;t.__docgenInfo={description:`A form control that allow users to choose one option from a set
