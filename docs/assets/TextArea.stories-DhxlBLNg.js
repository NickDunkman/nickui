import{r}from"./iframe-BOhUS0D9.js";import{A as re}from"./AllSizersStoryWrapper-B8yhyoy3.js";import{F as le}from"./Field-BCFMpcPz.js";import{u as ue}from"./useFieldA11yIds-CMM-qVMC.js";import{a as oe,u as ce}from"./index-DNuRN-av.js";const me=oe({slots:{root:"relative",textarea:`
    ...
    `,hiddenTextArea:"invisible absolute -z-1 pointer-events-none select-none"},compoundSlots:[{slots:["textarea","hiddenTextArea"],className:"appearance-none w-full border-2"},{slots:["textarea","hiddenTextArea"],sizer:"xs",className:"text-xs py-1.25 px-2"},{slots:["textarea","hiddenTextArea"],sizer:"sm",className:"text-sm py-1.5 px-2"},{slots:["textarea","hiddenTextArea"],sizer:"base",className:"text-base py-2.5 px-3.5"},{slots:["textarea","hiddenTextArea"],sizer:"lg",className:"text-lg py-3.5 px-4.5"},{slots:["textarea","hiddenTextArea"],sizer:"xl",className:"text-xl py-4.5 px-5.5"}],variants:{sizer:{xs:{},sm:{},base:{},lg:{},xl:{}},hasError:{false:{},true:{textarea:"border-rose-800 focus:border-rose-800 focus:shadow-rose-300"}},disableManualResize:{false:{},true:{textarea:"resize-none"}}},defaultVariants:{sizer:"base",hasError:!1}});function o({className:e,sizer:s,label:i,hint:n,error:a,disabled:u,required:F,id:Q,defaultValue:I,value:N,onChange:W,rows:k,minRows:d=2,maxRows:R=10,disableManualResize:G,"aria-labelledby":$,"aria-describedby":K,"aria-errormessage":Y,"aria-invalid":_,...J}){const O=r.createRef(),q=r.useRef(null),[V,Z]=r.useState(0),ee=k!==void 0?k:V>d?V:d,[ae,X]=r.useState(I),j=N!==void 0,M=j?N:ae;function te(c){j||X(c.target.value),W?.(c)}r.useLayoutEffect(()=>{if(q.current){q.current.value=M||"";const c=getComputedStyle(q.current),ie=D(c.lineHeight),ne=D(c.paddingTop)+D(c.paddingBottom),P=Math.ceil((q.current.scrollHeight-ne)/ie),U=P<d?d:P>R?R:P;U!==V&&Z(U)}},[M,d,R,V]),r.useLayoutEffect(()=>{if(N===void 0&&I===void 0){const c=de(O);c.value&&X(c.value)}},[]);const m=ue({label:i,hint:n,error:a,controlledId:Q,controlledAriaLabelledBy:$,controlledAriaDescribedBy:K,controlledAriaErrorMessage:Y}),se=ce(s),L=me({sizer:se,hasError:!!a,disableManualResize:G});return r.createElement(le,{className:e,sizer:s,label:i,labelId:m.ariaLabelledBy,controlId:m.id,hint:n,hintId:m.ariaDescribedBy,error:a!==!0?a:void 0,errorId:m.ariaErrorMessage,disabled:u,required:F},r.createElement("div",{ref:O,className:L.root()},r.createElement("textarea",{ref:q,className:L.hiddenTextArea(),rows:d,disabled:!0,"aria-hidden":!0}),r.createElement("textarea",{...J,id:m.id,className:L.textarea(),rows:ee,value:M,onChange:te,disabled:u,required:F,"aria-labelledby":m.ariaLabelledBy,"aria-describedby":m.ariaDescribedBy,"aria-errormessage":m.ariaErrorMessage,"aria-invalid":_!==void 0?_:!!a})))}function D(e){return Number(e.slice(0,-2))}function de(e){return[...e.current?.getElementsByTagName("textarea")||[]][1]}o.__docgenInfo={description:`A form control that allows users to enter & edit a mass of text
...
}`,...B.parameters?.docs?.source}}};const xe=["fieldLayout","empty","controlled","uncontrolled","disabled","xs","sm","base","lg","xl","responsive","autoResizableHeight","fixedHeight","disableManualResize","allControlStates","allSizers"],Te=Object.freeze(Object.defineProperty({__proto__:null,__namedExportsOrder:xe,allControlStates:E,allSizers:B,autoResizableHeight:C,base:f,controlled:g,default:ge,disableManualResize:z,disabled:b,empty:p,fieldLayout:A,fixedHeight:S,lg:y,responsive:w,sm:h,uncontrolled:x,xl:T,xs:v},Symbol.toStringTag,{value:"Module"}));export{o as T,C as a,z as d,S as f,Te as s};
